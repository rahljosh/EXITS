...
<!---			SELECT smg_users.businessname, smg_users.userid
  ...
  <tr>
		...
		<td class="style1"><input type="checkbox" name="email_intrep" />Send email to Intl. Agent (if on file)<BR />
		<input type="checkbox" name="email_self" />I would like to receive a copy of the email. (#client.email#)</td>
  </tr>

  <Tr>
  	<td align="right" class="style1"><b>Format:</b></td>
	<td class="style1"> <input type="radio" name="print" value=0 checked>  Onscreen (View Only) <input type="radio" name="print" value=1> Print (FlashPaper) <input type="radio" name="print" value=2> Print (PDF) 
  </Tr>
  <tr>
