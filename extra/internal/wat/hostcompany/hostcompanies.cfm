...
<table border=0 cellpadding=4 cellspacing=0 class="section" align="center" width=95%>
	<tr>
		...
		<th width=28% align="left" bgcolor="4F8EA4"><a href="?curdoc=hostcompany/hostcompanies&order=name" class="style2">Company Name</a></th>
		<th width=15% align="left"  bgcolor="4F8EA4"><a href="?curdoc=hostcompany/hostcompanies&order=phone" class="style2">Phone</th>
		<th width=17 align="left"  bgcolor="4F8EA4"><a href="?curdoc=hostcompany/hostcompanies&order=supervisor" class="style2">Contact</th>
		<th width=10% align="left"  bgcolor="4F8EA4"><a href="?curdoc=hostcompany/hostcompanies&order=city" class="style2">City</a></th>
		<th width=10% align="left"  bgcolor="4F8EA4"><a href="?curdoc=hostcompany/hostcompanies&order=state" class="style2">State</a></th>
		<th width=15% align="left"  bgcolor="4F8EA4"><a href="?curdoc=hostcompany/hostcompanies&order=typebusiness" class="style2">Business</a></th>
		</tr>
<cfloop query="hostcompanies">
	<tr bgcolor="#iif(hostcompanies.currentrow MOD 2 ,DE("e9ecf1") ,DE("white") )#">
		...
		<td bgcolor="#iif(hostcompanies.currentrow MOD 2 ,DE("e9ecf1") ,DE("white") )#" class="style5"><div align="left">#phone#</td>
		<td bgcolor="#iif(hostcompanies.currentrow MOD 2 ,DE("e9ecf1") ,DE("white") )#" class="style5"><div align="left">#supervisor#</td>
		<td bgcolor="#iif(hostcompanies.currentrow MOD 2 ,DE("e9ecf1") ,DE("white") )#" class="style5"><div align="left">#city#</div></a></td>
