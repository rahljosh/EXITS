...
<cfquery name="check_for_duplicate_business" datasource="mysql">
select companyid, name
from extra_hostcompany
where name = '#form.name#'
</cfquery>

<cfif check_for_duplicate_business.recordcount gt 0><br />
	<table border=0 cellpadding=4 cellspacing=0 class="section" align="center" width=90%>
		<tr><th background="images/back_menu2.gif" class="title1">EXTRA - Error Message</th>
		</tr>
		<tr><td class="style1" align="center">Sorry, but this business  has been entered in the database as follow:</td></tr>
		<tr>
			<td align="center">
				<cfoutput query="check_for_duplicate_business">
				<a href="?curdoc=hostcompany/hostcompany_profile&hostcompanyid=#check_for_duplicate_business.companyid#">#name# (#companyid#)</a>
				</cfoutput>
			</td>
		</tr>
