												...
												<cfelse>
													<select name="fieldstudyid" class="style1" onChange="loadOptions('listsubcat');">
														...
														<cfloop query="fieldstudy">
															<option value="#fieldstudyid#" <cfif fieldstudyid EQ get_candidate_unqid.fieldstudyid>selected</cfif>><cfif len(fieldstudy) GT 37>#Left(fieldstudy,35)#...<cfelse>#fieldstudy#</cfif></option>
														</cfloop>
													</select>
												</cfif>
											</td>
									...
									<table width="100%" cellpadding=5 cellspacing=0 border=0>
									 ...
									 <!---- // close position from wat --->			
										...
										<tr>
											...
											<td class="style1"><cfif edit EQ 'no'>#dateformat (candidate_place_company.startdate, 'mm/dd/yyyy')#<cfelse><cfinput type="text" name="host_startdate" size=30 value="#dateformat (candidate_place_company.startdate, 'mm/dd/yyyy')#" maxlength="50"></cfif></td>
										</tr>
										<tr>
											<td class="style1" align="right"><b>End Date:</b></td>
											<td class="style1"><cfif edit EQ 'no'>#dateformat (candidate_place_company.enddate, 'mm/dd/yyyy')#<cfelse><cfinput type="text" name="host_enddate" size=30 value="#dateformat (candidate_place_company.enddate, 'mm/dd/yyyy')#" maxlength="50"></cfif></td>
										</tr>
										<tr>
								...
								<td bordercolor="FFFFFF">
									...
									<table width="100%" cellpadding=5 cellspacing=0 border=0>
										...
										<tr>
											...
											<td width="1083" class="style1">Candidate Cancelled &nbsp; <b>Date:</b> &nbsp; <cfif edit EQ 'no'>#DateFormat(cancel_date, 'mm/dd/yyyy')#<cfelse><input type="text" class="style1" name="cancel_date" size=8 value="#DateFormat(cancel_date, 'mm/dd/yyyy')#"></cfif></td>
										</tr>
										<tr>
											<td colspan="2">
												<table width="100%">
													<tr>
														...
														<td width="990" class="style1"><cfif edit EQ 'no'>#cancel_reason# <cfelse><input type="text" class="style1" name="cancel_reason" size=20 value="#cancel_reason#"></cfif></td>
													</tr>
												</table>
											</td>										
										</tr>
										...
										<tr>
											...
											<td class="style1" colspan="3" >
												...
												<select name="combo_subfield" class="style1" >
														...
														<cfif get_subfield.code EQ get_candidate_subject.ds2019_subject><option value="#code#" selected>#code# #left(subfield,35)# </option><cfelse>
														<option value="#code#">#code# #left(subfield,35)#</option></cfif>
														</cfloop>
												</select>
												</cfif>											</td>
										</tr>
