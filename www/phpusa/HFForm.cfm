...
<div class="photobox"><img src="images/study/study.gif" width="300" height="200" /></div>
  
     <span class="headline">Host Family Form</span><br /><br />
...
from smg_states
     ...
     <cfoutput>
         ...
         <input type="hidden" name="new_account" value="host family" />
           Name
        <br />
