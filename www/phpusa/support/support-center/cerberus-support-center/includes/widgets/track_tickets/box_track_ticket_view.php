...
<table cellpadding="4" cellspacing="1" border="0" class="main_table" width='100%'>
	<tr>
		...
		<td class="table_header_cell" align="center" width="150"><a href="<?php echo $tickets_url; ?>" class="url">Back to <?php echo $view_type; ?> Tickets</a></td>
	</tr>
	...
	<tr>
		<td bgcolor="#F8F8F8" colspan="2">
			...
			<table cellpadding="2" cellspacing="0" border="0" bgcolor="#F8F8F8">
				...
				<?php if(!empty($track_ticket->ticket_date)) { ?>
				<tr>
					<td valign="top" class="box_content_text"><B>Opened:</B></td>
					<td><img src="includes/images/spacer.gif" width="5" height="1"></td>
					<td class="box_content_text"><?php echo $track_ticket->ticket_date->getDate("%a %b %d %Y %I:%M%p"); ?></td>
				</tr>
				<?php } ?>
				
				<?php if(!empty($track_ticket->activity_date)) { ?>
				<tr>
					<td valign="top" class="box_content_text"><B>Last Msg:</B></td>
					<td><img src="includes/images/spacer.gif" width="5" height="1"></td>
					<td class="box_content_text"><?php echo $track_ticket->activity_date->getDate("%a %b %d %Y %I:%M%p"); ?></td>
				</tr>
				<?php } ?>
				
				<?php if(!empty($track_ticket->ticket_due)) { ?>
				<tr>
					<td valign="top" class="box_content_text"><B>Due:</B></td>
					<td><img src="includes/images/spacer.gif" width="5" height="1"></td>
					<td class="box_content_text"><?php echo $track_ticket->ticket_due->getDate("%a %b %d %Y %I:%M%p"); ?></td>
				</tr>
				<?php } ?>
