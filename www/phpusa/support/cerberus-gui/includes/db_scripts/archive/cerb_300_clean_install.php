...
define("DB_SCRIPT_NAME","Cerberus Helpdesk 3.0.0 Release New Install");
...
function init_table_ticket()
{
	...
	$TABLE_DEF->create_sql = "CREATE TABLE `ticket` (".
								...
								"  `num_teams` tinyint(3) unsigned NOT NULL default '0',".
	...
	$TABLE_DEF->fields["num_teams"] = new CER_DB_FIELD("num_teams","tinyint(3) unsigned","","MUL","0","");
	...
	$TABLE_DEF->indexes["num_teams"] = new CER_DB_INDEX("num_teams","1","num_teams");
...
function init_table_team()
{
   ...
   $TABLE_DEF->create_sql = "CREATE TABLE `team` (".
		...
		"  `default_response_time` tinyint(3) unsigned NOT NULL default '0',".
		"  `default_schedule` bigint(20) unsigned NOT NULL default '0',".
		"  PRIMARY KEY  (`team_id`)".
		") TYPE=MyISAM";
   ...
   $TABLE_DEF->fields["default_response_time"] = new CER_DB_FIELD("default_response_time","tinyint(3) unsigned","","","0","");
   $TABLE_DEF->fields["default_schedule"] = new CER_DB_FIELD("default_schedule","bigint(20) unsigned","","","0","");
