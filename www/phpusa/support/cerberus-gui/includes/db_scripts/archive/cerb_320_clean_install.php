...
define("DB_SCRIPT_NAME","Cerberus Helpdesk 3.2 Release New Install");
...
function init_table_workstation_tags() {
	...
	$TABLE_DEF->create_sql = "CREATE TABLE `workstation_tags` ( ".
		...
		"`tag_set_id` int(11) unsigned NOT NULL default '0', ".
		"PRIMARY KEY  (`tag_id`) ".
		") TYPE=MyISAM;";
   ...
   $TABLE_DEF->fields["tag_set_id"] = new CER_DB_FIELD("tag_set_id","int(11) unsigned","","","0","");
...
function init_table_public_gui_profiles()
{
	...
	$TABLE_DEF->create_sql = "CREATE TABLE `public_gui_profiles` (".
								...
								"  `pub_mod_kb_tag_sets` text default '',".
	...
	$TABLE_DEF->fields["pub_teams"] = new CER_DB_FIELD("pub_teams","text","","","","");
	...
	$TABLE_DEF->fields["pub_mod_kb_tag_sets"] = new CER_DB_FIELD("pub_mod_kb_tag_sets","text","","","","");
...
function init_table_chat_visitor_pages()
{
   ...
   $TABLE_DEF->fields["page_name"] = new CER_DB_FIELD("page_name","char(255)","","","","");
   $TABLE_DEF->fields["visitor_id"] = new CER_DB_FIELD("visitor_id","bigint(20) unsigned","","MUL","0","");
