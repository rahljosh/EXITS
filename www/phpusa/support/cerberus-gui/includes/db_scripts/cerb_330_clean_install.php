...
define("DB_SCRIPT_NAME","Cerberus Helpdesk 3.3 Release New Install");
...
function cer_init()
{
	...
	init_table_kb_comments();
	init_table_kb_ratings();
	init_table_log();
...
function set_precursor_hashes()
{
	...
	if($TABLE_PM->table_exists) {
		...
		$cerberus_db->query($sql);
		$sql = "REPLACE INTO db_script_hash(script_md5,run_date) VALUES('3da36ae7ac9316f6f2f68b2c6a7d2381',NOW())"; // 2.7.x to 3.0.x RC1
		$cerberus_db->query($sql);
		$sql = "REPLACE INTO db_script_hash(script_md5,run_date) VALUES('c0c47e3871612409bf4b33ba22022192',NOW())"; // 2.7.x to 3.0.130 RC1
		$cerberus_db->query($sql);
		$sql = "REPLACE INTO db_script_hash(script_md5,run_date) VALUES('11a6afd83f5bea9451ac9f6d7e7b7933',NOW())"; // 3.0.130 RC1 to 3.0.228 Release
		$cerberus_db->query($sql);
		$sql = "REPLACE INTO db_script_hash(script_md5,run_date) VALUES('6e4c00953b623699657dc92b8b237b97',NOW())"; // 3.0 to 3.1 Release
		$cerberus_db->query($sql);
		$sql = "REPLACE INTO db_script_hash(script_md5,run_date) VALUES('5cd59f1f203235841f0604e3e90f68d7',NOW())"; // 3.1 to 3.2 Release
		$cerberus_db->query($sql);
		$sql = "REPLACE INTO db_script_hash(script_md5,run_date) VALUES('78284fe3452f81d86c20e0c5928e090a',NOW())"; // 3.2 to 3.3 Release
		$cerberus_db->query($sql);
	}
}
...
function init_table_dashboard() {
   ...
   $TABLE_DEF->fields["title"] = new CER_DB_FIELD("title","char(64)","","","","");
   $TABLE_DEF->fields["agent_id"] = new CER_DB_FIELD("agent_id","bigint(20) unsigned","","MUL","0","");
   $TABLE_DEF->fields["hide_queues"] = new CER_DB_FIELD("hide_queues","text","","","","");
   $TABLE_DEF->fields["hide_teams"] = new CER_DB_FIELD("hide_teams","text","","","","");
   $TABLE_DEF->fields["reload_mins"] = new CER_DB_FIELD("reload_mins","tinyint(3) unsigned","","","0","");
...
function init_table_jasper_reports() {
	...
	$TABLE_DEF->fields["guid"] = new CER_DB_FIELD("guid","int(10)","YES","","","");
	$TABLE_DEF->fields["summary"] = new CER_DB_FIELD("summary","text","YES","","","");
	$TABLE_DEF->fields["version"] = new CER_DB_FIELD("version","varchar(20)","YES","","","");
	$TABLE_DEF->fields["author"] = new CER_DB_FIELD("author","varchar(255)","YES","","","");
	$TABLE_DEF->fields["category_id"] = new CER_DB_FIELD("category_id","int(10)","YES","","","");
	$TABLE_DEF->fields["report_source"] = new CER_DB_FIELD("report_source","mediumtext","YES","","","");
	$TABLE_DEF->fields["scriptlet_source"] = new CER_DB_FIELD("scriptlet_source","mediumtext","YES","","","");
...
function init_table_parser_fail_headers() {
   ...
   $TABLE_DEF->fields["message_source_filename"] = new CER_DB_FIELD("message_source_filename","char(20)","","","","");
   $TABLE_DEF->fields["message_size"] = new CER_DB_FIELD("message_size","int(11) unsigned","","","0","");
...
function init_table_pop3_accounts() {
   ...
   $TABLE_DEF->create_sql = "CREATE TABLE `pop3_accounts` ( ".
		...
		"`max_messages` tinyint(4) unsigned DEFAULT '0' NOT NULL , ".
		"`delete` tinyint(4) unsigned DEFAULT '0' NOT NULL , ".
		"`lock_time` bigint(20) unsigned DEFAULT '0',".
		"`max_size` bigint(20) unsigned DEFAULT '0',".
   ...
   $TABLE_DEF->fields["host"] = new CER_DB_FIELD("host","varchar(255)","","","","");
   $TABLE_DEF->fields["login"] = new CER_DB_FIELD("login","varchar(255)","","","","");
   ...
   $TABLE_DEF->fields["max_messages"] = new CER_DB_FIELD("max_messages","tinyint(4) unsigned","","","0","");
   $TABLE_DEF->fields["delete"] = new CER_DB_FIELD("delete","tinyint(4) unsigned","","","0","");
   $TABLE_DEF->fields["lock_time"] = new CER_DB_FIELD("lock_time","bigint(20) unsigned","","","0","");
   $TABLE_DEF->fields["max_size"] = new CER_DB_FIELD("max_size","bigint(20) unsigned","","","0","");
   $TABLE_DEF->fields["port"] = new CER_DB_FIELD("port","int(11) unsigned","","","110","");
...
function init_table_next_step() {
   ...
   $TABLE_DEF->fields["note"] = new CER_DB_FIELD("note","text","","","","");
...
function init_table_workstation() {
	...
	$TABLE_DEF->create_sql = "CREATE TABLE `workstation` (".
		...
		"`max_web_users` INT(11) UNSIGNED default '0' NOT NULL ,".
		"`max_desktop_users` INT(11) UNSIGNED default '0' NOT NULL ,".
   ...
   $TABLE_DEF->fields["max_web_users"] = new CER_DB_FIELD("max_web_users","int(11) unsigned","","","0","");
   $TABLE_DEF->fields["max_desktop_users"] = new CER_DB_FIELD("max_desktop_users","int(11) unsigned","","","0","");
   $TABLE_DEF->fields["expires"] = new CER_DB_FIELD("expires","date","","","0000-00-00","");
   $TABLE_DEF->fields["license_id"] = new CER_DB_FIELD("license_id","char(32)","","","","");
   $TABLE_DEF->fields["enable_jparser"] = new CER_DB_FIELD("enable_jparser","tinyint(3)","","","0","");
...
function init_table_workstation_routing_agents() {
   ...
   $TABLE_DEF->fields["agent_id"] = new CER_DB_FIELD("agent_id","bigint(20) unsigned","","PRI","0","");
   $TABLE_DEF->fields["queue_id"] = new CER_DB_FIELD("queue_id","bigint(20) unsigned","","PRI","0","");
   $TABLE_DEF->fields["is_flagged"] = new CER_DB_FIELD("is_flagged","tinyint(3) unsigned","","PRI","0","");
	
	$TABLE_DEF->indexes["primary"] = new CER_DB_INDEX("primary","0",array("agent_id","queue_id","is_flagged"));
...
function init_table_team_queues() {
   ...
   $TABLE_DEF = new CER_DB_TABLE("team_queues",false);
	...
	$TABLE_DEF->create_sql = "CREATE TABLE `team_queues` ( ".
		...
		"`quick_assign` tinyint(3) unsigned default '0' NOT NULL, ".
   ...
   $TABLE_DEF->fields["quick_assign"] = new CER_DB_FIELD("quick_assign","tinyint(3) unsigned","","","0","");
...
function init_table_configuration() {
	...
	$TABLE_DEF->create_sql = "CREATE TABLE `configuration` (".
								...
								"  `subject_ids` tinyint(3) UNSIGNED DEFAULT '1' NOT NULL, ".
	...
	$TABLE_DEF->fields["subject_ids"] = new CER_DB_FIELD("subject_ids","tinyint(3) unsigned","","","1","");
...
// `kb_comments` table
// ***************************************************************************
function init_table_kb_comments()
{
	global $cerberus_db;
	
	$TABLE_DEF = new CER_DB_TABLE("kb_comments",false);
	
	$TABLE_DEF->create_sql = "CREATE TABLE `kb_comments` (".
...
// `kb_ratings` table
// ***************************************************************************
function init_table_kb_ratings()
{
	global $cerberus_db;
	
	$TABLE_DEF = new CER_DB_TABLE("kb_ratings",false);
	
	$TABLE_DEF->create_sql = "CREATE TABLE `kb_ratings` (".
...
function init_table_public_gui_profiles()
{
	...
	$TABLE_DEF->create_sql = "CREATE TABLE `public_gui_profiles` (".
								...
								"  `pub_mod_kb_root` int(10) unsigned NOT NULL default '0',".
	...
	$TABLE_DEF->fields["pub_mod_kb_root"] = new CER_DB_FIELD("pub_mod_kb_root","int(10) unsigned","","","0","");
	...
	$TABLE_DEF->fields["pub_url"] = new CER_DB_FIELD("pub_url","varchar(255)","","","","");
...
function init_table_queue()
{
	...
	$TABLE_DEF->fields["queue_reply_to"] = new CER_DB_FIELD("queue_reply_to","char(128)","","","","");
...
function init_table_ticket()
{
	...
	$TABLE_DEF->create_sql = "CREATE TABLE `ticket` (".
								...
								"  `is_waiting_on_customer` tinyint(3) unsigned NOT NULL default '0',".
								"  `num_flags` tinyint(3) unsigned NOT NULL default '0',".
								"  `opened_by_address_id` bigint(20) unsigned DEFAULT '0' NOT NULL,".
								...
								"  KEY `is_waiting_on_customer` (`is_waiting_on_customer`),".
								"  KEY `num_flags` (`num_flags`),".
	...
	$TABLE_DEF->fields["is_closed"] = new CER_DB_FIELD("is_closed","tinyint(3) unsigned","","MUL","0","");
	$TABLE_DEF->fields["is_deleted"] = new CER_DB_FIELD("is_deleted","tinyint(3) unsigned","","MUL","0","");
	$TABLE_DEF->fields["is_waiting_on_customer"] = new CER_DB_FIELD("is_waiting_on_customer","tinyint(3) unsigned","","MUL","0","");
	$TABLE_DEF->fields["num_flags"] = new CER_DB_FIELD("num_flags","tinyint(3) unsigned","","MUL","0","");
	$TABLE_DEF->fields["opened_by_address_id"] = new CER_DB_FIELD("opened_by_address_id","bigint(20) unsigned","","MUL","0","");
	...
	$TABLE_DEF->indexes["is_closed"] = new CER_DB_INDEX("is_closed","1","is_closed");
	$TABLE_DEF->indexes["is_deleted"] = new CER_DB_INDEX("is_deleted","1","is_deleted");
	$TABLE_DEF->indexes["is_waiting_on_customer"] = new CER_DB_INDEX("is_waiting_on_customer","1","is_waiting_on_customer");
	$TABLE_DEF->indexes["num_flags"] = new CER_DB_INDEX("num_flags","1","num_flags");
	$TABLE_DEF->indexes["opened_by_address_id"] = new CER_DB_INDEX("opened_by_address_id","1","opened_by_address_id");
...
function init_table_ticket_views()
{
	...
	$TABLE_DEF->fields["view_params"] = new CER_DB_FIELD("view_params","text","","","","");	
	$TABLE_DEF->fields["dashboard_id"] = new CER_DB_FIELD("dashboard_id","bigint(20) unsigned","","","0","");	
	$TABLE_DEF->fields["view_order"] = new CER_DB_FIELD("view_order","tinyint(3) unsigned","","","0","");	
...
function init_table_user()
{
	...
	$TABLE_DEF->create_sql = "CREATE TABLE `user` (".
								...
								"  `user_display_name` char(32) DEFAULT '' NOT NULL,".
	...
	$TABLE_DEF->fields["user_display_name"] = new CER_DB_FIELD("user_display_name","char(32)","","","","");
	$TABLE_DEF->fields["user_ws_enabled"] = new CER_DB_FIELD("user_ws_enabled","tinyint(3)","","","0","");
	...
	$sql = sprintf("INSERT IGNORE INTO `user` (user_name,user_email,user_email_verify,user_login,user_password,user_superuser) ".
		" VALUES ('Super User', 'superuser@localhost', '', 'superuser', '%s', 1);",
			md5("superuser")
		);
...
function init_table_chat_visitors()
{
   ...
   $TABLE_DEF->create_sql = "CREATE TABLE `chat_visitors` (".
		...
		"  `visitor_os_id` int(10) unsigned default NULL,".
		...
		"  `last_page_id` bigint(20) unsigned default '0' NULL,".
   ...
   $TABLE_DEF->fields["visitor_ip"] = new CER_DB_FIELD("visitor_ip","int(11)","YES","","","");
   $TABLE_DEF->fields["visitor_os_id"] = new CER_DB_FIELD("visitor_os_id","int(10) unsigned","YES","","","");
   ...
   $TABLE_DEF->fields["last_page_id"] = new CER_DB_FIELD("last_page_id","bigint(20) unsigned","YES","","0","");
...
function init_table_team_members()
{
   ...
   $TABLE_DEF->fields["is_watcher"] = new CER_DB_FIELD("is_watcher","tinyint(3) unsigned","","","0","");
