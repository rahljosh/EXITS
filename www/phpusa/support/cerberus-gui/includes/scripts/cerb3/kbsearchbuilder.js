...
function doSearchCriteriaList(lbl) {
   ...
   if(null == con) return;
	con.innerHTML = "Loading...";
	var cObj = YAHOO.util.Connect.asyncRequest('GET', 'rpc.php?cmd=kbsearch_list_criteria&label=' + lbl, {success: cbSearchCriteriaList,failure: handleFailure, argument: {lbl:lbl}});
}
