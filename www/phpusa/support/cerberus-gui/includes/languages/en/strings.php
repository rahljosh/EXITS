...
define("LANG_AUDIT_ACTION_CHANGED_QUEUE","<b>%s</b> moved to mailbox <b>%s</b>.");
...
define("LANG_AUDIT_ACTION_RULE_CHQUEUE","<b>Parser</b> mail rule changed mailbox to <b>%s</b>.");
...
define("LANG_CONFIG_ADDRESS_QUEUES","Select Mailboxes:");
...
define("LANG_CONFIG_GROUPS_EDIT_QUEUE","Change Mailbox");
define("LANG_CONFIG_GROUPS_EDIT_QUEUE_CREATE","Mailbox Create");
define("LANG_CONFIG_GROUPS_EDIT_QUEUE_DELETE","Mailbox Delete");
define("LANG_CONFIG_GROUPS_EDIT_QUEUE_EDIT","Mailbox Edit");
...
define("LANG_CONFIG_MENU_QUEUE_EDIT","Edit/Delete Mailboxes");
define("LANG_CONFIG_MENU_QUEUE_NEW","Create New Mailbox");
...
define("LANG_CONFIG_QUEUE_ADD","Add New Mailbox");
define("LANG_CONFIG_QUEUE_CREATE","Create a New Mailbox");
define("LANG_CONFIG_QUEUE_EDIT_ADDRESS_IE","(for example: support@yourcompany.com)");
define("LANG_CONFIG_QUEUE_EDIT_ADDRESS","Mailbox Address");
...
define("LANG_CONFIG_QUEUE_EDIT","Edit Configuration of Mailbox");
define("LANG_CONFIG_QUEUE_EDIT_NAME_IE","(for example: &quot;Support&quot;)");
define("LANG_CONFIG_QUEUE_EDIT_NAME","Mailbox Name");
...
define("LANG_CONFIG_QUEUE_EDIT_NOID","Cerberus [ERROR]: Mailbox ID is not present.  Aborting.");
...
define("LANG_CONFIG_QUEUE_EDIT_PREFIX","Mailbox Prefix");
define("LANG_CONFIG_QUEUE_TITLE","Mailbox Configuration");
define("LANG_CONFIG_QUEUE_WARNING","Are you sure you want to permanently delete the selected mailboxes?");
...
define("LANG_CONFIG_USER_EDIT_NAME","Real Name");
...
define("LANG_CONFIG_USER_EDIT_QUEUES","Mailbox Access");
...
define("LANG_CONTACTS_COMPANY_SLABOX_TABLE_QUEUEMODE","Mailbox Mode");
define("LANG_CONTACTS_COMPANY_SLABOX_TABLE_QUEUE","Mailbox");
...
define("LANG_DISPLAY_PROPS_TICKET_QUEUE","Ticket Mailbox");
...
define("LANG_DISPLAY_SLABOX_TABLE_QUEUEMODE","Mailbox Mode");
define("LANG_DISPLAY_SLABOX_TABLE_QUEUE","Mailbox");
...
define("LANG_FNR_TITLE","Cerberus Fetch &amp; Retrieve&trade; - Related Articles");
...
define("LANG_HEADER_QUICKQUEUE", "Quick Mailbox");
define("LANG_HEADER_REPORTS","reports");
define("LANG_HEADER_RESULTS","search");
...
define("LANG_LIST_CHANGE_QUEUE","Change Mailbox");
...
define("LANG_MYCERBERUS_NOTIFICATIONS_EVENT_ASSIGNMENT_HEADER", "Event: Ticket Assigned/Suggested to Me");
define("LANG_MYCERBERUS_NOTIFICATIONS_EVENT_CLIENTREPLY_HEADER", "Event: Client Reply on Flagged Ticket");
define("LANG_MYCERBERUS_NOTIFICATIONS_EVENT_NEWTICKET_HEADER", "Event: New Ticket");
define("LANG_MYCERBERUS_NOTIFICATIONS_EVENT_NEWTICKET_QUEUE", "Mailbox");
define("LANG_MYCERBERUS_NOTIFICATIONS_EVENT_NEWTICKET_QUEUES_INFO", "(the mailboxes you want<br>to be notified of new<br>tickets in)<br>");
define("LANG_MYCERBERUS_NOTIFICATIONS_EVENT_NEWTICKET_QUEUES", "Mailboxes:");
...
define("LANG_MYCERBERUS_NOTIFICATIONS_TOKENS_INSTRUCTIONS", "You can use the following tokens in all notification templates:");
...
define("LANG_MYCERBERUS_QUICKASSIGN_INSTRUCTIONS", "The <B>quick assign</B> column below determines which mailboxes will be used by the quick assign feature in the header above.  Choose the mailboxes you would like to have tickets assigned to you from. For example: assign from the mailboxes '<i><B>Support</B></i>' and '<i><B>Sales</B></i>', but don't assign from the mailboxes '<i><B>Failure Notices</B></i>' or '<i><B>Virus/SPAM</B></i>'.<br><br>As a <B>watcher</B> you will receive an e-mail copy of all new tickets and correspondence for the mailboxes you select below. &nbsp;A watcher can read and reply to tickets through any e-mail client, or simply use the e-mail messages as a notification to log into the GUI.<br><br>Your watcher e-mails will be sent to:");
...
define("LANG_MYCERBERUS_QUICKASSIGN_QUEUE", "Mailbox");
...
define("LANG_REFRESH_TITLE","Auto Refresh");
...
define("LANG_SEARCH_ANY_QUEUE","any mailbox");
define("LANG_SEARCH_ANY_STATUS","any status");
define("LANG_SEARCH_COMPANY", "Company Contains");
define("LANG_SEARCH_CONTENT","Content Contains");
define("LANG_SEARCH_INQUEUE","Is in Mailbox");
...
define("LANG_SEARCH_TITLE","Ticket Search");
...
define("LANG_STATUS_QUEUE_LOAD","Mailbox Load %");
...
define("LANG_TICKET_SPAM_TRAINING_IS","Spam");
define("LANG_TICKET_SPAM_TRAINING_NOT","Not Spam");
define("LANG_UNASSIGNED_TITLE","Newest Unassigned Tickets in All Mailboxes");
define("LANG_UPDATE_ATTACHMENT","Send an Attachment");
define("LANG_UPDATE_CC_ADMIN","Admin Cc");
define("LANG_UPDATE_CC","Cc");
define("LANG_UPDATE_CC_QUEUE","Mailbox Cc");
...
define("LANG_UPDATE_NEXT_QUEUE", "%s Mailbox List");
...
define("LANG_WORD_QUEUE","Mailbox");
define("LANG_WORD_QUEUES","Mailboxes");
