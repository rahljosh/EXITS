	...
	switch($form_submit)
	{
		case "mail_settings":
			...
			$sql = sprintf("UPDATE configuration SET ".
				...
				"mail_delivery=%s,smtp_server=%s,sendmail=%d,".
...
//						$cerberus_db->query($sql);
		...
		case "rules_edit":
		{
			...
			// [JAS]: Loop through form input for rule actions and add to database
 			$rule_actions = array("rule_act_chowner","rule_act_chqueue","rule_act_chstatus","rule_act_chpriority","rule_act_break", "rule_act_pre_redirect", "rule_act_pre_bounce","rule_act_pre_ignore","rule_act_pre_no_autoreply","rule_act_pre_no_notification","rule_act_clearworkflow","rule_act_tags","rule_act_flags","rule_act_agents");
