...
class CER_USER_PREFS
{
	...
	function _load_user_prefs($uid="")
	{
		...
		$sql = sprintf("SELECT prefs.ticket_order, prefs.user_language, prefs.signature_pos, prefs.signature_autoinsert, sig.sig_content, prefs.page_layouts, prefs.keyboard_shortcuts, prefs.gmt_offset ".
