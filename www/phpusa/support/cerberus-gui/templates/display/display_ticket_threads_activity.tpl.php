...
{if !empty($oThread->thread_to) && !$oThread->is_agent_message}
...
{if !empty($oThread->thread_replyto) && !$acl->has_restriction($smarty.const.REST_EMAIL_ADDY,$smarty.const.BITGROUP_2)}
