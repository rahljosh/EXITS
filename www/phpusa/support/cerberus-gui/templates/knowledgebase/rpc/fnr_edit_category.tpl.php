...
<tbody>
  ...
  <tr>
    <td align="right"></td>
    <td><input name="save" value="Save Changes" type="button" onclick="javascript:doFnrCategoryEdit();"><input name="delete" value="Delete" type="button" onclick="javascript:doFnrCategoryDelete();"></td>
  </tr>
</tbody>
</table>
