...
echo "Indexing <b>" . ($total-$to) . "</b> to <B>" . ($total-(0<$from?$from:0)) . "</B> of <b>$total</b> e-mails.&nbsp; &nbsp;<b>";
...
$sql = sprintf("SELECT t.ticket_id from ticket t where t.ticket_id > %d AND t.ticket_id <= %d ORDER BY t.ticket_id DESC",
	$from,
	$to
);
