<?php /* Smarty version 2.5.0, created on 2007-01-15 18:59:11
         compiled from display/display_ticket_workflow.tpl.php */ ?>
<?php echo '
...
<a href="#" onclick="javascript:toggleDisplayWorkflow();"><img alt="Toggle" id="ticket_display_workflow_icon" src="includes/images/<?php if ($this->_tpl_vars['session']->vars['login_handler']->user_prefs->page_layouts['layout_display_show_workflow']): ?>icon_collapse.gif<?php else: ?>icon_expand.gif<?php endif; ?>" width="16" height="16" border="0"></a>
...
<div id="ticket_display_workflow" style="display:<?php if (! empty ( $this->_tpl_vars['hp'] ) || $this->_tpl_vars['session']->vars['login_handler']->user_prefs->page_layouts['layout_display_show_workflow']): ?>block<?php else: ?>none<?php endif; ?>;">
<table width="100%" border="0" cellspacing="0" cellpadding="2" class="ticket_display_table">
	<tr>
		<td>
	        ...
	        <tr>
	        	 <td valign="top">
					<span id="workflowSnapshot_<?php echo $this->_tpl_vars['ticket']; ?>
">Initializing...<br></span>
					<script type="text/javascript">YAHOO.util.Event.addListener(document.body,"load",ticketWorkflow.refresh());</script>
	        	 </td>
	          <td valign="top">
	          	<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include("display/boxes/box_quick_workflow.tpl.php", array('ticketId' => $this->_tpl_vars['ticket']));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
				<script>
					YAHOO.util.Event.addListener(document.body, "load", autoTags('tag_input_<?php echo $this->_tpl_vars['ticket']; ?>
','searchcontainer_<?php echo $this->_tpl_vars['ticket']; ?>
'));
