...
<cfoutput>
<cfmail from="helpdesk@student-management.com" to="#get_user_info.email#" subject="SMG Help Desk - New Message Submitted">
...
and the SMG Technical Support Team will be reviewing it soon.

Please click on the link to check the status, review the item, or add additional information. 

http://www.student-management.com/?link=#get_link_id.linkid#
...
<cfmail from="helpdesk@student-management.com" to="#assigned_to.email#, wayne@iseusa.com" subject="AXIS Help Desk - New Message Submitted">
	Dear #assigned_to.firstname# #assigned_to.lastname#,
	
	A new request of service has been submitted to you.
	Item Link: http://www.phpusa.com/?link=#get_link_id.linkid#
