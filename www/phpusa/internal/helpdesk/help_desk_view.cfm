...
<cfquery name="help_desk_principal" datasource="MySql">
...
<table width=100% cellpadding=0 cellspacing=0 border=0 height=24>
	<tr valign=middle height=24 >
		...
		<td width=26 ><img src="pics/helpdesk.gif"></td>
		<td><h2>Reviewing a Ticket</h2></td>
	
	</tr>
</table>
<!--- BODY OF TABLE --- USER'S ITEMS  --->
<table width=100% border=0 cellpadding=4 cellspacing=0 class="section">
	<tr background="images/back_menu2.gif"><td width="4%"><h3><u>ID</u></h3></td>
...
<table width=100% border=0 cellpadding=4 cellspacing=0 class="section">
	...
	<tr bgcolor="e2efc7">
		...
		<td width="21%" align="left">
			...
			<cfquery name="global" datasource="MySql">
