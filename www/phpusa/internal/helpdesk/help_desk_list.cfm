...
<tr><td width="49%" align="left">
	...
	<table border=0 cellpadding=4 cellspacing=0 class="section" align="center" width=100%>
	<tr>
		<td>
		<h2>Help Desk <cfif IsDefined('url.new')> - Adding a New Ticket</cfif> </h2></td>
		
	</table>
	<table width=100% border=0 cellpadding=4 cellspacing=0 class="section">
		<tr background="images/back_menu2.gif"><td><cfif IsDefined('url.new')> <font size="1" color="#3333FF">Please try to include as much information as possible.</font> <cfelse>&nbsp;</cfif></td></tr>
	</table>
	<div class="box2">
		<cfif not IsDefined('url.new')>
		<table>
			<tr background="images/back_menu2.gif">
				
			</tr><tr>
			<td width="100%"><div align="justify">
					<p>Please, fill out the form and submit the information. Your message 
					will be forwarded to the AXIS support team.  You will then receive an 
...
<table border=0 cellpadding=4 cellspacing=0 width=100%>
	<tr>
			<td><h2>Your Tickets</h2></td>
			<td align="right">#help_desk_user.recordcount# message(s) displayed</td>
	...
	<table width=100% border=0 cellpadding=4 cellspacing=0>
		<tr background="images/back_menu2.gif"><td width="20%" ><u>Submitted</u></td>	<td width="36%"><u>Subject</u></td>
	...
	<div class="scroll2">
		...
		<cfif help_desk_user.recordcount is not 0>
			<cfoutput query="help_desk_user">
				...
				<tr bgcolor="#iif(help_desk_user.currentrow MOD 2 ,DE("e9ecf1") ,DE("white") )#">
...
<table border=0 cellpadding=4 cellspacing=0 class="section" width=90% align="Center">
	<tr background="images/back_menu2.gif">	
...
<div class="scroll">
	...
	<cfif help_desk_list.recordcount is not 0>
		...
		<cfquery name="check_sub_items" datasource="MySql">
			...
			<tr bgcolor="FFC4C5">
			<cfelse>
			<tr bgcolor="#iif(help_desk_list.currentrow MOD 2 ,DE("e9ecf1") ,DE("white") )#">
			</cfif>
