		...
		<td>
			...
			Personal Information [<a href="?curdoc=users/edit_user&id=#URL.userID#"> EDIT </a>]
				<cfif client.usertype LT 4>
					<cfif qGetUserInformation.changepass eq 1>
												...
												<TBODY>
													<TR>
														<TD valign="center">
															<!----Employtment Info---->
																<cfif usertype is 5>
															<cfif qGetUserInformation.insurance_policy_type is ''><font color="FF0000">Missing insurance type for this Agent</font>
																<cfelseif qGetUserInformation.insurance_policy_type is 'none'>Does not take insurance provided by SMG
																<cfelse>Takes #qGetUserInformation.insurance_policy_type# insurance provided by SMG
															</cfif><br>
															<cfif qGetUserInformation.accepts_sevis_fee is ''>Missing SEVIS fee information
																<cfelseif qGetUserInformation.accepts_sevis_fee is '0'>Does not accept SEVIS fee
