...
<cfquery name="supervisor" datasource="mysql">
select php_superviser
from smg_users
where userid = #progress_Report.userid#
</cfquery>
<!----
...
select advisorid
from user_access_rights
where userid = #rep_on_report.userid# and companyid = #client.companyid# 
</cfquery>
----->
...
<table width=90% cellpadding=0 cellspacing=0 border=0 align="center">
	<tr valign=middle height=24>
		<td width="57%" valign="middle" bgcolor="##e9ecf1"><h2 align="left" class="style1">&nbsp;Progress Report for #student_host_name.firstname# #student_host_name.familylastname# </h2></td>
	</tr>
</table>
				<!----Sizing Table---->	
				...
				<table border=0 width=100%>
					<tr>
						...
						<td width=50% valign="top" align="left">
									...
									<!----Table that shows status of approval----->
									
									<table>
										<th bgcolor="CC0000"><font color="white">Status</th>
										<tr>
											<td bgcolor="ededed">
											Supervisor Approval: <Cfif supervisor.php_superviser is 0>N/A<cfelseif tracking_info.date_Ra_approved is ''>Pending<cfelse>#DateFormat(tracking_info.date_ra_approved, 'mm/dd/yyyy')# @ #TimeFormat(tracking_info.date_ra_approved, 'h:mm:ss tt')#</cfif><br>
							...
							<td valign="top" align="right">
											...
											<tr>
												...
												<cfelseif client.usertype is 7 and tracking_info.date_Rd_approved is ''>
											...
											<tr>
												...
												<cfelseif client.usertype is 7 and tracking_info.date_Rd_approved is ''>
												<form action="?curdoc=querys/approve_progress_report&number=#url.number#&stu=#stu_id.stuid#&month=#progress_Report.month_of_report#<cfif IsDefined('url.regionid')>&regionid=#url.regionid#</cfif>" method="post"><input type="hidden" name="edit" value="yes"><input name="Submit" type="image" src="pics/approve.gif" alt="Approve Report"  border=0></form></td>
												<Cfelseif client.usertype is 5 and tracking_info.ny_accepted is ''>
												<form action="?curdoc=querys/approve_progress_report&number=#url.number#&stu=#stu_id.stuid#&month=#progress_Report.month_of_report#<cfif IsDefined('url.regionid')>&regionid=#url.regionid#</cfif>" method="post"><input type="hidden" name="edit" value="yes"><input name="Submit" type="image" src="pics/approve.gif" alt="Approve Report"  border=0></form></td>
												<cfelseif client.usertype lt 5 and tracking_info.date_Rd_approved is not  ''>
												<form action="?curdoc=querys/approve_progress_report&number=#url.number#&stu=#stu_id.stuid#&month=#progress_Report.month_of_report#<cfif IsDefined('url.regionid')>&regionid=#url.regionid#</cfif>" method="post"><input type="hidden" name="edit" value="yes"><input name="Submit" type="image" src="pics/approve.gif" alt="Approve Report"  border=0></form></td>
											...
											<cfif client.usertype LTE '4'> 
											<tr>
												<td>&nbsp; <a href="javascript:OpenLetter('reports/email_progress_report.cfm?number=#url.number#');"><img src="pics/email.gif" border="0" alt="Email Progress Report"> Email</a></td>
											</tr>
											</cfif>
										</Table>
								</td>
