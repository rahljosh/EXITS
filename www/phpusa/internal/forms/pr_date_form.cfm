...
<table border=0 cellpadding=4 cellspacing=0>
    <tr>
        ...
        <td><cfinput type="text" name="prdate_date" value="#dateFormat(form.prdate_date, 'mm/dd/yyyy')#" size="10" class="datePicker" maxlength="10" mask="99/99/9999" required="yes" validate="date" message="Please enter a valid Date."> mm/dd/yyyy</td>
    </tr>
    <tr>
