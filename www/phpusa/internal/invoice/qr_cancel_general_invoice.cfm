					...
					<table border="0" cellpadding="3" cellspacing="0" width="90%" align="center">
						...
						<tr><td width="100%" valign="top">	
								<table border="0" cellpadding="3" cellspacing="0" width="100%">
									...
									<tr><td>&nbsp;</td></tr>
									<tr bgcolor="##C2D1EF"><th><a href="?curdoc=invoice/create_general_invoice_view&i=#URLEncodedFormat(form.i)#"><img src="pics/back.gif" border="0" /></a></th></tr>						
								</table>
							</td>
						</tr>
					</table>
...
alert("You have successfully updated this page. Thank You.");
	location.replace("?curdoc=invoice/create_general_invoice_view&i=#URLEncodedFormat(form.i)#");
-->
</script>
