    ...
    UNION ALL    
        ...
        GROUP BY ttt.intrepid 
            ...
            <cfif getAgentInfo.billing_email IS NOT "" AND getTotalBalancePerAgent.recordCount NEQ 0>
            													<!--- #getAgentInfo.billing_email# --->
                <cfmail from="marcel@student-management.com" to="marcel@student-management.com" bcc="marcel@student-management.com" subject="#getAgentInfo.businessname# - PHP PROGRAM - Balance Due" type="html">
