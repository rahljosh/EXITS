    ...
    UNION ALL    
        ...
        GROUP BY ttt.intrepid 
            ...
            <cfif variables.missingEmail NEQ 1 AND getTotalBalancePerAgent.recordCount NEQ 0>
                ...
                <cfmail from="marcel@student-management.com" to="#getAgentInfo.php_billing_email#" bcc="marcel@student-management.com" subject="#getAgentInfo.businessname# (#getAgentInfo.userid#) - PHP PROGRAM - Balance Due" type="html">
