...
<table width="95%" cellpadding=2 cellspacing="0" align="center" frame="below">	
	<cfloop query="get_students">
		<tr bgcolor="#iif(get_students.currentrow MOD 2 ,DE("ededed") ,DE("white") )#">
			...
			<td width="7%"><i><font size="-2"><cfif return_student EQ '0'>No<cfelseif return_student eq 1>Return<cfelseif return_student eq 2>Extend<cfelseif return_student eq 3>Transfer</cfif></font></i></td>
