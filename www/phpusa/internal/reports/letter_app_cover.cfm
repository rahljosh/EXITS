...
<cfif NOT IsDefined('form.extra_comments')>
	...
	<cfform name="comments" action="letter_app_cover.cfm" method="post">
		<input type="hidden" name="unqid" value="#url.unqid#">
		<input type="hidden" name="assignedid" value="#url.assignedid#">
...
<cfelse>
	...
	<cfquery name="get_student_unqid" datasource="MySql">
		...
		AND stu_prog.assignedid = <cfqueryparam value="#form.assignedid#" cfsqltype="cf_sql_integer">
	</cfquery>
