...
<Table class="nav_bar" cellpadding=2 cellspacing="0" width="90%" align="center">
	<tr><td bgcolor="##C4CDE7"><b>Labels and Student ID Cards</b></td></tr>
</table>
...
<tr><td>
	...
	<table cellpadding=2 cellspacing="0" align="center" width="100%">
		<tr>
			<td width="50%" valign="top">
				...
				<Table cellpadding=2 cellspacing="0" width="100%">
					<tr><th colspan="2" bgcolor="##C4CDE7">Student ID Cards</th></tr>
					<tr>
			...
			<td width="50%" valign="top">
				...
				<Table cellpadding=2 cellspacing="0" width="100%">
					<tr><th colspan="2" bgcolor="##C4CDE7">Student ID Cards LIST</th></tr>
					<tr>
						<td align="right">Program :</td>
						<td><cfselect name="programid" multiple size="5">
								<cfloop query="get_programs"><option value="#programid#">#programname# &nbsp;</option></cfloop>
		...
		<tr><th colspan="2">PS: Please set your margins as follow: top 0.4in / bottom 0.4in / left 0.4in / right 0.4in for ID Cards.</th></tr>
	</table><br>
	...
	<table cellpadding=2 cellspacing="0" align="center" width="100%">
		<tr>
			<td width="50%" valign="top">
				...
				<Table cellpadding=2 cellspacing="0" width="100%">
					<tr><th colspan="2" bgcolor="##C4CDE7">Student Labels (HF and School)</th></tr>
					<tr>
						<td align="right">Program :</td>
						<td><cfselect name="programid" multiple size="5">
								<cfloop query="get_programs"><option value="#programid#">#programname# &nbsp;</option></cfloop>
			...
			<td width="50%" valign="top">
				...
				<Table cellpadding=2 cellspacing="0" width="100%">
					<tr><th colspan="2" bgcolor="##C4CDE7">School Labels</th></tr>
					<tr>
						<td align="right">Program :</td>
						<td><cfselect name="programid" multiple size="5">
								<cfloop query="get_programs"><option value="#programid#">#programname# &nbsp;</option></cfloop>
	...
	<table cellpadding=2 cellspacing="0" align="center" width="100%">
		<tr>
			<td width="50%" valign="top">
				...
				<Table cellpadding=2 cellspacing="0" width="100%">
					<tr><th colspan="2" bgcolor="##C4CDE7">Host Famliy Labels</th></tr>
					<tr>
						<td align="right">Program :</td>
						<td><cfselect name="programid" multiple size="5">
								<cfloop query="get_programs"><option value="#programid#">#programname# &nbsp;</option></cfloop>
			...
			<td width="50%" valign="top">
				...
				<Table cellpadding=2 cellspacing="0" width="100%">
					<tr><th colspan="2" bgcolor="##C4CDE7">Bulk Host Famliy Letter</th></tr>
					<tr>
						<td align="right">Program :</td>
						<td><cfselect name="programid" multiple size="5">
								<cfloop query="get_programs"><option value="#programid#">#programname# &nbsp;</option></cfloop>
