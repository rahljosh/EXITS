...
<!--- stu_prog.ds2019_no, stu_prog.ds2019_received --->
<cfquery name="get_student_unqid" datasource="MySql">
	SELECT s.studentid, s.firstname, s.middlename, s.familylastname, s.dob, s.sex, s.uniqueid, s.flight_info_notes,
		...
		stu_prog.dateplaced, stu_prog.school_acceptance, stu_prog.active
	FROM smg_students s
...
<CFSET ImgScrPath = "http://www.phpusa.com">
 
<cfif get_student_unqid.email EQ ''>
	There is no email information for this school. Please make sure there is one in order to submit flight information.
	<cfabort>
</cfif>

<CFMAIL SUBJECT="Flight Information for #get_student_unqid.firstname# #get_student_unqid.familylastname# (###get_student_unqid.studentid#)"
TO="#get_student_unqid.email#" bcc="#get_current_user.email#"
...
TYPE="HTML">
	...
	<table width="670" align="center" border=0 bgcolor="##FFFFFF" cellpadding="2"> 
		<tr>
			...
			<table>
				...
				<tr><td>E-MAIL:</td><td>#get_student_unqid.email#</td></tr>
				<tr><td colspan="2">#DateFormat(now(), 'dddd, mmmm dd, yyyy')#</td></tr>
				<tr><td>&nbsp;</td></tr>
			</table>
			</td>
			<td valign="top" rowspan=4 align="center"><img src="#ImgScrPath#/internal/pics/dmd-logo.jpg"></td>
	...
	<table width="670" align="center" border=0 cellpadding="1" cellspacing="1">
		<tr><td>Thanks,</td></tr>	
		<tr><td>&nbsp;</td></tr>
		<tr><td><img src="#ImgScrPath#/internal/pics/lukesign.jpg" border="0"></td></tr>
...
<cfoutput>
<br />
<table border="0" align="center" width="680" valign="top" frame="box">
<tr><td align="center"><span class="application_section_header">Flight Information</span></td></tr>
<tr><td align="center"><h2><u>#get_student_unqid.firstname# #get_student_unqid.familylastname# ( ###get_student_unqid.studentid# )</u></h2></td></tr>
<tr align="center" bgcolor="##ACB9CD"><td>This flight information has been sent to #get_student_unqid.schoolname# at #get_student_unqid.email#</td></tr>
