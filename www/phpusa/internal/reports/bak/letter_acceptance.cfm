...
<table width=650 align="center" border=0 bgcolor="FFFFFF"> 
	<tr>
		...
		<table>
			...
			<tr><td>&nbsp;</td></tr>
			<tr><td colspan="2"><cfform action="letter_acceptance_email.cfm?unqid=#uniqueid#" name="sendemail" method="post" onsubmit="return confirm ('Are you sure? This Acceptance Letter will be sent to #businessname#')">
