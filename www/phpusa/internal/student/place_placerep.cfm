...
<title>Placement Management - Placing Representative</title>
</head>
...
<cfquery name="get_available_reps" datasource="mysql">
	...
	WHERE u.active = '1' 
		...
		AND (uar.usertype = '7' or uar.usertype = 6)
	ORDER BY u.lastname
</cfquery>
...
<cfif get_student_unqid.schoolid EQ 0>
	<table width="580" border="0" cellpadding="2" align="center" bgcolor="##ffffff" class="box">
		<tr bgcolor="##C2D1EF"><td align="center"><b>Placing Representative</b></td></tr>
...
<!---  SELECT NEW PLACING REPRESENTATIVE --->
<cfif NOT IsDefined('url.change')>
	<table width="580" border="0" cellpadding="2" align="center" bgcolor="##ffffff" class="box">
		<tr bgcolor="##C2D1EF"><td align="center" colspan="2"><b>Placing Representative</b></td></tr>
		<!--- SELECT A PLACING REPRESENTATIVE --->
		<cfif get_student_unqid.placerepid EQ 0>
			<cfform action="qr_place_placerep.cfm?unqid=#get_student_unqid.uniqueid#" method="post">
			<cfinput type="hidden" name="assignedid" value="#get_student_unqid.assignedid#">
			<tr><td colspan="2">The following Placing Representatives are available for this student:</td></tr>
			<tr><td>				
		...
		<!--- STUDENT IS ASSIGNED TO A PLACING REPRESENTATIVE --->
		<cfelse>
		<!----
		
			<cfif rep_info.recordcount is '0'>	
				<tr><td colspan="2">Placing Representative (#get_student_unqid.placerepid#) was not found in the system.</td></tr>
			<cfelse>
				<tr><td colspan="2">			
			...
			<cfform action="place_placerep.cfm?unqid=#get_student_unqid.uniqueid#&change=yes"  method="post">
			<tr>
				<td align="center" width="50%"><input name="submit" type="image" src="../pics/update.gif" align="right" border=0></td>
				<td align="center" width="50%"><input type="image" value="close window" src="../pics/close.gif" onclick="javascript:window.close()"></td>
			</tr>
...
---->
		...
		<cfform action="place_change_placerep.cfm?unqid=#url.unqid#"  method="post">
