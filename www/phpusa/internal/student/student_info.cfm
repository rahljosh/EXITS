            ...
            <td align="right" valign="top" width="200"  class="box">
                <div id="subMenuNav"> 
                    <div id="subMenuLinks">  
                        ...
                        <a href="" onClick="javascript: win=window.open('http://ise.exitsapplication.com/nsmg/index.cfm?curdoc=virtualfolder/view&unqid=#get_student_unqid.uniqueID#', 'Settings', 'height=600, width=700, location=no, scrollbars=yes, menubars=no, toolbars=no, resizable=yes'); win.opener=self; return false;">Virtual Folder</a>						
                        <!--- Flight Information --->
