...
<cfif NOT IsDefined('form.studentid')>
	...
	<cfquery name="update_student" datasource="mysql">
		UPDATE smg_students
		SET interests = <cfif NOT IsDefined('form.interests')>''<cfelse>'#form.interests#'</cfif>,
	...
	<cflocation url="?curdoc=student/student_form5&unqid=#get_uniqueid.uniqueid#" addtoken="no">
	<!---
	<html>
	<head>
