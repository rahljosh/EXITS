...
<cfsilent>
    ...
    <cfparam name="FORM.placementNotes" default="">
               	...
               	<table width="90%" cellpadding="2" cellspacing="0" class="section paperwork" align="center"> 
                    <tr>
                        <td class="placementMgmtInfo" align="center">
                            <label class="fieldCenterTitle" for="placementNotes">
                            ...
                            <textarea name="placementNotes" id="placementNotes" class="xxLargeTextArea">#FORM.placementNotes#</textarea>
                        </td>
                    </tr>
                </table>
