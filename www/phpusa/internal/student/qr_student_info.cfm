...
<cfquery name="get_student_info" datasource="mysql">
	SELECT s.studentid, s.uniqueid, s.jan_app, s.firstname, s.familylastname, s.studentid,
		stu_prog.assignedid, stu_prog.hostid, stu_prog.schoolid, stu_prog.programid, stu_prog.canceldate,
		u.businessname,
		sc.schoolname
	FROM smg_students s
...
<cfif IsDefined("form.student_cancel")>
	...
	<cfmail to="craig@intoedventures.org" from="support@phpusa.com" subject='PHP Cancelation - #get_student_info.firstname# #get_student_info.familylastname# (###get_student_info.studentid#)' type="html" failto="support@phpusa.com">
		...
		<table align="center">
			...
			<tr><td>Intl. Rep.: #get_student_info.businessname#</td></tr>
			<tr><td>Student: #get_student_info.firstname# #get_student_info.familylastname# (###get_student_info.studentid#)</td></tr>
			<tr><td>Cancel Date: #DateFormat(form.date_canceled, 'mm/dd/yyyy')#</td></tr>
			<tr><td>Cancel Reason: #form.Reason_canceled#</td></tr>
			<tr><td>Applying School: #get_student_info.schoolname#</td></tr>
