            ...
            <tr>
                <td> 
                    ...
                    <table cellpadding="2" cellspacing="0" align="center" class="placementLetterTableNoBorder">
                        <tr>
                            <td colspan="4">
                                <p style="margin:5px 0px 5px 0px;">The student will attend the following school:</p>
                            </td>
                        </tr>                 
                        <tr>
    ...
    <cfswitch expression="#FORM.pisAction#">
        ...
        <cfcase value="emailPIS">
            ...
            <cfinvoke component="internal.extensions.components.email" method="send_mail">
                ...
                <cfinvokeargument name="email_from" value="""#qGetCompany.companyshort_nocolor# - #CLIENT.firstname# #CLIENT.lastname#"" <#CLIENT.email#>">
