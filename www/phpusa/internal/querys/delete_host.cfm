...
<cfelse>
	...
	<cfif check_students.recordcount NEQ '0' OR check_cbcs.recordcount NEQ '0'>  <!--- THERE ARE STUDENTS ASSIGNED TO THIS HOST --->
		<h2>&nbsp;&nbsp;&nbsp;&nbsp;<img src="pics/deletex.gif">D e l e t e  -  E r r o r </strong>
...
<!--- none students are assigned to the HOST, - DELETE HOST --->
		...
		<table width=100% cellpadding=0 cellspacing=0 border=0 height=24>
			<tr valign=middle height=24>
				<td height=24 width=13 ba>&nbsp;</td>
				<td width=26 ><img src="pics/deletex.gif"></td>
				<td ><h2>Host Family Deleted Successfully </h2></td>
		...
		<tr><td align="center"><a href="?curdoc=lists/hosts"><img src="pics/back.gif" border="0"></img></a></td></tr>
		</table>
