...
<Table class="nav_bar" cellpadding=3 cellspacing="0" width="90%" align="center">
	<tr><th bgcolor="##C4CDE7">VIRGINIA SURETY INSURANCE - EXCEL FILES AND REPORTS</th></tr>
</table><br />
...
<table cellpadding=3 cellspacing="0" align="center" width="100%">
	<tr>
		<td width="50%" valign="top">
			<cfform action="?curdoc=insurance/vsc_new_programid" method="POST">
			<Table cellpadding=3 cellspacing="0" width="100%">
				<tr><th colspan="2" bgcolor="C4CDE7">VIRGINIA SURETY - New Transaction</th></tr>
				<tr><td colspan="2" bgcolor="C4CDE7" align="center">Students never been insured for the program.</td></tr>
				<tr align="left">
					<TD>Program :</td>
				...
				<tr align="left">
					...
					<TD><select name="php_insurance_typeid">
						<cfloop query="get_insurance_policies"><option value="#insutypeid#">#type#</option></cfloop>
						</select>
					</td>
				</tr>				
				<tr><td colspan="2">According to arrival or school start / school end date or program end date.</td></tr>
	...
	<tr>
		<td width="50%" valign="top">
			<Table cellpadding=3 cellspacing="0" width="100%">
				...
				<tr><td align="center"><b>Transaction</b></td><td align="center"><b>Insurance Type</b></td><td align="center"><b>Total of Students</b></td></tr>
		...
		<td width="50%" valign="top">
			<cfform action="?curdoc=insurance/vsc_manual_transaction" method="POST">
			<Table cellpadding=3 cellspacing="0" width="100%">
				...
				<tr>
					...
					<td><cfselect name="insurance_typeid">
							<option value="0"></option>
							<cfloop query="get_insurance_policies">
