...
LEFT JOIN php_students_in_program ON php_students_in_program.studentid = fi.studentid
...
php_students_in_program.programid= 262
OR php_students_in_program.programid = 230
...
AND fi.studentid NOT IN (SELECT studentid from php_insurance_batch where studentid = fi.studentid)
