...
<cfquery name="get_students" datasource="MySQL">
  SELECT 	s.firstname, s.familylastname, s.sex, s.dob, s.studentid, s.intrep,s.uniqueid,
			u.insurance_typeid,
			p.insurance_enddate, 
			c.countrycode,
			co.orgcode
...
<CFMAIL SUBJECT="EXITS - Flight Information for #get_students.firstname# #get_students.familylastname# (###get_students.studentid#)"
TO="#email_to#"
FROM="""Support"" <support@phpusa.com>"
TYPE="HTML">
...
<tr><td bgcolor=b5d66e></td></tr>
<tr><td><br>Luke,<br><br></td></tr>
...
<tr><td>
	Please click 
	<a href="http://www.phpusa.com/internal/index.cfm?curdoc=student/student_info&unqid=#get_students.uniqueid#">here</a>
	to see the student's flight information.<br><br>
</td></tr>	
<tr><td>
	 Sincerely,<br>
	 EXITS - DMD Private High School <br><br>
</td></tr>
</table>
