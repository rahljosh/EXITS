...
<div class="mainContent">
 <h1>George Elliot Secondary</h1>
 <hr /> <hr />
 <div class="slideDisplay">
<a href="javascript:gotoshow()"><img src="GEpic/pic1.jpg" name="slide" border=1></a>
<script>
<!--

//configure the paths of the images, plus corresponding target links
slideshowimages("GEpic/pic1.jpg","GEpic/pic1.jpg")
...
<hr />
 <br />  
 <p>George Elliot Secondary school is located just outside of the city and has a smaller student population. They have about 950 students attend grades 8 through 12. Courses include Marine Biology, World History, Dance, Theatre and Fine Arts. The school also offers a Fire Fighting course. Sports include Track and Field, Volleyball, Basketball and Tennis. </p>
