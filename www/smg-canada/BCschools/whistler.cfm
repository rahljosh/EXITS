...
<div class="mainContent">
 <h1>Whistler Secondary</h1>
 <hr /> <hr />
 <div class="slideDisplay">
<a href="javascript:gotoshow()"><img src="Wstlrpics/pic1.jpg" name="slide" border=1></a>
<script>
<!--

//configure the paths of the images, plus corresponding target links
slideshowimages("Wstlrpics/pic1.jpg","Wstlrpics/pic1.jpg")
...
<hr />
 Whistler Secondary is located in a densely populated suburb with a permanent population of about 10,000. Whistler is an absolute dream to any student that enjoys winter activities. Whistler Secondary however has a small town feel to it considering its student population of 375. Even though it is quite small, the staff at Whistler Secondary has been able to retain many of the sports and electives that are offered in larger high schools. Some of the sports include soccer, golf, and tennis. Electives such as drawing, painting, choir, and other fine arts are some of the choices students have. 
