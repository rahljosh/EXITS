...
<div class="mainContent">
 <h1>Selkirk Secondary</h1>
 <hr /> <hr />
 <div class="slideDisplay">
<a href="javascript:gotoshow()"><img src="skpics/pic1.jpg" name="slide" border=1 width=412 height=308></a>
<script>
<!--

//configure the paths of the images, plus corresponding target links
slideshowimages("skpics/pic1.jpg","skpics/pic2.jpg")
...
<hr />
 Selkirk Secondary school is located within walking distance of the Kimberley Alpine resort. This gives every student easy access to the mountain all year round. With a student population of about 450, Selkirk is able to offer all of the traditional academic programs while maintaining some of its own unique electives such as equine studies, forensics, law, drafting, metals, and automotive shop.  Sports offered: Soccer, badminton, skiing and snowboarding, track and field, and swimming.<br />
<hr />
<br />
