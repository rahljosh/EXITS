...
<div class="mainContent">
 <h1>Mount Boucherie Secondary</h1>
 <hr /> <hr />
 <div class="slideDisplay">
<a href="javascript:gotoshow()"><img src="mtb/pic2.jpg" name="slide" border=1></a>
<script>
<!--

//configure the paths of the images, plus corresponding target links
slideshowimages("mtb/pic1.jpg","mtb/pic2.jpg","mtb/pic3.jpg")
...
<hr />
 <br />  
 <p>Mount Boucherie Secondary school is located on the west side of the city. It has a population of about 1500 students in grades 10 through 12. While providing a wide range of academic courses like Science, business and, liberal arts, it also offers quite a few specialized programs. Some of these include the Culinary Arts, Hair Dressing Program, and Fire Fighting Academy.</p>
