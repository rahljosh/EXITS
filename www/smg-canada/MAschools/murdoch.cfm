...
<div class="mainContent">
 <h1>Murdoch MacKay Collegiate</h1>
 <hr /> <hr />
 <div class="slideDisplay">
<a href="javascript:gotoshow()"><img src="murpics/pic1.jpg" name="slide" border=1 ></a>
<script>
<!--

//configure the paths of the images, plus corresponding target links
slideshowimages("murpics/pic1.jpg","murpics/pic1.jpg")
...
<hr />
<p>Murdoch MacKay Collegiate has a student population of approximately 900 students attending grade 9 through 12This school offers a rigorous college preparatory curriculum, including three tracks (basic, college preparatory, and Honors/AP) for all core academic courses. The school offers vocational diplomas in Power Mechanics, Aerospace, Building Construction and Fashion Technology. In addition, the school offers a variety of elective courses from which to choose, allowing students much control in determining their course of study above and beyond the school's graduation requirements. Industrial Arts courses in Graphic Arts, Photography, Multimedia, Electronics and Woods are also offered as optional courses. Upon completion of 4 related areas students earn a mini-diploma that indicates proficiency in that area. Students have a variety of extracurricular options available in the arts such as Drama Performances, Speech Club, Art Club, and Band Performances. Murdoch Mackay also offers a variety of student groups and humanitarian clubs that students can join such as Youth and Philanthropy club, natural helpers, science club, and student action. ESL class and additional support are available to all International Students.</p>
<br />
<hr />
<br />
