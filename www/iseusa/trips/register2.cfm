  ...
  <div class="whtMiddletours2">
	...
	<input type=hidden name="acctVerified" value="#acctVerified#" />
          <Table width=100% cellspacing=0 cellpadding=2 class="border">
            ...
            <Tr  bgcolor="##deeaf3">
            	<td><h3>State</h3></td>
                <td><cfinput type="text"  name="state" value="#hostInfo.state#"> <input type="hidden" name="ret_state" value="#hostInfo.state#" /></td>
           	</Tr>
             <Tr>
            	<td><h3>Zip</h3></td>
          ...
          <Table width=100% cellspacing=0 cellpadding=2 class="border">
             ...
             <Tr bgcolor="##deeaf3">
          	 <td colspan=3><h3>What is your nationality? &nbsp;&nbsp;<cfinput type="text" name="nationality" validateat="onSubmit" message="Please answer the question: What is your nationality?  This will help us in assigning roommates." required="yes" size=30/></h3></td>
             </Tr>
        	 <T>
             ...
             <textarea cols=80 rows=5 name="med"><Cfif stuINfo.med_allergies is not ''>Medical Allergies: #stuInfo.med_allergies#;</Cfif><cfif stuInfo.other_Allergies is not ''>Other Allergies: #stuInfo.other_allergies#</cfif></textarea></td>
              ...
              <h2>Trip Information</h2>
				<em>You are registering for te following tour(s).</em>
          <Table width=100% cellspacing=0 cellpadding=2 class="border">
            ...
            <tr bgcolor="##deeaf3">
            	...
            	<td><h3>Billing Address</h3></td><td><cfinput type="text" name="billingAddress" validateat="onSubmit" message="Please enter the Credit Card billing address" required="yes"/>                                          
					...
					<Tr>
                                ...
                                <td><cfinput type="text" name="billingstate" validateat="onSubmit" message="Please enter the billing state." validate="noblanks" required="yes" size=20></td></Tr>
					<Tr bgcolor="##deeaf3">
