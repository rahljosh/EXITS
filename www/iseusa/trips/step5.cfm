...
insert into student_tours (studentid, tripid, date, nationality, med, person1, person2, person3,stuNationality)
					values(#client.verifiedstudent#, #client.selectedTrip#, #now()#, '#client.nationality#', '#client.medical#','#client.person1#', '#client.person2#', '#client.person3#','#client.stuNationality#')
</cfquery>
