...
<cfoutput>	
    ...
    <cfsavecontent variable="stuEmailMessage">
        ...
        <p>Please visit ISE's website for additional questions. <a href="http://www.iseusa.com/trips/questions.cfm">http://www.iseusa.com/trips/questions.cfm</a></p>
    ...
    <cfsavecontent variable="repEmailMessage">
        ...
        <a href="http://ise.exitsapplication.com/nsmg/index.cfm?curdoc=tours/hold&student=#qGetStudentInfo.studentid#&trip=#qGetTourDetails.tour_id#">form</a> 
