          ...
          <table width="593" height="333" border="0" cellpadding="0" cellspacing="0">
           ...
           Quantity  <INPUT NAME="Qty" class="style1" VALUE="1" size=3> <br />
             ...
             <select name=size class="style1">
																	<option value="Size: Small $9.00 each" selected>Small $9.00 </option>
																	<option value="Size: Medium $9.00 each">Medium $9.00 </option>
																	<option value="Size: Large $9.00 each">Large $9.00 </option>
																	<option value="Size: XL $9.00 each">X-Large $9.00</option>
																	<option value="Size: XXL $9.00 each">XX-Large $9.00 </option>
																	<option value="Size: XXXL $9.00 each">XXX-Large $9.00 </option>
                             	  </select>  
              <Br />
...
100% polyester shell, 100% polyester mesh upper back lining, 100% nylon lining on lower back/front/sleeves; contrasting neck trim. Features lower slash zip pockets. Port Pocket™ access for easy embroidery. Princess cut provides a feminine fit.
                ...
                <br />
                               <SELECT NAME=Size class="style1">
                              <option value="Size: XSmall $36.00 each">XSmall $36.00 </option>
                              <option value="Size: Small $36.00 each" selected>Small $36.00 </option>
                              <option value="Size: Medium $36.00 each">Medium $36.00 </option>
...
100% polyester shell, 100% polyester mesh upper back lining, 100% nylon lining on lower back/front/sleeves; contrasting neck trim.<br />Red with Navy Trim &  Logo                  <img src="images/webstore/greenLine.gif" width="211" height="15" alt="green line" /><br />
              Quantity   <INPUT NAME="Qty" size=3 VALUE="1"> 
													  <INPUT TYPE='HIDDEN' NAME='DiscItm' VALUE='n'>
                                                        ...
                                                        <br />
                  <SELECT NAME=Size class="style1">
                    <option value="Size: XSmall $36.00 each" selected>XSmall $36.00 </option>
                    <option value="Size: Small $36.00 each" selected>Small $36.00 </option>
                    <option value="Size: Medium $36.00 each">Medium $36.00 </option>
                    <option value="Size: Large $36.00 each">Large$36.00 </option>
                    <option value="Size: XL $36.00 each">XLarge $36.00 </option>
...
<img src="images/webstore/greenLine.gif" width="211" height="15" alt="green line" /><br />
                            ...
                            <SELECT NAME=Size class="style1">
                              ...
                              <option value="Size: Medium $22.00 each">Medium $22.00 </option>
                              <option value="Size: Large $22.00 each">Large $22.00 </option>
                              <option value="Size: XL $22.00 each">X-Large $22.00</option>
                              <option value="Size: XXL $22.00 each">XX-Large $22.00 </option>
                              <option value="Size: XXXL $22.00 each">XXX-Large $22.00 </option>
                            </SELECT>
                            <br />
