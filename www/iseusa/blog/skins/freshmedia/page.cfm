...
<div id="wrap-out"><div id="wrap">
				...
				<mango:PageProperty ifcommentsallowed>
                    ...
                    <form method="post" action="#respond" id="comment_form">
                        ...
                        <mango:AuthenticatedAuthor ifNotIsLoggedIn>
                       	<label for="comment_name">Name</label><input id="comment_name" type="text" name="comment_name" value="<mango:RequestVar name='comment_name' />" />
	...
	<div id="footer-wrap"><div id="footer-content">
		<mangox:PodGroup locationId="footer" template="page">
			<template:footer />
        </mangox:PodGroup>
