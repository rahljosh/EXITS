...
INSERT INTO #prefix#role (id, name, description, preferences)
 			SELECT 'administrator', 'Administrator', 'Somebody who has access to all the administration features.', ''
UNION ALL	SELECT 'author', 'Author', 'Somebody who can publish and manage their own posts and pages.', ''
UNION ALL	SELECT 'editor', 'Editor', 'Somebody who can publish posts, manage posts as well as manage other people''s posts.', ''
