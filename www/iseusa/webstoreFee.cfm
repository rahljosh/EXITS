...
<title>(ISE) International Student Exchange - Program Fee</title>
<style type="text/css">
<!--
-->
</style>
      ...
      <div class="whtMiddle1">
        <div class="shopping">
          ...
          <table width="593" height="333" border="0" cellpading=0 cellspacing="0">
            ...
            <tr>
              <td width="298" height="178" class="lightGreen" scope="row">
              <FORM action="http://www.coolcart.net/shop/coolcart.aspx/studentmanagement" method=post name="mug" id="mug" target="loja">
                <p>If you would like to pay for more then 1 invoice, please submit a seperate payment for each invoice.</p>
            
                <table>
                	<tr>
                    	<td>Inovoice Number your paying:</td><td><INPUT TYPE="text" NAME="ID" VALUE=""></td>
                    </tr>
                	<tr>
                ...
                <INPUT TYPE="HIDDEN" NAME="Describe" VALUE="Invoice Payment">
