...
have been approved as a host family, it simpliy indicates that your application is ready to submit.<br /><Br />
<table>
	<tr>
    	<Td>Once your application is complete, and you are satisfied with the information and pictures contained in it, you need to submit your application to ISE for consideration as a host family. Click the button to the right to submit your appliaction.  
        </Td>
        <Td><img src="../images/buttons/SubmitApp_03.png" width="244" height="66" /></Td>
    </tr>
</table>
