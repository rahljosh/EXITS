...
<cfif isDefined('form.processLogin')>
 ...
 SELECT h.familylastname, h.applicationStarted, h.applicationapproved, h.applicationDenied, h.regionid, h.arearepid, h.reasonAppDenied, h.lead,
 ...
 <cfset appCheckList.recordcount = 0>
 ...
 <h1 class="enter">Welcome #lcase(appInfo.familylastname)# Family!</h1>
  <table>
     ...
     <h3 align="Center">App Overview</h3>
            ...
            <cfif appChecklist.recordcount eq 0>
            	Ready to Submit
             <cfelse>
           ...
           <p><strong> Application Started -</strong> 
            ...
            Denied - #DateFormat(appInfo.applicationDenied, 'mmm d, yyyy')#<br />
            For: 
			<cfelse>
			Approved -<cfif appInfo.applicationApproved is ''>
            ...
            <p><strong>Region - </strong><cfif appInfo.regionid eq 0>Not Assigned<cfelse>#appInfo.regionname#</cfif> </p>
            <p><strong>Regional Manager -</strong> <cfif appInfo.regionid eq 0>Not Assigned<cfelse>#appInfo.regionname#</cfif></p>
            <p><strong>Area Representative -</strong> <cfif appInfo.regionid eq 0>Not Assigned<cfelse>#appInfo.repFirst# #appInfo.repLast# </cfif>
            </td>
            <td>
            &nbsp;&nbsp;
            </td>
    		<td>
      <h3 align="Center">Application Instructions / Announcement</h3>
      <p>Carefully complete this application.  Your student's family will receive a copy of the information you provide so please be as complete as possible.  Please be aware that the Department of State has specific requirements regarding the photos that are uploaded on the family album.  We are mandated to have photos of specific areas of your home on file. <br /><br /> 
         ...
         If you have not already been in contact with a representative, you will be contacted shortly after your application is submitted.</p>
        	<cfif appInfo.lead eq 1>
            	<a href="index.cfm?page=startHostApp##pageTop"><img src="../images/startApp.png" alt="start" border="0" /></a>
            <cfelse>
            	<a href="index.cfm?page=startHostApp"><img src="../images/continueApp.png" alt="continue" border="0" /></a>
            </cfif>
            <br />
            <a href="../logout.cfm"><img src="../images/buttons/logout.png" border=0/></a>
      		</td>
