<link rel="stylesheet" href="http://ise.exitsapplication.com/nsmg/linked/css/hostApp.css" type="text/css">
...
<cfquery name="rep" datasource="mysql">
            ...
            <td>
               ...
               <table width=800 align="Center">
                ...
                <table  align="center" border="0" cellpadding="4" cellspacing="0" width="800">
                    <tr>           
                        <td colspan=5 align="center"><img src="../images/hostAppBanners/HPpdf_04.jpg"/></Td>
                    </tr>
                    <tr>
                        <td valign="top">
                    ...
                    <table  align="center" border="0" cellpadding="4" cellspacing="0" width="800">
                        <tr>           
                            <td colspan=5 align="center"><img src="../images/hostAppBanners/HPpdf_06.jpg" /></Td>
                        </tr>
                        <tr>
                            <td valign="top">
                       ...
                       <table  align="left" border="0" cellpadding="4" cellspacing="0" width="100%">
                       	<Tr>
                      		 <td align="center"><img src="../images/hostAppBanners/dietary_38.jpg"></td>
                            	<td align="center"><img src="../images/hostAppBanners/HPpdf_10.jpg"></Td>
                       </Tr>
                        <tr>
                    ...
                    <Tr>
                       ...
                       <Td>
                     <img src="../images/hostAppBanners/HPpdf_12.jpg" />
                        <Td>
                    </Tr>
                    <Tr>
                       ...
                       <!----INterests---->     
                             <table  align="center" border="0" cellpadding="4" cellspacing="0" width="800">
                        <tr>           
                            <td colspan=5 align="center"><img src="../images/hostAppBanners/HPpdf_08.jpg" /></Td>
                        </tr>
                        <tr>
                            <td valign="top">
                                ...
                                <tr>
                                	<Td>
                                        <Cfloop list="#qGetHostFamily.interests#" index=i>
                                            <Cfquery name="interestName" datasource="mysql">
                                            SELECT interest
                                            FROM smg_interests
  ...
  <table class="profileTable" align="center">
        <tr>
			...
			<!--- Letter --->
                <table  align="center" border="0" cellpadding="4" cellspacing="0" width="800">
                    <tr>           
                        <td colspan=5 align="center"><img src="../images/hostAppBanners/HPpdf_15.jpg"/></Td>
                    </tr>
                    <tr>
 ...
 <table class="profileTable" align="center">
        <tr>
            <td>
   				 <table width=800>
                    <tr>
                        <td colspan=3 align="Center"><img src="../images/hostAppBanners/Pdf_Headers_02.jpg"></td>
                    </tr>
                    <tr>
 ...
 <table class="profileTable" align="center">
        <tr>
			...
			<!--- Religious Prefs --->
                <table  align="center" border="0" cellpadding="4" cellspacing="0" width="800">
                    <tr>           
                        <td colspan=6 align="center"><img src="../images/hostAppBanners/HPpdf_27.jpg"/></Td>
                    </tr>
                    <tr>
