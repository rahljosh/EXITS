...
where referencefor = <cfqueryparam cfsqltype="integer" value="#client.hostid#">
</cfquery>
   <cfoutput> 
        ...
        <tr>
			...
			<!--- Finance Prefs --->
                <table  align="center" border="0" cellpadding="4" cellspacing="0" width="800">
                    <tr>           
                        <td colspan=6 align="center"><img src="../images/hostAppBanners/HPpdf_29.jpg"/></Td>
                    </tr>
                    <tr>
...
Agency in the past?</span>
                ...
                <table  align="center" border="0" cellpadding="4" cellspacing="0" width="800">
                    <tr>           
                        <td colspan=6 align="center"><img src="../images/hostAppBanners/HPpdf_32.jpg"/></Td>
                     </tr>
                     <tr>
                     	<td>         
