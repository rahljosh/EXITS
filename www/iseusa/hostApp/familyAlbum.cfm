...
<cfif isDefined('url.delPic')>
	<cffile action="delete" 
    	file="/home/httpd/vhosts/111cooper.com/httpdocs/pics/hostAlbum/#url.delPic#">
...
<h2>Picture Album</h2> 
Please upload photos of you, your family, and your home including the exterior and grouns, kitchen, student's bedroom, student's bathroom, and family and living areas with a brief description of each. <br /><br />
...
<cfelse>
  <cffile action="upload"
     destination="/home/httpd/vhosts/111cooper.com/httpdocs/pics/hostAlbum"
   ...
   <cffile action="rename" destination="/home/httpd/vhosts/111cooper.com/httpdocs/pics/hostAlbum/#newFName#" source="/home/httpd/vhosts/111cooper.com/httpdocs/pics/hostAlbum/#file.serverfile#">
...
<option value="#catID#">#cat_name#<Cfif catid is not 7>*</Cfif></option>
</cfloop>
</select>
...
<form method="post" action="familyAlbum.cfm">
    ...
    <cfloop query="current_photos">
    	...
    	<Td><cfimage action="writetobrowser" 
        		source="../pics/hostAlbum/#filename#" height = 100><br />
                #catDesc.cat_name#<br />
...
<table border=0 cellpadding=4 cellspacing=0 width=100% class="section">
    <tr>
    <cfif current_photos.recordcount neq 0>
    <td colspan=4 align="Center">When you are done editing the descriptions, just click "I'm Finished"
