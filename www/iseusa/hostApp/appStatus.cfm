...
<cfsilent>
    ...
    <cfquery name="qGetHFInfo" datasource="MySQL">
        SELECT 
        	* 
        FROM 
        	smg_hosts
	...
	<cfscript>
		...
		*/
		...
		if ( NOT SESSION.formErrors.length() ) {
			appNotComplete = appNotComplete + 27;
	...
	<!--- Family Interests --->			      
    <cfquery name="qGetHostInterests" datasource="MySQL">
        select 
        	interests, 
            interests_other, 
            playBand,
	...
	<!--- Family Album --->   
    <cfquery name="qGetHostPicturesCategories" datasource="MySQL">
    	SELECT 
        	*
    	FROM 
        	smg_host_pic_cat 
    ...
    <cfquery name="qGetHostPictures" datasource="MySQL">
        SELECT 
            *
        FROM 
