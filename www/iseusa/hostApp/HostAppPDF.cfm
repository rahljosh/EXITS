                    ...
                    <tr>
                    	<Td valign="top" width=450>
                        	<Table>
                                ...
                                <tr>
                                    <td>  <span class="title">Do you expect your student to attend<br> services?</span></td><td>#capFirst(qGetHostFamily.churchfam)#</td>
                                </tr>
                                <tr>
                                    <td>  <span class="title">Would you transport the student to their religious services
if they are different from your own?</span></td><td>#capFirst(qGetHostFamily.churchtrans)#</td>
                                </tr>
