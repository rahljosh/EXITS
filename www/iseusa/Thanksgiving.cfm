...
<title>(ISE) International Student Exchange - Student Success Stories</title>
<style type="text/css">
<!--
-->
</style>
  ...
  <div id="subPages">
   ...
   <div class="whtMiddleService">
    <div class="SuccessInfo">
     <h1 class="enter">Thanksgiving Baskets</h1>
     <table width="633">
      <tr>
      ...
      <tr>
       ...
       <td width="406" class="lightBlue" scope="row"><img src="images/studentSuccess/Thanks1.png" width="250" height="167" border="1" /></span></td>
      </tr>
     </table>
     <br />
    </div>
