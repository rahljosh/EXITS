...
return $password;
   ...
   $hostID = "select max(id) as lastID
	 ...
	 {
		$hashid = (($fieldData->lastID*64) % 29).chr((substr($fieldData->lastID,-1,1)+65)).($fieldData->lastID % 4);
		echo 'Josh'.$hashid;
	 }
  ...
  $query = "INSERT INTO
	...
	$stmt->bind_param('ssssisssss',$firstname,$lastname,$address,$city,$state,$zipcode,$phone,$email,$userPass,$hashid);
	...
	$emailBody = '<p>Thank you for you interest in ISE.</p>';
	...
	$emailBody .= '<p>Please visit http://www.119cooper.com/ready-host-student.php to view profiles of students who ';
  ...
  echo '<p>Thank you for your interest in becoming a host family!<br>';
  echo 'A represenative with ISE will be in contact with you shortly. Click the button below to view limited profiles of students here or coming to the US shorlty.</p>';
