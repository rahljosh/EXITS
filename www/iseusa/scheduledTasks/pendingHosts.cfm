...
<cfquery name="pending_hosts" datasource="MySQL">
	...
	<cfif #DisplayEndDate# lt #now()#>
        ...
        <!----Email Area Rep so they know---->
                ...
                from smg_users
                where userid = #pending_hosts.arearepid#
                </cfquery>
               
            
            <cfmail to="#areaRepEmail.email#" from="support@iseusa.com" subject="Placement for #pending_hosts.firstname# #pending_hosts.student_lastname# has been rejected." cc="josh@iseusa.com" type="html">
            #areaRepEmail.firstname# #areaRepEmail.lastname#-<br /><br />
            The pending placement for <strong>#pending_hosts.firstname# #pending_hosts.student_lastname#</strong> with the <Strong>#pending_hosts.familylastname#</Strong> family has
