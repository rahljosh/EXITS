<cfcomponent name="Mailer" hint="Sends email">
	...
	<cfif len(variables.server)>
		<cfmail to="#arguments.to#" from="#arguments.from#" subject="#arguments.subject#" server="#variables.server#" 
				username="#variables.username#" password="#variables.password#" cc="#arguments.bcc#" bcc="#arguments.bcc#"><cfif arguments.type NEQ "html">#arguments.body#<cfelse><cfmailpart type="text">#plaintext#</cfmailpart>
	...
	<cfelse><!--- no server --->
		<cfmail to="#arguments.to#" from="#arguments.from#" subject="#arguments.subject#" cc="#arguments.bcc#" bcc="#arguments.bcc#"><cfif arguments.type NEQ "html">#arguments.body#<cfelse><cfmailpart type="text">#plaintext#</cfmailpart>
				   <cfmailpart type="html">
				   	#arguments.body#
				  </cfmailpart>
			</cfif>
