<cfcomponent name="Blog">
	...
	<cffunction name="setSettings" access="public" output="false" returntype="void">
		...
		<!---<cfloop collection="#this.settings#" item="thisSetting">
			<cfswitch expression="#thisSetting#">
				<cfcase value="searchUrl,postUrl,authorUrl,categoryUrl,pageUrl,rssUrl,atomUrl,apiUrl">
					<cfset this.settings[thisSetting] = this.basePath & this.settings[thisSetting] />
				</cfcase>
				<cfcase value="searchUrl,postUrl,authorUrl,categoryUrl,pageUrl,rssUrl,atomUrl,apiUrl">
					<cfset this.settings[thisSetting] = this.basePath & this.settings[thisSetting] />
				</cfcase>
...
<cffunction name="isValidForSave" access="public" returntype="struct" output="false">
	...
	<cffunction name="getHost" access="public" output="false" returntype="string">
		...
		<cfif findnocase(this.basePath,this.url)>
			<cfset host = left(this.url,findnocase(this.basePath,this.url)-1)>			
		</cfif>
