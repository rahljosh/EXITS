...
<cfif NOT structkeyexists(url, "update") AND listfind(currentAuthor.currentRole.permissions, "manage_system")>
...
<cf_layout page="Overview" title="Overview">
	<div id="wrapper">
		...
		<h2 class="pageTitle">Overview</h2>
			...
			<cfif structkeyexists(url, "update") AND listfind(currentAuthor.currentRole.permissions, "manage_system")>
				<cfflush interval="5">
				<cfoutput>
					<div class="message">
