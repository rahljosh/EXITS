...
<cfquery name="get_category" datasource="#application.dsn#">
	SELECT category
...
TYPE="HTML">
	...
	<tr><td bgcolor=b5d66e><img src="http://www.exitsapplication.com/exits/student_app/pics/top-email.gif" width=550 height=75></td></tr>
	...
	<tr><td>
		Please click 
		<a href="http://www.exitsapplication.com/exits/index.cfm?curdoc=student_info&studentid=#get_student_info.studentid#">here</a>
...
<cfquery name="email_int_rep" datasource="#application.dsn#">
select email
from smg_users 
