...
<cfquery name="virtual_category" datasource="#application.dsn#">
...
<table width=660 cellpadding=6 cellspacing=1 border=0 align="center">
	...
	<tr bgcolor="#iif(currentrow MOD 2 ,DE("eeeeee") ,DE("white") )#">
		...
		<cfform method="post" action="qr_delete_file.cfm" name="Delete">
			...
			<cfinput type="image" name="submit" src="vfolderdelete.png" alt="Delete this file" onclick="return areYouSure(this);"> 
		</cfform>				
		</td>
		</cfif>	
	</tr>
