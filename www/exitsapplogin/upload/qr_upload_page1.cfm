...
<cfoutput>
	...
	<cfset directory = 'D:\home\exitsapplication.com\wwwroot\exits\uploadedfiles\web-students'>
	...
	<cfif cffile.ClientFileExt NEQ 'gif' AND cffile.ClientFileExt NEQ 'jpg' AND cffile.ClientFileExt NEQ 'jpeg' AND cffile.ClientFileExt NEQ 'GIF' AND cffile.ClientFileExt NEQ 'JPG' AND cffile.ClientFileExt NEQ 'JPEG' AND cffile.ClientFileExt NEQ 'PNG'>
		<!----
        <cffile action = "delete" file = "#directory#/#cffile.serverfile#">
		---->
			<script language="JavaScript">
	...
	<cfimage action="convert" source="#directory#\#cffile.serverfile#" destination="#directory#\#form.studentid#.jpg" overwrite=true>
<!----
