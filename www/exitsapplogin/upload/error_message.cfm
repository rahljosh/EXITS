...
<table width="100%" cellpadding="0" cellspacing="0" align="center" border="0">
	<tr height="33">
		...
		<td width="26" class="tablecenter"><img src="http://www.exitsapplication.com/exits/pics/students.gif"></td>
...
<table width="100%" border=0 cellpadding=6 cellspacing=0 align="center">
	<tr><td>
		 ...
		 <div align="center"><input name="back" type="image" src="http://www.exitsapplication.com/exits/pics/close.gif" align="middle" border=0 onClick="window.close()"></div><br><br>
	</td></tr>
</table>
</div>
