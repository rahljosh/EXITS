  ...
  <div id="logoContent">
    <table width="557" height="72" border="0">
      <tr>
        ...
        <td width="311">&nbsp;</td>
        <td width="43"><img src="images/#client.companyid#.png" width="74" height="97" /></td>
      </tr>
    </table>
  </div>
  ...
  <div class="form1">
   <cfif url.forgot>
        ...
        <table border="0" align="center" cellpadding="4" cellspacing="0" width=95%>
          ...
          <tr>
            <td><a href="login.cfm" class="style2">Back to Login</a></td><td align="right"><input type="image" src="images/send.png" alt="Login" /></td>
          </tr>
          </cfform>
        </table>
	<!--- login form --->
    <cfelse>
        ...
        <input type="hidden" name="login_submitted" value="1">
          ...
          <table border="0" align="center" cellpadding="4" cellspacing="0" width=95%>
          <tr>
            <td><a href="login.cfm?forgot=1" class="style2" valign="middle" align="right">Forgot Login?</a></td><td align="right" width=100> <input type="image" src="images/button.png" alt="Login" /></td>
          </tr>
        </cfform>
