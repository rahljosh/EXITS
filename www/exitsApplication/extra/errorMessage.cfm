...
<head>
    ...
    <title>EXTRA - System Error</title>
    <link rel="stylesheet" href="csb.css" type="text/css">
    <link rel="stylesheet" href="internal/linked/css/baseStyle.css" type="text/css"> <!-- BaseStyle -->
</head>
<body>
...
<table width="80%" align="center" cellpadding="0" cellspacing="0" border="0" style="margin-top:30px;">
    <tr valign="middle" height="24">
        <td width="13" height="24" background="internal/pics/header_leftcap.gif">&nbsp;</td>
        <td background="internal/pics/header_background.gif"><h2>EXTRA - System Error</h2></td>
        <td width="17" background="internal/pics/header_rightcap.gif">&nbsp;</td>
    </tr>
</table>
...
<table width="80%" align="center" cellpadding="0" cellspacing="0" border="0">
	<tr valign="bottom">
		<td width="9" valign="top" height=12><img src="internal/pics/footer_leftcap.gif"></td>
		<td width="100%" background="internal/pics/header_background_footer.gif"></td>
		<td width="9" valign="top"><img src="internal/pics/footer_rightcap.gif"></td>
	</tr>
</table>
