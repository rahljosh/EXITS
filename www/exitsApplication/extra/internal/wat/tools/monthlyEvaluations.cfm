        ...
        <table id="candidateList" cellpadding="4" cellspacing="0" align="center" class="section" width="95%">
        	<tr>
                ...
                <cfif ListFind("1,2",FORM.reportType)>
                	<td class="listTitle style2">Phone</td>
                </cfif>
                ...
                <td class="listTitle style2">Check-in Date</td>
                <td class="listTitle style2">Days since check-in</td>
                <td class="listTitle style2" align="center">Cultural Activity</td>
                <td class="listTitle style2" align="center">Evaluation Tracking</td>
                <cfif ListFind("1,5",FORM.evaluationID)>
                	<td class="listTitle style2" align="center">Evaluation 1</td>
                <cfelseif ListFind("2,6",FORM.evaluationID)>
                	<td class="listTitle style2" align="center">Evaluation 2</td>
                <cfelseif ListFind("3,7",FORM.evaluationID)>
                	<td class="listTitle style2" align="center">Evaluation 3</td>
                <cfelseif ListFind("4,8",FORM.evaluationID)>
                	<td class="listTitle style2" align="center">Evaluation 4</td>
                </cfif>
            </tr>
