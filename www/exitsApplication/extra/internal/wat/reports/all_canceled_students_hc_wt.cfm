    ...
    <table width="95%" cellpadding="4" cellspacing="0" border="0" align="center">
        <tr valign="middle" height="24">
            <td valign="middle" bgcolor="##E4E4E4" class="title1" colspan=2>
                <font size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp; Host Company Reports -> All Cancelled Candidates</font>
            </td>
        </tr>
        <tr valign="middle" height="24">
    ...
    <cfswitch expression="#FORM.printOption#">
        ...
        <cfcase value="2">   
            <cfdocument format="pdf" orientation="landscape" backgroundvisible="yes" overwrite="no" fontembed="yes">          	
                ...
                <div class="title1">All cancelled students per Host Company and Program</div>
                <img src="../../pics/black_pixel.gif" width="100%" height="2">
        ...
        <cfcase value="3">
            ...
            <cfheader name="Content-Disposition" value="attachment; filename=canceledStudentsHiredPerCompany.xls"> 
