...
<cfsilent>
    ...
    <cfquery name="qGetSeasons" datasource="MySql">
    	SELECT p.programID, p.programName, hih.dateChanged, hsh.j1Positions, hsh.j1Date
...
<head>
	...
	<title>Host Company Available J1 Position History</title>
</head>
<body>
 		...
 		<td bordercolor="FFFFFF">
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="0" height="24">
            	<tr valign="middle" height="24">
                	<td align="right" class="title1"><cfoutput>J1 Position History for #qGetHost.name# (###qGetHost.hostCompanyID#)</cfoutput></td>
              	</tr>
             	<tr><td>&nbsp;</td></tr>
        	</table>
                    		...
                    		<table width="100%" border="0" cellpadding="5" cellspacing="0">
                                <tr>
                           		...
                           		<tr>
                                    ...
                                    <td class="style2" bgcolor="8FB6C9"><center>Positions</center></td>
                                </tr>
                                ...
                                <cfloop query="qGetPositions">
                                    <cfif j1Positions NEQ lastNumber OR j1Date NEQ lastDate>
                                        <tr bgcolor="#iif(currentrow MOD 2 ,DE("ffffff") ,DE("F7F7F7") )#">
                                            <td>#DateFormat(dateChanged,'mm/dd/yyyy')#</td>
                                            <td>#DateFormat(j1Date,'mm/dd/yyyy')#</td>
                                            <td><center>#j1Positions#</center></td>
                                            <cfset lastNumber = #j1Positions#>
                                            <cfset lastDate = #j1Date#>
                                       	</tr>
                                    </cfif>
                                </cfloop>
                          	</table>
