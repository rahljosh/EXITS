...
<cfquery name="get_candidates" datasource="MySQL">
	SELECT c.candidateid, c.firstname, c.lastname, c.sex, c.dob, c.startdate, c.enddate, c.status, c.cancel_date,
	...
	INNER JOIN smg_countrylist country ON country.countryid =  c.residence_country
	INNER JOIN smg_insurance_codes insu_codes ON (u.extra_insurance_typeid = insu_codes.insutypeid AND c.companyid = insu_codes.companyid)
	WHERE c.status = '1'
