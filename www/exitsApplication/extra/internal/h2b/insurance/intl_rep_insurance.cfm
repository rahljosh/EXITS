...
<cfquery name="get_insutypes" datasource="MySql">
	...
	WHERE insutypeid = '1' OR insutypeid = '6' OR insutypeid = '14'
</cfquery>
	...
	<tr>
		<td bordercolor="FFFFFF">
			...
			<table width="80%" border="0" cellpadding="3" cellspacing="0" align="center" bordercolor="C7CFDC">	
				<tr><th colspan="2" class="style1">Ps: Changes on this page will affect all EXTRA systems (H2B, TRAINEE AND W&T)</td></tr>
				<tr><td colspan="2">&nbsp;</td></tr>
				<tr bgcolor="8FB6C9">
					<td class="style2" bgcolor="8FB6C9">International Representative</td>
					<td class="style2" bgcolor="8FB6C9">Insurance Policy Type</td>
				</tr>
				<cfloop query="get_intl_reps">
					<tr  bgcolor="#iif(currentrow MOD 2 ,DE("e9ecf1") ,DE("white") )#">
						<td class="style1">#businessname#
				...
				<tr bgcolor="##8FB6C9"><th colspan="2"><cfinput type="image" name="next" value=" Update " src="../pics/update.gif" align="middle"></th></tr>
			</table><br>
		</td>
	</tr>
</table>
