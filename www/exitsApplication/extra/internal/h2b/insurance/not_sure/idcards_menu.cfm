							...
							<tr>
								<td bordercolor="FFFFFF" valign="top">
									<table width="100%" cellpadding=3 cellspacing=0 border=0>
										<cfform name="new_ticket" action="insurance/insurance_cards.cfm" method="post" target="_blank">
										<tr bgcolor="C2D1EF"><td class="style2" bgcolor="8FB6C9" colspan="2">&nbsp;:: ID Cards (Placed Candidates)</td></tr>
										<tr>
