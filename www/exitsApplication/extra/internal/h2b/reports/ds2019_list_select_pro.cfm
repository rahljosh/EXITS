		...
		<Table class="nav_bar" align="left" cellpadding=5 cellspacing="0">
			...
			<tr>
				<TD><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Program :</font></td>
					...
					<cfoutput query="get_active_programs"><option value="#ProgramID#"><cfif #len(get_active_programs.programname)# gt 32>#Left(get_active_programs.programname, 29)#...<cfelse>#programname#</cfif></option></cfoutput>
					</select>
				</td>
			</tr>
			<TR>
