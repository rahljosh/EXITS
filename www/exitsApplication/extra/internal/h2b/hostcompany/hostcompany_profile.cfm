...
<table width="100%" height="100%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="CCCCCC" bgcolor="f4f4f4">
	<tr>
		...
		<cfquery name="get_upcomingtrainee" datasource="MySql">
			SELECT extra_candidates.firstname, extra_candidates.lastname, smg_programs.programname, extra_candidates.startdate
			FROM extra_candidates
										...
										<tr>
											<td width="561" align="center"><font size="5" face="Verdana, Arial, Helvetica, sans-serif">    
						    					...
						    					<font size=2 face="Verdana, Arial, Helvetica, sans-serif"><span class="edit_link">
						 						<!----   [  <a href='company_profile.cfm?companyid=#session.companyid#'>profile</a><a href='company_profile_pdf.cfm?companyid=#session.companyid#'><img src="../pics/pdficon_small.gif" border=0 /></a>]</span></font>---->
											
												<table width="76%" cellpadding=2 cellspacing=2 border=0 bordercolor="C7CFDC" >
												<cfoutput>
													<tr>
														...
														<td valign="top">
															...
															#hostcompanies.typebusiness#</font></p>
														</td>
													</tr>
														
													<tr>
														<td width="130"><div align="right"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Date of Entry: </font></strong></div></td>
													...
													<tr>
														<td width="130"><div align="right"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Entered by: </font></strong></div></td>
					...
					<td bordercolor="FFFFFF">
						...
						<table width="98%" border=0 align="center" cellpadding=3 cellspacing=0 bordercolor="#C7CFDC" bgcolor="#ffffff">
							<tr class="style1" bordercolor="#FFFFFF" bgcolor="#C2D1EF">
								<td height="16" bgcolor="#8FB6C9" colspan="2" class="style1" ><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF"><b>:: Address</b></font>
								</td>
							</tr>
                            <tr>
            ...
            <table cellpadding=5 cellspacing=5 border=1 align="center" width="98%" bordercolor="C7CFDC" bgcolor="ffffff">
				<tr>
					<td bordercolor="FFFFFF">
                    	...
                    	<table width="98%" border=0 align="center" cellpadding=3 cellspacing=0 bordercolor="#C7CFDC" bgcolor="#ffffff">
                        	<tr class="style1" bordercolor="#FFFFFF" bgcolor="#C2D1EF">
                        		<td height="16" bgcolor="#8FB6C9" class="style1" colspan=2><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF"><b>:: Housing </b></font></td>
                            </tr>
                            <tr>
								<cfoutput>
									...
									<table width="100%" border="0" >
                                  		...
                                  		<tr>
											<td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">
												<a href="javascript:OpenHistory('hostcompany/edit_newjob.cfm?jobid=#id#');" class="style4Big"><b>
												#title#</b></a></font><br />
											</td>
											<td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">#wage# / hour <!----#wage_type#---></font><br />
											</td>
                                  		</tr>
								  			</cfoutput>
								  			<cfoutput>
...
<div align="center"><img src="../pics/edit.gif" width="54" height="23" border="0" /><br /></div>
</cfoutput>
