<cfdocument format="pdf" orientation="portrait" backgroundvisible="yes" overwrite="no" fontembed="yes" margintop="0.5" marginbottom="0.5" scale="99">
    ...
    <cfoutput query="get_candidate">
        <br />
        <span class="style1">
            This  letter is to confirm that #firstname# #lastname# has been approved by ISE for 
            the J-1 visa sponsorship and has been entered into the Student and Exchange Visitor 
            Information System (SEVIS) database. A DS-2019 form (SEVIS ID #ds2019#) has been issued and sent.
            <br />
            <br />
            If an  appointment to apply for the J-1 visa at the U.S. Embassy or Consulate in the  home country has not yet been scheduled, please make sure that is done at this  time.
            <br />
            <br />
            ...
            You  will need to bring the electronic or original receipt with you for your visa  interview.
            <br />
            <br />
            Below is the information needed to complete form I-901 exactly as it appears on  the DS-2019 form
            <br />
            issued  by ISE:
            <br />
        </span>
