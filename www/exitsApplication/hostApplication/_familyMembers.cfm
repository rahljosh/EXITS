...
<cfoutput>
    ...
    <cfform action="#CGI.SCRIPT_NAME#?#CGI.QUERY_STRING#" method="post" preloader="no">
        ...
        Please include all college age or younger children who live in the home or will be <strong>living</strong> in the home at some point durring students visit, and <span style="background-color:##FF0; padding: 3px;"><strong> any other persons</strong></span> 
