...
<cfif isdefined('form.submit')>
    <cfquery name="insert_family_letter" datasource="#APPLICATION.DSN.Source#">
    update smg_hosts
...
<cfquery name="host_letter" datasource="#APPLICATION.DSN.Source#">
select familyletter
from smg_hosts
where hostID = <cfqueryparam cfsqltype="cf_sql_integer" value="#APPLICATION.CFC.SESSION.getHostSession().ID#">
</cfquery>
<cfform method="post" action="index.cfm?section=personalDescription">
