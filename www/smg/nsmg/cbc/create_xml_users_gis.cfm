...
<cfquery name="get_company" datasource="MySql">
	SELECT companyid, companyshort, gis_account, gis_username, gis_password, gis_email, support_email
	FROM smg_companies
...
<cfif form.usertype NEQ '3'>
	<cfquery name="get_cbc_users" datasource="MySql">
		...
		WHERE cbc.date_sent IS NULL 
			...
			AND 
            	cbc.seasonid =  <cfqueryparam value="#form.seasonid#" cfsqltype="cf_sql_integer">
			AND 
            	u.ssn != ''
...
<cfloop query='get_cbc_users'> 
	...
	<cfcatch type="any">
		Please check SSN for #firstname# #lastname# (###userid#)
		<cfabort>
	</cfcatch>
	</cftry>
	...
	<cffile action="write" file="/var/www/html/student-management/nsmg/uploadedfiles/xml_files/gis/#get_company.companyshort#/batch_#get_batchid.cbcid#_user_#get_cbc_users.userid#_sent.xml" output="#toString(requestXML)#" mode="777">

	<cfset responseXML = ''>
   	<cfset responseXML = XmlParse(cfhttp.filecontent)>

    <cffile action="write" file="/var/www/html/student-management/nsmg/uploadedfiles/xml_files/gis/#get_company.companyshort#/batch_#get_batchid.cbcid#_user_#get_cbc_users.userid#_rec.xml" output="#toString(responseXML)#" mode="777">	

	<table width="670" align="center" cellpadding="0" cellspacing="0">
		<tr><td>XML FILE <a href="../uploadedfiles/xml_files/gis/#get_company.companyshort#/batch_#get_batchid.cbcid#_user_#get_cbc_users.userid#_sent.xml" target="_blank">Sent</a></td></tr>
		<tr><td>XML FILE <a href="../uploadedfiles/xml_files/gis/#get_company.companyshort#/batch_#get_batchid.cbcid#_user_#get_cbc_users.userid#_rec.xml" target="_blank">Received</a></td></tr>
	</table><br>
	...
	<cfmail from="#get_company.support_email#" to="#get_company.gis_email#"  subject="GIS Search for #get_company.companyshort# - User : #firstname# #lastname# (###userid#)" failto="#get_company.support_email#" type="html">
