...
<cfelse>
	...
	<cffile action="read" file="/var/www/html/student-management/nsmg/uploadedfiles/sevis/#get_company.companyshort_nocolor#/host_family/#form.filename#" variable="myxml">
