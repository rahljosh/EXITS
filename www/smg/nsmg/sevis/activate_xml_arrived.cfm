...
<cfoutput>
<cffile action="write" file="#AppPath.sevis##get_company.companyshort_nocolor#/activate/#get_company.companyshort_nocolor#_activate_00#get_batchid.batchid#.xml" output="#toString(sevis_batch)#">
