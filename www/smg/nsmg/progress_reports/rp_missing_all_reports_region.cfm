...
<table width="90%" cellpadding="2" cellspacing="0" align="center" frame="box">
	<th><span class="application_section_header">#companyshort.companyshort# - Missing Progress Reports</span></th>
	<tr>
		<td><b>Program(s) :</b><br> 
	...
	<cfif get_students.recordcount>
		<table width="90%" cellpadding="2" cellspacing="0" align="center" frame="box">
			...
			<tr>
				...
				<td width="25%"><b>Missing Report</b></td>
			...
			<cfloop query="get_students">		
				...
				<cfloop list="#form["prtype" & type]#" index="i">
					...
					<cfif #Evaluate("month_"& i &".recordcount")# EQ 0>
						<cfset list_reports = ListAppend(list_reports, "#MonthAsString(i)#")>
					</cfif>
				</cfloop>
				
				<cfif list_reports NEQ ''>
				<tr>
