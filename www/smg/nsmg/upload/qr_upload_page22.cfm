...
---->
	...
	<cfif file.ServerFileExt EQ 'jpg' OR file.ServerFileExt EQ 'gif' OR file.ServerFileExt EQ 'jpeg' OR file.ServerFileExt EQ 'JPG' OR file.ServerFileExt EQ 'GIF' OR file.ServerFileExt EQ 'JPEG'> 
		...
		<cfif #FileExists("#directory#/new#filename#.#file.ServerFileExt#")#>
			...
			<!--- rename new file --->
			<cfoutput>
			#directory#/new#filename#.#file.ServerFileExt#
			</cfoutput>
			<cffile action="rename" source="#directory#/new#filename#.#file.ServerFileExt#" destination="#directory#/#filename#.#LCase(file.ServerFileExt)#" attributes="normal" mode="777" nameconflict="makeunique">
		</cfif>
	</cfif>

	<!--- <cffile action="rename" source="#directory#/#CFFILE.ServerFile#" destination="#directory#/#form.studentid#.#cffile.clientfileext#" mode="777"> --->
