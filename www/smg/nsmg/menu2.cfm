	...
	<tr bgcolor=##B5D66E>
        ...
        <td>
            ...
            <div class="section">
				...
				<a class="item2" href="?curdoc=intrep/int_students&placed=yes">Placed</a>
		...
		<td>
            <a class="item1" href="http://www.student-management.com/smgstore/index.htm">Store</a>
		</td>
	...
	<tr bgcolor=##B5D66E>
        ...
        <td>
            ...
            <div class="section">
				...
				<td>
			<a class="item1" href="?curdoc=helpdesk/help_desk_list">Tools</a>
			<div class="section">
		...
		<td><a class="item1" href="http://www.student-management.com/smgstore/index.htm">Store</a></td>
		<td height=24 width=13 background="pics/header_rightcap.gif">
    </tr>
</table>
	...
	<tr bgcolor=##B5D66E>
		...
		<Cfif client.usertype LTE 4>
			...
			<td>
				...
				<div class="section">
					...
					<a class="item2" href="?curdoc=invoice/reports/statement_detailed">SMG Detailed Statement</a>
                    ...
                    <a class="item2" href="" onClick="javaScript:win=window.open('invoice/m_hs_invoiceBatch.cfm', 'height=750, width=950, location=no, scrollbars=yes, menubars=no, toolbars=no, resizable=yes'); win.opener=self; return false;">HS Invoice Batch</a>
				</div>
			</td>
			</cfif>
		</Cfif>
		...
		<cfif client.usertype LTE 4>
			...
			<div class="section">
				...
				<a class="item2" href="index.cfm?curdoc=cbc/combine_hosts">Combining Feature</a>
				</cfif>
				<a class="item2" href="index.cfm?curdoc=insurance/site_menu">SITE Insurance Files</a>
		...
		<td>
			...
			<div class="section">
			<a class="item2" href="index.cfm?curdoc=helpdesk/help_desk_list">New Ticket</a>
			<a class="item2" href="index.cfm?curdoc=helpdesk/hd_list_exits">EXITS</a>
		...
		<td>
			<a class="item1" href="http://webmail.student-management.com/login.html?username=#webmail.email#&password=#webmail.password#" target="_blank">Webmail</a>
		</td>
		<td>
            <a class="item1" href="http://www.student-management.com/smgstore/index.htm" target="_blank">Store</a>
		</td>
		<td height=24 width=13 background="pics/header_rightcap.gif">
    </tr>
    </table>
