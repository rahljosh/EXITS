...
<cfif client.usertype LTE '4'>
	<cfquery name="list_regions" datasource="MySql"> <!--- GET ALL REGIONS --->
...
<cfelse>
	...
	<Cfif get_user_region.usertype EQ 6>
		<cfset hostlist = ''>
		<cfquery name="areareps" datasource="MySQL">
		...
		<cfloop query="areareps">
			<cfquery name="hosts_under_reps" datasource="MySQL">
	...
	<cfif get_user_region.usertype EQ '7' OR get_user_region.usertype EQ '9'>
		<cfset hostlist = ''>
		<cfquery name="host_under_area" datasource="MySQL">
			SELECT DISTINCT hostid FROM smg_students 
