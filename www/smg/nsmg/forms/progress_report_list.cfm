...
smg_students.firstname, smg_students.familylastname, smg_students.arearepid, smg_students.studentid, smg_students.canceldate,
smg_users.firstname as rep_first, smg_users.lastname as rep_last, smg_students.active,
...
INNER JOIN smg_prquestion_details ON  smg_prquestion_details.stuid = smg_students.studentid
...
<table width=90% cellpadding=0 cellspacing=0 border=0 height=24 align="center">
	<tr valign=middle height=24>
		...
		<td background="pics/header_background.gif"><h2>Progress Reports submitted prior to 09/16/2009</h2></td>
        <td background="pics/header_background.gif" width=16></td>
        <td background="pics/header_background.gif" align="right"><a href="index.cfm?curdoc=progress_reports">Current Progress Reports</a></td>
	...
	<table cellpadding=2 cellspacing=4 width=90% bgcolor="##ffffe6" align="center" class="section">
				...
				<Table align="center">
					...
					<Tr>
						...
						<td><!---Due:---></td><Td> <!---#total_Students.recordcount#---> <font color="FF0000"> * Cancelled </font></Td>
...
<td>Phase:</td>
		...
		<option value="?curdoc=forms/progress_report_list&rmonth=10&regionid=#regionid#&clearpage=0" <cfif url.rmonth is '10'>selected</cfif>>Phase 1 - Due Oct 1</option>
		<option value="?curdoc=forms/progress_report_list&rmonth=12&regionid=#regionid#&clearpage=0" <cfif url.rmonth is '12'>selected</cfif>>Phase 2 - Due Dec 2</option>
		<option value="?curdoc=forms/progress_report_list&rmonth=2&regionid=#regionid#&clearpage=0" <cfif url.rmonth is '2'>selected</cfif>>Phase 3 - Due Feb 1</option>
		<option value="?curdoc=forms/progress_report_list&rmonth=4&regionid=#regionid#&clearpage=0" <cfif url.rmonth is '4'>selected</cfif>>Phase 4 - Due Apr 1</option>
		<option value="?curdoc=forms/progress_report_list&rmonth=6&regionid=#regionid#&clearpage=0" <cfif url.rmonth is '6'>selected</cfif>>Phase 5 - Due Jun 1</option>
		<option value="?curdoc=forms/progress_report_list&rmonth=8&regionid=#regionid#&clearpage=0" <cfif url.rmonth is '8'>selected</cfif>>Phase 6 - Due Aug 1</option>
		</select>
	</form>
...
<td>Status:</td>
		...
		<select name="status" onChange="javascript:formHandler3()">
		<option value="?curdoc=forms/progress_report_list&rmonth=#url.rmonth#&regionid=#regionid#&clearpage=0&RequestTimeout=240&cancelled=0" <cfif url.cancelled is '0'>selected</cfif>>Active</option>
		<option value="?curdoc=forms/progress_report_list&rmonth=#url.rmonth#&regionid=#regionid#&clearpage=0&RequestTimeout=240&cancelled=1" <cfif url.cancelled is '1'>selected</cfif>>Cancelled</option>
</select>
	</form>
...
<!---- ::#total_students_under_rep.recordcount#::--->
				...
				<tr class="btnav" onmouseover="style.backgroundColor='##FFDDBB';" onMouseOut="style.backgroundColor='##FFFFE6';">
					<td width=10></td><td><a href="?curdoc=forms/view_progress_report&number=#report_number#&regionid=#regionid#" title="View Report Number #report_number#"><font color="##000000"> <cfif active EQ 0> <font color="##ff0000">* </cfif> #firstname# #familylastname# (#studentid#)</td>
					<td><a href="?curdoc=forms/view_progress_report&number=#report_number#&regionid=#regionid#" title="View Report Number #report_number#"><font color="##000000"> <cfif active EQ 0> <font color="##ff0000"> </cfif> #DateFormat(date_submitted, 'mm/dd/yyyy')#</td>
					<td><a href="?curdoc=forms/view_progress_report&number=#report_number#&regionid=#regionid#" title="View Report Number #report_number#"><font color="##000000"> <cfif active EQ 0> <font color="##ff0000"> </cfif> #DateFormat(date_ra_approved, 'mm/dd/yyyy')#  </td> 
					<td><a href="?curdoc=forms/view_progress_report&number=#report_number#&regionid=#regionid#" title="View Report Number #report_number#"><font color="##000000"> <cfif active EQ 0> <font color="##ff0000"> </cfif> #DateFormat(date_rd_approved, 'mm/dd/yyyy')#  </td>
					<TD><a href="?curdoc=forms/view_progress_report&number=#report_number#&regionid=#regionid#" title="View Report Number #report_number#"><font color="##000000"> <cfif active EQ 0> <font color="##ff0000"> </cfif> #DateFormat(ny_accepted, 'mm/dd/yyyy')#  </TD>
					<TD><a href="?curdoc=forms/view_progress_report&number=#report_number#&regionid=#regionid#" title="View Report Number #report_number#"><font color="##000000"> <cfif active EQ 0> <font color="##ff0000"> </cfif> #DateFormat(date_rejected, 'mm/dd/yyyy')#  </TD>
