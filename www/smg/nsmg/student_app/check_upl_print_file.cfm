...
<cfset nsmg_directory = '/var/www/html/student-management/nsmg/uploadedfiles/online_app'>

<cfdirectory directory="#nsmg_directory#/#doc#" name="file" filter="#client.studentid#.*">	
