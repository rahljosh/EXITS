...
<cfoutput>
	...
	<p id="calendarcontrols">
		&laquo;
		<a href="#REQUEST.URLPath#&action=week&date=#Fix( dtPrevWeek )#">#DateFormat( dtPrevWeek, "mmmm d, yyyy" )#</a> &nbsp;|&nbsp;
		<a href="#REQUEST.URLPath#&action=week&date=#Fix( dtNextWeek )#">#DateFormat( dtNextWeek, "mmmm d, yyyy" )#</a>
		&raquo;
	</p>
	...
	<cfloop 
		...
		<cfif ((DayOfWeek( dtDay ) MOD 7) EQ 1)>
			<tr class="days">
				<td class="header">
					<a href="#REQUEST.URLPath#&action=month&date=#dtDay#">&raquo;</a>
				</td>
		</cfif>
