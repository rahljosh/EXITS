	...
	<!----
	<cfquery name="add_rep_details" datasource="MySQL">
	update smg_users
	...
	---->
	<!----
		<cfquery name="user_type" datasource="MySQL">
		select usertype
		from smg_users
		where userid=#url.userid#
		</cfquery>
	---->
		...
		<cfquery name="add_user_regions" datasource="MySQL">
		Update smg_users
...
<!----
			<cfloop list = #form.regions# index=x>
				<cfquery name="get_regions_company" datasource="MySQL">
				select company
				from smg_regions
				where regionid = #x#
				</cfquery>
				
				<cfquery name="insert_regions" datasource="MySQL">
