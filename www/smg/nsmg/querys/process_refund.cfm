<cfquery name="account_balance" datasource="mysql">
...
<cftransaction action="begin" isolation="SERIALIZABLE">
	<cfquery name="get_invoice_number" datasource="MySQL">
...
<cfquery name="create_refund_invoice" datasource="MySQL">
...
<cfquery name="update_account" datasource="mysql">
update smg_users 
