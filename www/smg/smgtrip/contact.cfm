      ...
      <td background="../flash/images/about_02.gif"><div align="center">
        <table width="70%" border="0" cellspacing="1" cellpadding="0">
          <tr>
            ...
            <td width="18%" bgcolor="#FFFFFF" class="style1"><div align="center" class="style7">Contact</div></td>
        ...
        <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td class="style1"><div align="center"><strong>MPD TOUR AMERICA, INC.</strong><br>
              ...
              <div align="center"><em><strong>E-MAIL:</strong></em> <A href="mailto:info@mpdtoursamerica.com">info@mpdtoursamerica.com</A><a href="mailto:MPD@touramerica.com"></a><br>
              </div></td>
          </tr>
        </table>
        <br>
