...
<cfsilent>
    ...
    <Cfquery name="hostcompany2" datasource="MySQL">
        SELECT 
            ...
            extra_candidates.uniqueid
        FROM 
        	extra_hostcompany
        INNER JOIN 
        	extra_candidates ON extra_candidates.hostcompanyid = extra_hostcompany.hostcompanyid
        WHERE 
        	extra_candidates.uniqueid = <cfqueryparam cfsqltype="cf_sql_varchar" value="#URL.uniqueID#">
    </Cfquery>
    ...
    <cfquery name="get_position" datasource="mysql">
        ...
        FROM 
        	extra_jobs
        INNER JOIN 
        	extra_candidate_place_company ON extra_candidate_place_company.candcompid = extra_jobs.id
                   
        <cfif VAL(hostcompanyid)>
            WHERE 
                extra_jobs.hostcompanyid = <cfqueryparam cfsqltype="cf_sql_integer" value="#hostcompany2.hostcompanyid#">
        </cfif>
    </cfquery>
	--->
...
<body <cfif FORM.edit NEQ 'no'>onLoad="init();"</cfif>>
								...
								<td valign="top">
									...
									<cfif FORM.edit EQ 'no'>
										...
										<table width="100%" cellpadding="2">
											...
											<tr>
												...
												<td width="82%" class="style1"><select name="intrep" <cfif FORM.edit EQ 'no'>disabled</cfif> >
											...
											<tr>
												<td align="right"><!---- <input type="checkbox" name="active" <cfif active EQ 1>checked="Yes"</cfif> <cfif FORM.edit EQ 'no'>disabled</cfif>> ----></td>
									...
									<cfelse>
										...
										<table width="100%" cellpadding="2">
											...
											<tr>
												<td width="18%" align="right" class="style1"><b>Intl. Rep.:</b></td>
												<td width="82%" class="style1"><select name="intrep" class="style1" <cfif FORM.edit EQ 'no'>disabled</cfif> >
													<option value="0"></option>		
													<cfloop query="int_Reps">
														<option value="#userid#" <cfif userid EQ get_candidate_unqid.intrep> selected </cfif>><cfif #len(businessname)# gt 45>#Left(businessname, 42)#...<cfelse>#businessname#</cfif></option>
													</cfloop>
											...
											<tr>
												<td align="right" class="style1"><b>Status: </b> <!---- <input type="checkbox" name="active" <cfif active EQ 1>checked="Yes"</cfif> <cfif FORM.edit EQ 'no'>disabled</cfif>> ----></td>
												<td class="style1"><select id="status" name="status" <cfif get_candidate_unqid.status NEq 'canceled'> onchange="javascript:cancelation();" </cfif> >
								...
								<td bordercolor="FFFFFF">
									...
									<table width="100%" cellpadding=5 cellspacing=0 border=0>
										...
										<tr>
											...
											<td class="style1" bordercolor="FFFFFF" width="65%"><cfif FORM.edit EQ 'no'>#birth_city#<cfelse><cfinput type="text" class="style1" name="birth_city" size=32 value="#birth_city#" maxlength="100"></cfif></td>
										</tr>
										<tr>
											...
											<td class="style1" bordercolor="FFFFFF">
												...
												<cfelse>
													<select name="birth_country" class="style1" <cfif FORM.edit EQ 'no'>disabled</cfif>  >
													<option value="0"></option>		
													<cfloop query="countrylist">
										...
										<tr>
											...
											<td class="style1" bordercolor="FFFFFF">
												...
												<cfelse>
													<select name="citizen_country" class="style1" <cfif FORM.edit EQ 'no'>disabled</cfif>  >
													<option value="0"></option>		
													<cfloop query="countrylist">
										...
										<tr>
											...
											<td class="style1" bordercolor="FFFFFF">
												...
												<cfelse>
													<select name="residence_country" class="style1" <cfif FORM.edit EQ 'no'>disabled</cfif>  >
													<option value="0"></option>		
													<cfloop query="countrylist">
											...
											<td class="style1" bordercolor="FFFFFF" colspan="2">
												...
												<table width="100%" cellpadding=1 cellspacing=2 border=1 bordercolor="C7CFDC" bgcolor="F7F7F7">
													<tr bordercolor="F7F7F7">
														<td colspan="4" class="style1"><b>Mailing Address:</b> <cfif FORM.edit EQ 'no'>#home_address#<cfelse><cfinput type="text" class="style1" name="home_address" size=49 value="#home_address#" maxlength="200"></cfif></td>
													</tr>
													<tr bordercolor="F7F7F7">
														<td class="style1" align="right"><b>City:</b></td>
														<td class="style1"><cfif FORM.edit EQ 'no'>#home_city#<cfelse><cfinput type="text" class="style1" name="home_city" size=11 value="#home_city#" maxlength="100"></cfif></td>
														<td class="style1" align="right"><b>Zip:</b></td>
														<td class="style1"><cfif FORM.edit EQ 'no'>#home_zip#<cfelse><cfinput type="text" class="style1" name="home_zip" size=11 value="#home_zip#" maxlength="15"></cfif></td>
													</tr>
													<tr bordercolor="F7F7F7">
														...
														<td colspan="3" class="style1">
															...
															<cfelse>
																<select name="home_country" class="style1" <cfif FORM.edit EQ 'no'>disabled</cfif>  >
																<option value="0"></option>		
																<cfloop query="countrylist">
													...
													<tr bordercolor="F7F7F7">
														...
														<td class="style1" colspan="3"><cfif FORM.edit EQ 'no'>#home_phone#<cfelse><cfinput type="text" class="style1" name="home_phone" size=38 value="#home_phone#" maxlength="50"></cfif></td>
													</tr>
													<tr bordercolor="F7F7F7">
														<td class="style1" align="right"><b>Email:</b></td>
														<td class="style1" colspan="3"><cfif FORM.edit EQ 'no'>#email#<cfelse><cfinput type="text" class="style1" name="email" size=38 value="#email#" maxlength="100"></cfif></td>
													</tr>
												</table>
								...
								<td bordercolor="FFFFFF">
									...
									<table width="100%" cellpadding=5 cellspacing=0 border=0>
										...
										<tr>
											...
											<td class="style1"><cfif FORM.edit EQ 'no'>#emergency_name#<cfelse><cfinput type="text" class="style1" name="emergency_name" size=32 value="#emergency_name#" maxlength="200"></cfif></td>
										</tr>
										<tr>
											<td class="style1" align="right"><b>Phone:</b></td>
											<td class="style1"><cfif FORM.edit EQ 'no'>#emergency_phone#<cfelse><cfinput type="text" class="style1" name="emergency_phone" size=32 value="#emergency_phone#" maxlength="50"></cfif></td>
										</tr>
										<tr>
											<td class="style1" align="right"><b>Relationship:</b></td>
											<td class="style1"><cfif FORM.edit EQ 'no'>#emergency_relationship#<cfelse><cfinput type="text" class="style1" name="emergency_relationship" size=32 value="#emergency_relationship#" maxlength="50"></cfif></td>
										</tr>
									</table>	
							...
							<tr>
								<td bordercolor="FFFFFF">
									...
									<table width="100%" cellpadding=5 cellspacing=0 border=0>
										...
										<tr>
											<td width="15%" class="style4" colspan="2" align="center"><a href='reports/enrollment_confirmation.cfm?uniqueid=#get_candidate_unqid.uniqueid#' class="style4Big", target="_blank"><b>Enrollment Confirmation</b></a></td></tr>
							...
							<tr>
								<td bordercolor="FFFFFF">
									...
									<table width="100%" cellpadding=5 cellspacing=0 border=0>
										...
										<tr>
											<td width="46%" class="style1" colspan="2"><Cfif #doc_application# Eq '0'><input type="checkbox" name="doc_application" <cfif FORM.edit EQ 'no'>disabled</cfif>> <cfelse> <input type="checkbox" name="doc_application" checked <cfif FORM.edit EQ 'no'>disabled</cfif> > </cfif> Application</td>
											<td width="54%" class="style1" colspan="2"><Cfif #doc_passportphoto# Eq '0'><input type="checkbox" name="doc_passportphoto" <cfif FORM.edit EQ 'no'>disabled</cfif>> <cfelse> <input type="checkbox" name="doc_passportphoto" checked <cfif FORM.edit EQ 'no'>disabled</cfif> > </cfif> Passport Photocopy</td>
										</tr>
										<tr>
											<td class="style1" colspan="2"><Cfif doc_resume Eq '0'><input type="checkbox" name="doc_resume" <cfif FORM.edit EQ 'no'>disabled</cfif>> <cfelse> <input type="checkbox" name="doc_resume" checked <cfif FORM.edit EQ 'no'>disabled</cfif> > </cfif> Resume</td>
											<td class="style1" colspan="2"><Cfif doc_insu Eq '0'><input type="checkbox" name="doc_insu" <cfif FORM.edit EQ 'no'>disabled</cfif>> <cfelse> <input type="checkbox" name="doc_insu" checked <cfif FORM.edit EQ 'no'>disabled</cfif> > </cfif> Medical Insurance Appli.</td>
										</tr>
										<tr>
											<td class="style1" colspan="2"><Cfif doc_proficiency Eq '0'><input type="checkbox" name="doc_proficiency" <cfif FORM.edit EQ 'no'>disabled</cfif>> <cfelse> <input type="checkbox" name="doc_proficiency" checked <cfif FORM.edit EQ 'no'>disabled</cfif> > </cfif> Proficiency Verification</td>
											<td class="style1" colspan="2"><Cfif doc_sponsor_letter Eq '0'><input type="checkbox" name="doc_sponsor_letter" <cfif FORM.edit EQ 'no'>disabled</cfif>> <cfelse> <input type="checkbox" name="doc_sponsor_letter" checked <cfif FORM.edit EQ 'no'>disabled</cfif> > </cfif> Home Sponsor Letter</td>
										</tr>
										<tr>
											<td class="style1" colspan="4"><Cfif doc_recom_letter Eq '0'><input type="checkbox" name="doc_recom_letter" <cfif FORM.edit EQ 'no'>disabled</cfif>> <cfelse> <input type="checkbox" name="doc_recom_letter" checked <cfif FORM.edit EQ 'no'>disabled</cfif> > </cfif> Letters of Recommendation</td>
										</tr>
										<tr>
											<td class="style1"> Missing Documents:</td>
											<td class="style1" colspan="3"><cfif FORM.edit EQ 'no'>#missing_documents#<cfelse><textarea name="missing_documents" class="style1" cols="25" rows="3">#missing_documents#</textarea></cfif></td>
										</tr>
									</table>
										...
										<tr>
											<!---- <td width="20">
												<Cfif #DateFormat(cancel_date, 'mm/dd/yyyy')# is ''> 
													<input name="cancel_date_check" type="checkbox" <cfif FORM.edit EQ 'no'>disabled="disabled"</cfif>> 
												<cfelse> 
													<input type="checkbox" name="cancel_date_check" checked="checked" <cfif FORM.edit EQ 'no'> disabled="disabled" </cfif>> 
												</Cfif>
										  </td> ---->
										  	<td class="style1" bordercolor="FFFFFF" align="right" valign="top"><b>Date:</b></td>
											<td class="style1" width="85%"><cfif FORM.edit EQ 'no'>#DateFormat(cancel_date, 'mm/dd/yyyy')#<cfelse><input type="text" class="style1" name="cancel_date" size=20 value="#DateFormat(cancel_date, 'mm/dd/yyyy')#"></cfif></td>
										</tr>
										<tr>
											<td class="style1" bordercolor="FFFFFF" align="right" valign="top"><b>Reason:</b></td>
											<td class="style1"><cfif FORM.edit EQ 'no'>#cancel_reason# <cfelse><input type="text" class="style1" name="cancel_reason" size=40 value="#cancel_reason#"></cfif></td>								
										</tr>
									</table>
								...
								<td bordercolor="FFFFFF" valign="top">
									...
									<table width="100%" cellpadding=5 cellspacing=0 border=0>
										...
										<tr>
											...
											<cfif FORM.edit EQ 'no'>#get_extrajobs.title# <cfelse> 
								...
								<td bordercolor="FFFFFF">
									...
									<table width="100%" cellpadding=5 cellspacing=0 border=0>
										...
										<tr>
											...
											<td class="style1" bordercolor="FFFFFF" colspan="3"><cfif FORM.edit EQ 'no'>#dateformat (earliestarrival, 'mm/dd/yyyy')#<cfelse><cfinput type="text" class="style1" name="earliestarrival" size=35 value="#dateformat (earliestarrival, 'mm/dd/yyyy')#" maxlength="35"  validate="date" message="Earlisest Arrival (MM/DD/YYYY)"></cfif></td>
										</tr>		
										<tr>
									...
									<table width="100%" cellpadding=3 cellspacing=0 border=0>
                                        ...
                                        <tr>
                                            ...
                                            <td class="style1" colspan="3">
												...
												<input type="checkbox" name="ds2019Check" id="ds2019Check" class="style1" onClick="populateDate('#DateFormat(now(), 'mm/dd/yyyy')#');" value="1" <cfif LEN(verification_received)>checked="checked"</cfif> <cfif edit EQ 'no'>disabled</cfif>>
										...
										<tr>
											...
											<td colspan="3" class="style1"><cfif FORM.edit EQ 'no'>#ds2019_street#<cfelse><cfinput type="text" class="style1" name="ds2019_street" size=50 value="#ds2019_street#" maxlength="150"></cfif></td>
										</tr>
										<tr>
										  <td class="style1" align="right"><b>City:</b></td>
										  <td class="style1"><cfif FORM.edit EQ 'no'>
										    #ds2019_city#
										        <cfelse>
											...
											<td class="style1"><cfif FORM.edit EQ 'no'>#ds2019_zip#<cfelse><cfinput type="text" class="style1" name="ds2019_zip" size=12 value="#ds2019_zip#" maxlength="10"></cfif></td>
										</tr>
										<tr>
