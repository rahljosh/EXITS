...
<Table width=80% frame=below cellpadding=6 cellspacing="0" align="center">
	...
	<tr bgcolor="ededed">
		<td></td><td><b>#get_agent_list.businessname#</b></td><td align="center"><b>#get_agent_list.total_candidate#</b></td>
	</tr>
	<cfset total = total + #get_agent_list.total_candidate#>
...
<!---			AND onhold_approved <= '4'--->
		...
		<tr><td></td><td colspan="2">#firstname# #familylastname# (###candidateid#)</td></tr>
		</cfloop>
	</cfloop>
