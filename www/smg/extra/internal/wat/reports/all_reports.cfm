			...
			<table cellpadding=3 cellspacing=3 border=1 align="center" width="100%" bordercolor="C7CFDC" bgcolor="ffffff">
				<tr>
				  <td bordercolor="FFFFFF">
						...
						<br />
						&nbsp; &nbsp; &nbsp;<a href="index.cfm?curdoc=reports/all_students_enrolled_wt" class="style4">- All active students</a><br />
						<br />
						&nbsp; &nbsp; &nbsp;<a href="index.cfm?curdoc=reports/all_canceled_students_enrolled_wt" class="style4">- All cancelled students</a><br />
						<br />
						&nbsp; &nbsp; &nbsp;<a href="index.cfm?curdoc=reports/ds2019_verification_wt" class="style4">- DS-2019 Verification Report</a></span></td>
				</tr>
			</table>
		</td>
	</tr>
				...
				<tr>
				  <td bordercolor="FFFFFF">
					  <span class="style1"><strong>2. Host Company Reports</strong><br />
                        <br />
                     &nbsp; &nbsp; &nbsp;<a href="index.cfm?curdoc=reports/students_hired_per_company_wt" class="style4">- All active students</a><br />
                        <br />
                      &nbsp; &nbsp; &nbsp;</a><a href="index.cfm?curdoc=reports/all_canceled_students_hc_wt" class="style4">- All cancelled students</a></span></td>
				</tr>
			</table>
		</td>
	</tr>
