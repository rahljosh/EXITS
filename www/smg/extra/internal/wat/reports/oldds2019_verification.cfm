...
<cfoutput>
	...
	<td><img src="../../pics/logo/#client.companyid#.gif"  alt="" border="0" align="right"></td>	
...
<cfoutput>
<div align="center"><h4>Total of #get_candidate.recordcount# student(s).</h4></b></div>
...
<Table width=98% frame=below cellpadding=14 cellspacing="0">
	...
	<tr bgcolor="#iif(get_candidate.currentrow MOD 2 ,DE("ededed") ,DE("white") )#" >
		<td>#get_candidate.candidateid#</td><td>#get_candidate.lastname#</td><td>#get_candidate.firstname#</td>
		<td>#get_candidate.middlename#</td><td>#get_candidate.sex#</td><td>#DateFormat(get_candidate.dob, 'mm/dd/yyyy')#</td>
		<td>#get_candidate.birth_city#</td><td>#get_candidate.countrybirth#</td><td>#get_candidate.countrycitizen#</td>
		<td>#get_candidate.countryresident#</td>
	</tr>
	</cfoutput>
</Table>
