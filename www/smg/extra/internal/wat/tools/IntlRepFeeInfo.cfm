...
<cfinput type="hidden" name="count" value="#qGetIntlReps.recordcount#">
	...
	<tr>
		<td>
			...
			<table width="95%" border="0" cellpadding="3" cellspacing="0" align="center" bordercolor="##C7CFDC">	
				...
				<tr bgcolor="##4F8EA4">
					<td colspan="6" align="center"><cfinput type="image" name="next" value=" Update " src="../pics/update.gif" align="middle"></td>
				</tr>
			</table>
