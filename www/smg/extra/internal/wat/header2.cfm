...
<title>EXTRA - Exchange Trainign Abroad</title>
...
<table width = 90% border=0 align="center" bordercolor="##CCCCCC" bgcolor="##FFFFFF">
	<tr>
		<td width=98 rowspan=4 bordercolor="##FFFFFF"><div align="center"><A href="index.cfm?curdoc=initial_welcome"><img src="../pics/extra-logo.jpg" width="60" height="81" border=0></a></div>
		</td>
	</tr>
	<tr>
		...
		<td width="111" valign=top bordercolor="##FFFFFF" class="style1">
		...
		<td width="110" align="right" valign="top" bordercolor="##FFFFFF" class="style1">
	...
	<tr>
		<td colspan=4 valign="bottom" bordercolor="##FFFFFF"><cfinclude template="menu.cfm">
		</td>
	</tr>
</table>
