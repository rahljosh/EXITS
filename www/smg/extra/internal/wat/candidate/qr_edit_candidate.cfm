...
<cfquery datasource="mysql">
    ...
    SET 
        ...
        <cfelse>
            verification_received = <cfqueryparam cfsqltype="cf_sql_date" value="" null="yes">,
        </cfif>
        ...
        <cfelse>
        	cancel_date = <cfqueryparam cfsqltype="cf_sql_date" value="" null="yes">,
        </cfif>
