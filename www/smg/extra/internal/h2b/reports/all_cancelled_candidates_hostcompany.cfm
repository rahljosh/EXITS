...
<cfquery name="get_candidates" datasource="MySql">
  ...
  WHERE <!----extra_candidates.status = 0
...
<cfoutput>
<form action="index.cfm?curdoc=reports/all_cancelled_candidates_hostcompany" method="post">
<table width="95%" cellpadding="4" cellspacing="0" border="0" align="center">
  <tr valign="middle" height="24">
    <td valign="middle" bgcolor="##E4E4E4" class="title1" colspan=2><font size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;All cancelled candidates per Host Company Representative and Program  </font></td>
...
<cfif isDefined('form.print')>
	<cfif form.print eq 1>
		...
		<meta http-equiv="refresh" content="1;url=index.cfm?curdoc=reports/all_cancelled_candidates_hostcompanyflashpaper&program=#form.program#&hostcompanyid=#form.companyid#">
