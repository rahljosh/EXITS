...
<cfif isDefined('form.submitted')>	
	...
	<cfelse>
		<cfquery name="updateHostInfo" datasource="#APPLICATION.dsn#">
		insert into smg_notes(appNotes, hostID) 
		values("#form.notes# <br> #client.name# - #DateFormat(now(), 'mmmm d, yyyy')#<hr>",#URL.hostID#)
		</cfquery>
	</cfif>
</cfif>
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<div class="tab-v2 margin-bottom-40">
					 <div class="headline"><h2 class="heading-lg">Notes on Pending Host Family</h2></div>
						<div class="row">
								...
								<div class="col-sm-10">
									<div class="tag-box tag-box-v3">	
											...
											<div class="col-sm-12">
												<div class="panel panel-default">
												  <div class="panel-heading">
													<h3 class="panel-title">Notes since pending status</h3>
												  </div>
										...
										<cfform method="post" action="appNotes.cfm?hostID=#URL.hostID#">
										<div class="row">
											<div class="col-sm-12">
												<div class="panel panel-default">
												  <div class="panel-heading">
										...
										<div class="row">
											<div class="col-sm-6">
												<A href="appNotes.cfm?close=1" class="btn btn-u btn-u-lg btn-u-orange"><i class="fa fa-times-circle-o" aria-hidden="true"></i> Close</p></a>
											</div>
											<div class="col-sm-6">
												<cfoutput>
														<input type="hidden" name="hostID" value=#URL.hostID#>
