<!--- ------------------------------------------------------------------------- ----
	...
	File:		_secondVisitRepCompliance.cfm
	...
	<cfoutput>
        ...
        <form action="report/index.cfm?action=userSecondVisitCompliance" name="userSecondVisitCompliance" id="userSecondVisitCompliance" method="post" target="blank">
            ...
            <table width="50%" cellpadding="4" cellspacing="0" class="blueThemeReportTable" align="center">
                <tr><th colspan="2">Representative Management - 2<sup>nd</sup> Visit Representative Compliance</th></tr>
                <tr class="on">
    ...
    <cfoutput>
        ...
        <cfif FORM.outputType EQ 'excel'>
            ...
            <table width="98%" cellpadding="4" cellspacing="0" align="center" border="1">
                <tr>
                    <th colspan="14">2<sup>nd</sup> Visit Representative Compliance</th>            
                </tr>
        ...
        <cfelse>
            ...
            <cfsavecontent variable="reportHeader">
                ...
                <table width="98%" cellpadding="4" cellspacing="0" align="center" class="blueThemeReportTable">
                    <tr>
                        <th>2<sup>nd</sup> Visit Representative Compliance</th>
                    </tr>
                    <tr>
                        <td class="center">
