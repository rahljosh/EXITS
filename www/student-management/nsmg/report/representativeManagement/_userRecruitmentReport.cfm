...
<cfsilent>
    ...
    <cfif VAL(FORM.submitted)>
        ...
        <cfif NOT SESSION.formErrors.length()>
            ...
            <cfquery name="qGetRegions" dbtype="query">
            	SELECT
                	*
              	FROM
                	qGetRegionList
            ...
            <cfquery name="qGetTotalWithPlacements" datasource="#APPLICATION.DSN#">
       			SELECT
                	u.userID,
                    uar.regionID
                FROM
...
<cfelse>
    ...
    <cfif FORM.outputType EQ 'excel'>
        ...
        <table width="98%" cellpadding="4" cellspacing="0" align="center" border="1">
            <tr><th colspan="6"><cfoutput>#vReportTitle#</cfoutput></th></tr>
            ...
            <cfloop query="qGetRegions">
                ...
                <cfoutput>      
                    <tr>
                        <td bgcolor="#vRowColor#"><cfif CLIENT.companyID EQ 5>#companyShort# - </cfif>#regionName#</td>
            ...
            <cfscript>
				...
				percentWithPlacement = 0.00;
				if ( (qGetTotalWithPlacements.recordCount NEQ 0) AND (qGetTotal.recordCount NEQ 0) ) {
					percentWithPlacement = (qGetTotalWithPlacements.recordCount/qGetTotal.recordCount) * 100;
				}
            ...
            <cfoutput>
                <tr>
                    <td bgcolor="#vRowColor#">Total</td>
                    <td bgcolor="#vRowColor#">#qGetTotal.recordCount#</td>
                    <td bgcolor="#vRowColor#">#qGetTotalEnabled.recordCount#</td>
                    <td bgcolor="#vRowColor#">#NumberFormat(percentEnabled,'99.99')#%</td>
                    <td bgcolor="#vRowColor#">#qGetTotalWithPlacements.recordCount#</td>
                    <td bgcolor="#vRowColor#">#NumberFormat(percentWithPlacement,'99.99')#%</td>
                </tr>
        	</cfoutput>
    	...
    	<cfsavecontent variable="report">
            ...
            <cfoutput>
                ...
                <cfloop query="qGetRegions">
                    ...
                    <table width="98%" cellpadding="4" cellspacing="0" align="center" class="blueThemeReportTable">
              			<tr>
                            <th class="left" colspan="9"><cfif CLIENT.companyID EQ 5>#companyShort# - </cfif>#regionName#</th>
                        </tr>      
                        <tr>
                ...
                <cfscript>
                 ...
                 <table width="98%" cellpadding="4" cellspacing="0" align="center" class="blueThemeReportTable">
                    ...
                    <tr>
                        ...
                        <td style="font-size:10px" align="center"><b>#NumberFormat(percentEnabled,'99.99')#%</b></td>
                        <td style="font-size:10px" align="center"><b>#qGetTotalWithPlacements.recordCount#</b></td>
                        <td style="font-size:10px" align="center"><b>#NumberFormat(percentWithPlacement,'99.99')#%</b></td>
                    </tr>
                </table>
