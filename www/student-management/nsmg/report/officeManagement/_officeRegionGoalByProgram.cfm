<!--- ------------------------------------------------------------------------- ----
	...
	File:		_officeRegionGoalByProgram.cfm
	Author:		James Griffiths
	Date:		January 22, 2013
	Desc:		Goal Per Region by Program
				
				#CGI.SCRIPT_NAME#?curdoc=report/index?action=officeRegionGoalByProgram	
        ...
        <cfif NOT SESSION.formErrors.length()>
			 ...
			 <cfquery name="qGetResults" datasource="#APPLICATION.DSN#">
                ...
                LEFT OUTER JOIN
                    ...
                    AND
                        a.seasonID IN ( SELECT seasonID FROM smg_programs WHERE programID = <cfqueryparam cfsqltype="cf_sql_integer" value="#FORM.programID#"> )
                WHERE
        ...
        <cfquery name="qGetStudents" datasource="#APPLICATION.DSN#">
            ...
            INNER JOIN 
                smg_programs p ON s.programID = p.programID
                    ...
                    AND
                        p.programID = <cfqueryparam cfsqltype="cf_sql_integer" value="#FORM.programID#"> 
            LEFT OUTER JOIN
...
<cfif NOT VAL(FORM.Submitted)>
	...
	<cfoutput>
        ...
        <form action="report/index.cfm?action=officeRegionGoalByProgram" name="officeRegionGoal" id="officeRegionGoal" method="post" target="blank">
