<!--- ------------------------------------------------------------------------- ----
	...
	File:		_hostFamilySpreadSheet.cfm
	Author:		James Griffiths
	Date:		June 15, 2012
	Desc:		Host Family Spreadsheet
				
				#CGI.SCRIPT_NAME#?curdoc=report/index?action=hostFamilySpreadsheet
...
<cfif NOT VAL(FORM.Submitted)>
	...
	<cfoutput>
        ...
        <form action="report/index.cfm?action=hostFamilySpreadsheet" name="hostFamilySpreadsheet" id="hostFamilySpreadsheet" method="post" target="blank">
            <input type="hidden" name="submitted" value="1" />
            <table width="50%" cellpadding="4" cellspacing="0" class="blueThemeReportTable" align="center">
                <tr><th colspan="2">Host Family Management - Host Family Spreadsheet</th></tr>
                <tr class="on">
...
<cfelse>
    ...
    <cfif FORM.outputType EQ 'excel'>
        ...
        <cfheader name="Content-Disposition" value="attachment; filename=hostFamilySpreadSheet.xls"> 
        
        <table width="98%" cellpadding="4" cellspacing="0" align="center" border="1">
            <tr>
                <th colspan="5">Host Family Management - Host Family Spreadsheet</th>            
            </tr>
    ...
    <cfelse>
        ...
        <cfoutput>
            ...
            <table width="98%" cellpadding="4" cellspacing="0" align="center" class="blueThemeReportTable">
                <tr>
                	<th width="12%"></th>
                    <th width="76%" align="center" colspan="3">Host Family Management - Host Family Spreadsheet</th>
