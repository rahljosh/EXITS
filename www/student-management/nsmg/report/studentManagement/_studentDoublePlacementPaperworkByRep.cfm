<!--- ------------------------------------------------------------------------- ----
	...
	File:		_studentDoublePlacementPaperworkByRep.cfm
	Author:		James Griffiths
	Date:		June 18, 2012
	Desc:		Student Double Placement Paperwork by Region
				
				#CGI.SCRIPT_NAME#?curdoc=report/index?action=studentDoublePlacementPaperworkByRep
...
<cfif NOT VAL(FORM.Submitted)>
	...
	<cfoutput>
        ...
        <form action="report/index.cfm?action=studentDoublePlacementPaperworkByRep" name="studentDoublePlacementPaperworkByRep" id="studentDoublePlacementPaperworkByRep" method="post" target="blank">
            <input type="hidden" name="submitted" value="1" />
            <table width="50%" cellpadding="4" cellspacing="0" class="blueThemeReportTable" align="center">
                <tr><th colspan="2">Student Management - Double Placement Paperwork by International Representative</th></tr>
                <tr class="on">
