<!--- ------------------------------------------------------------------------- ----
	...
	File:		_placementPaperworkByRegion.cfm
	Author:		Marcus Melo
	Date:		April 20, 2012
...
<cfif FORM.outputType EQ 'excel'>
	...
	<cfheader name="Content-Disposition" value="attachment; filename=DOS-Missing-Placement-Paperwork-By-Region.xls"> 
    
    <table width="98%" cellpadding="4" cellspacing="0" align="center" border="1">
        <tr>
            <th colspan="12">Host Family Management - Placement Paperwork by Region</th>            
        </tr>
	...
	<cfoutput>
        ...
        <cfsavecontent variable="reportHeader">
            ...
            <table width="98%" cellpadding="4" cellspacing="0" align="center" class="blueThemeReportTable">
                <tr>
                    <th>Host Family Management - Placement Paperwork by Region</th>            
                </tr>
                <tr>
                    <td class="center">
