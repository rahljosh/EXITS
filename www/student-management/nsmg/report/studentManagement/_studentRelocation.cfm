<!--- ------------------------------------------------------------------------- ----
	...
	File:		_studentRelocation.cfm
	Author:		James Griffiths
	Date:		May 29, 2012
	Desc:		Student Relocation Report
	
				#CGI.SCRIPT_NAME#?curdoc=report/index?action=studentRelocation
...
<cfsilent>
    ...
    <cfscript>	
		...
		vReportTitle = "Student Management - Relocation";
        ...
        <cfif NOT SESSION.formErrors.length()>
            ...
            <cfquery name="qGetResults" datasource="#APPLICATION.DSN#">
                ...
                <cfif FORM.placedDateTo NEQ "">
                	AND
                    	s.datePlaced < <cfqueryparam cfsqltype="cf_sql_date" value="#DateAdd('d',1,FORM.placedDateTo)#">
               	</cfif>
                <!--- Regional Advisors --->
...
<cfif NOT VAL(FORM.Submitted)>
	...
	<cfoutput>
        ...
        <form action="report/index.cfm?action=studentRelocation" name="studentRelocation" id="studentRelocation" method="post" target="blank">
