<!--- ------------------------------------------------------------------------- ----
	...
	Desc:		Tours permission form report
				...
				#CGI.SCRIPT_NAME#?curdoc=report/MPDReports/permissionFormPerTour			
...
<cfif NOT VAL(FORM.Submitted)>
	...
	<cfoutput>
        ...
        <form action="report/MPDReports/index.cfm?action=permissionFormPerTour" name="permissionFormPerTour" id="permissionFormPerTour" method="post" target="blank">
