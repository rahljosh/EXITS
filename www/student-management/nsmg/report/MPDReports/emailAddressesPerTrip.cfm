<!--- ------------------------------------------------------------------------- ----
	...
	Desc:		Tours email address report
				...
				#CGI.SCRIPT_NAME#?curdoc=report/MPDReports/emailAddressesPerTrip			
...
<cfif NOT VAL(FORM.Submitted)>
	...
	<cfoutput>
        ...
        <form action="report/MPDReports/index.cfm?action=emailAddressesPerTrip" name="emailAddressesPerTrip" id="emailAddressesPerTrip" method="post" target="blank">
