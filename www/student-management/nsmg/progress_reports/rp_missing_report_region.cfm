...
<table width="90%" cellpadding="2" cellspacing="0" align="center" frame="box">
	<th><span class="application_section_header">#companyshort.companyshort# - Missing Phase
    <cfif form.rmonth eq 10>
    1
    <cfelseif form.rmonth eq 12>
    2
    <cfelseif form.rmonth eq 2>
    3
    <cfelseif form.rmonth eq 4>
    4
    <cfelseif form.rmonth eq 6>
    5
    <cfelse>
    6
    </cfif>
    Progress Reports</span></th>
	<tr>
		<td><b>Program(s) :</b><br> 
	...
	<cfif get_students.recordcount>
		<table width="90%" cellpadding="2" cellspacing="0" align="center" frame="box">
			...
			<cfloop query="get_students">		
				...
				<cfquery name="month_report" datasource="MySql">
					SELECT DISTINCT fk_student 
					FROM progress_reports 
					WHERE fk_student = '#studentid#'
						AND pr_month_of_report = '#form.rmonth#' 
				</cfquery>
...
<!---
	...
	<cfloop list="#form["prtype" & type]#" index="i">
		<cfquery name="month_#i#" datasource="MySql">
