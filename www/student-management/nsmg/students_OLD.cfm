...
<cfsilent>
    ...
    <cfparam name="recordsToShow" default="50">
...
<cfoutput>
    ...
    <cfform action="index.cfm?curdoc=students_OLD" method="post">
                                ...
                                <cfif CLIENT.usertype NEQ 9>
                                    <td>
                                        ...
                                        <select name="placed">
                                            ...
                                            <option value="1" <cfif form.placed EQ 1>selected</cfif>>Yes</option>
                                            <option value="0" <cfif form.placed EQ 0>selected</cfif>>No</option>
                                        </select>            
                                    </td>
                                </cfif>
                                <cfif listFind("1,2,3,4", CLIENT.userType)>
