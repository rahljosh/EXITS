...
<table width="500" border=0 cellpadding=3 cellspacing=0 align="center">
	<tr>
		<td style="line-height:20px;" valign="top" colspan=3>
			<cfform action="qr_upload_page22.cfm" name="upload_form" method="post" enctype="multipart/form-data" preloader="no">
			...
			<br><br>
			<cfinput type="image" name="upload" src="../pics/uploadpage.gif" alt="Upload File to Server"><br>
			</div>
			</cfform>
		</td>
	</tr>
