	...
	<tr>
		<td style="line-height:20px;" valign="top" colspan=3><br>
			<cfform action="qr_upload_letter.cfm" method="post" name="upload_letter" enctype="multipart/form-data" preloader="no">
				...
				<strong>PLEASE UPLOAD ONLY JPG, JPEG, GIF, TIF, TIFF, PNG, OR PDF FILES.</strong>
                <br />
				If you upload the wrong letter, just upload the correct file and the wrong file will be removed. 
				<br />
				<div align="center">
					Browse for the file.. 
                    <cfinput type="file" name="letter" size=35 required="yes" enctype="multipart/form-data" message="You must select a file in order to continue." validateat="onsubmit,onserver">
					<br />
                    <br />
					<cfinput type="image" name="upload" src="../pics/uploadletter.gif" alt="Upload Letter to Server">
                    <br />
				</div>
			</cfform>
		</td>
