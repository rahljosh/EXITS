...
<table width="670" border=0 cellpadding=1 cellspacing=0 align="center">
	...
	<tr><td>
			<div align="justify">
				<u>_____________________________________________________________, </u> a minor (hereafter "Exchange Student"), do hereby authorize and consent to the following:
				<br/><br/>
...
<table width="670" border=0 cellpadding=1 cellspacing=0 align="center">
	...
	<tr><td><br><img src="#path#pics/line.gif" width="400" height="1" border="0" align="absmiddle"></td></tr>
	<tr><td>&nbsp;</td></tr>
