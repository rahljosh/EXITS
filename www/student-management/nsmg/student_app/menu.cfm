...
<table width=100% cellpadding=0 cellspacing=0 border="0" id="menu1" align="center">
	...
	<tr>
		...
		<cfif url.p EQ '21'>
			<td align="center" class="selected"><a class="item2" href="?curdoc=section4/page21#print#&id=4&p=21" onClick="return CheckLink();"><div class="selectedlink">Page [21] &nbsp; State Choice </div></a></td>
		<cfelse>
			<td align="center" class="ddmx"><a class="item2" href="?curdoc=section4/page21#print#&id=4&p=21" onClick="return CheckLink();">Page [21] &nbsp; State Choice </a></td>
		</cfif>	
		<cfif url.p EQ '22'>
