...
<p style="font-size:10px;" >I understand and agree that this agreement shall constitute a binding contract between the undersigned and "#CLIENT.companyshort#". "#CLIENT.companyshort#" is defined to include: International Student Exchange, Inc., its affiliates, and their owners, directors, officers, and employees.</p>
<ol>
...
<li style="font-size:10px;">All program applications are subject to acceptance by #CLIENT.companyshort# in Babylon, NY, U.S.A.</li>
