...
<cfif file.recordcount NEQ '0'>
	<table width="670" border=0 cellpadding=3 cellspacing=0 align="center">
		...
		<tr><td><a href="#AppPath.onlineApp.uploadURL#delete_inserts.cfm?referrer=#CGI.HTTP_HOST#&doc=#doc#&ref=#curdoc#&id=#url.id#&p=#url.p#&student=#client.studentid#" onClick="return areYouSure(this);"><img src="pics/button_drop.png" border=0> Delete file that was uploaded</a></td></tr>
		<tr><td><a href="" onClick="javascript: win=window.open('#AppPath.onlineApp.uploadURL#upload_file.cfm?referrer=#CGI.HTTP_HOST#&folder=#doc#&student=#client.studentid#', 'UploadFiles', 'height=310, width=600, location=no, scrollbars=yes, menubars=no, toolbars=no, resizable=yes'); win.opener=self; return false;"><img src="pics/docs.gif" border=0> Upload a new document (Note: the current file will be replaced by the new one)</a></td></tr>
	</table><br>
<cfelse>
	<table width="670" border=0 cellpadding=3 cellspacing=0 align="center">
		...
		<tr><td align="center"><a href="" onClick="javascript: win=window.open('#AppPath.onlineApp.uploadURL#upload_file.cfm?referrer=#CGI.HTTP_HOST#&folder=#doc#&student=#client.studentid#', 'UploadFiles', 'height=310, width=600, location=no, scrollbars=yes, menubars=no, toolbars=no, resizable=yes'); win.opener=self; return false;"><img src="pics/uploadpage.gif" border=0></img></a></td></tr>
	</table><br>
	<!---
        <table width="670" border=0 cellpadding=3 cellspacing=0 align="center">
            <tr><td align="center"><b>Note: &nbsp; This page needs to be uploaded.</b></td></tr>
