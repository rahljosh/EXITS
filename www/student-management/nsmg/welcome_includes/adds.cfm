<cfif (ListFind("1,2,3,4,5,6,7,9,15", CLIENT.userType) AND ListFind(APPLICATION.SETTINGS.COMPANYLIST.publicHS, CLIENT.companyid)) >

	<cfscript>
		tripcount = 7 - vPlacedStudents;
		vDeadline = CreateDate(Year(NOW()),9,12);
	</cfscript>
                        ...
                        <tr>
                            <cfif vPlacedStudents LT 7>
                                ...
                                <td>
                                    ...
                                    <a href="uploadedfiles/pdf_docs/#CLIENT.companyshort#/promotion/Incentive%20Trip.pdf" target="_blank">
                            ...
                            <cfelse>
                                <td colspan=2 style="font-size:16px; color:##C55;">
                                    ...
                                    <b><a href="uploadedfiles/pdf_docs/#CLIENT.companyshort#/promotion/Incentive%20Trip.pdf" target="_blank" style="color:##C55;">#incentive_trip.trip_place#!!!</a></b> 
