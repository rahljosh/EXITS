...
<h2>School Information</h2>
  <table width=100% cellspacing=0 cellpadding=2 class="border" align="center">
    <tr bgcolor="##deeaf3">
        <td class="label" width=100>High School<span class="redtext">*</span></td><td class="form_text" > <input type="text" name="schoolname" size="20" value="#form.schoolname#"></span>
</tr>
		<tr>
			<td class="label">Address<span class="redtext">*</span></td><td  class="form_text"> <input type="text" name="address" size="20" value="#form.address#"></td>
		</tr>
		<tr>
			<td></td ><td   class="form_text"> <input type="text" name="address2" size="20" value="#form.address2#">
		</tr>
		<tr bgcolor="##deeaf3">			 
			<td class="label">City<span class="redtext">*</span> </td><td   class="form_text"><input type="text" name="city" size="20" value="#form.city#">
		</tr> 
		<tr >	
    ...
    <tr>
    <td class="zip" >Zip<span class="redtext">*</span> </td><td class="form_text"><input type="text" name="zip" size="5" value="#form.zip#"></td>
		...
		<tr>			
		<td class="label">Phone</td><td class="form_text" ><cfinput type="text" name="phone" size=20 value="#form.phone#" placeholder="(208) 867-5309" mask='(999) 999-9999'></span>
		</tr>
		
		<tr  bgcolor="##deeaf3">
			<td class="label">Contact Email</td><td class="form_text" > <cfinput name="email" size=20 type="text" value="#form.email#" placeholder="contact@school.edu"></span>
		</tr>
        <Tr>
        	<td class="label">School Type</td>
            <td  ><input type="radio" value="public" name="schoolType" <Cfif form.schooltype is 'public'>checked</cfif> /> Public &nbsp;&nbsp; <input type="radio" value="private" name="schoolType" <Cfif form.schooltype is 'private'>checked</cfif>   /> Private </td>
        </Tr>
        <Tr  bgcolor="##deeaf3">
        	<td class="label">School Fees</td><td  ><input type="text" name="schoolFees" size=25 placeholder="amount of tution or fees" value="#form.schoolFees#" /> </td>
        </Tr>
        <tr>
			<td class="label">Student Enrollment</td>
            <td class="form_text" > <cfinput name="numberStudents" size=10 type="text" placeholder="1200" value="#FORM.numberofstudents#"></span>
		</tr>
        <tr   bgcolor="##deeaf3">
