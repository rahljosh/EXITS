...
select * 
from student_tours
where id = <cfqueryparam cfsqltype="cf_sql_integer" value="#form.tour_id#"> 
limit 1
</Cfquery>
<cfoutput>
...
#student_info.city# #student_info.state# &nbsp;&nbsp;#student_info.zip#<br />
 Local Airport: <strong>#student_info.local_air_code#</strong><br />
  ...
  <tr>
    ...
    select st.tripid, smgt.tour_Date, smgt.tour_name, smgt.tour_price
    ...
    where id = <cfqueryparam cfsqltype="cf_sql_integer" value="#form.tour_id#"> 
        ...
        <strong> #trip_info.tour_name# ($#trip_info.tour_price#)</strong> - #trip_info.tour_date#<br />
       	</cfloop>
    	</Td>
    </tr>    
