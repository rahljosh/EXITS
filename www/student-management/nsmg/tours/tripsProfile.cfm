...
<cfif client.usertype GT 4> <!--- Block if they try to cheat changing the student id in the address bar --->
	...
	<cfif  client.usertype neq 25><br>
...
<table width=650 align="center" border=0 bgcolor="FFFFFF">
	<tr>
	<td valign="top" width=80><img src="images/mpdlogo.jpg" width=72></td> 
	<td valign="top"><div align="center">
		<font size=+2><b>#get_student_info.firstname#  #get_student_info.familylastname#</b></font><br>
		
		Tour: #tourInfo.tour_name#<br>
		Nationality: #tourInfo.nationality# <br>
        Roommates: <cfif tourInfo.person1 is not ''> #tourInfo.person1#,</cfif> <cfif tourInfo.person2 is not ''> #tourInfo.person2#,</cfif> <cfif tourInfo.person3 is not ''> #tourInfo.person3#</cfif><cfif tourInfo.person1 is '' and tourInfo.person2 is '' and tourInfo.person3 is ''>None Specified</cfif></td>
...
<br>
	...
	<table width=650 align="center" border=0 bgcolor="FFFFFF" style="font-size:13px"> 
		...
		<tr>
        	<Td colspan=2>
            <hr width=80% align="center">
            <span class="application_section_header">Host Family Information</span><br> 
            </Td>
        </tr>
		<tr><td width="50%">
        
			<table>
				<tr><td width="100"><font color="Gray">Father:</font></td><td width="180">#get_students_host.fatherfirstname# #get_students_host.fatherlastname#</td></tr>
				<tr><td><font color="Gray">Cell Phone:</font></td><td>#get_students_host.father_cell#</td></tr>
				<tr>
				  <td><font color="Gray">Work Phone:</font></td><td>#get_students_host.fatherworkphone#</td></tr>
		...
		<td width="50%">
			<table>
				<tr>
                	<td width="100"><font color="Gray">Mother:</font></td><td width="180">#get_students_host.motherfirstname# #get_students_host.motherlastname#</td>
                </tr>
				<tr><td><font color="Gray">Cell Phone:</font></td><td>#get_students_host.mother_cell#</td></tr>
				<tr><td><font color="Gray">Work Phone:</font></td><td>#get_students_host.motherworkphone#</td></tr>
			</table>	
		</td>
		</tr>		
	...
	<table width=650 align="center" border=0 bgcolor="FFFFFF" style="font-size:13px"> 
		...
		<tr>
        	<td colspan=4><font face="" color="Gray">Additonal Allery Info:</font> <Cfif tourInfo.med is ''>None<cfelse>#tourInfo.med#</cfif> </td>
            </tr>
		<tr><td> </td></tr>
		<tr>
		<td colspan="4">
