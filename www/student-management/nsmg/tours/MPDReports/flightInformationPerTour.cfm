<!--- ------------------------------------------------------------------------- ----
	...
	Desc:		Flight Information report
				...
				#CGI.SCRIPT_NAME#?curdoc=tours/MPDReports/flightInformationPerTour			
...
<cfif NOT VAL(FORM.Submitted)>
	...
	<cfoutput>
        ...
        <form action="tours/MPDReports/index.cfm?action=flightInformationPerTour" name="flightInformationPerTour" id="flightInformationPerTour" method="post" target="blank">
