...
<cfquery name="refunds" datasource="mysql">
			select smg_invoice_refunds.companyid, smg_invoice_refunds.agentid, smg_invoice_refunds.amount,
			smg_credit.creditid, smg_credit.description, smg_credit.invoiceid, smg_credit.stuid, smg_credit.type, smg_credit.amount, 
...
#DateFormat(refunds.date, 'M/DD/yy')# 
		...
		<tr></tr>
				<td bgcolor="CCCCCC" align="center" class="thin-border-bottom"><b><FONT size="+1">Receipt ##</td>
			
		  </tr>
		  <tr>
			<td  align="center" class="thin-border-bottom"><b><FONT size="+1">#url.id#</td>
...
<cfquery name="total_refund" datasource="mysql">
			...
			from smg_invoice_refunds right join smg_credit on smg_invoice_refunds.creditid = smg_credit.id
			where smg_invoice_refunds.refund_receipt_id = #url.id#
