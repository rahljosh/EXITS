...
<cfsavecontent variable="email_message">
    Dear #qGetRegionInfo.firstname# #qGetRegionInfo.lastname#,<br><br>T
    his e-mail is just to let you know a new document has been uploaded into #qGetStudentInfo.firstname# #qGetStudentInfo.familylastname#'s (###qGetStudentInfo.studentid#) virtual folder by #qGetUser.businessname# #qGetUser.firstname# #qGetUser.lastname#.
...
<cfsavecontent variable="email_message">
    ...
    Please click  <a href="http://#exits_url#/nsmg/index.cfm?curdoc=intrep/int_student_info&unqid=#qGetStudentInfo.uniqueID#">here</a> to see the student's virtual folder.<br><br>
    Sincerely,<br>
    EXITS - #CLIENT.companyname#<br><br>
</cfsavecontent>
