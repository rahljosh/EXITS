...
----- ------------------------------------------------------------------------- --->
   ...
   <!-- Remove the end item on the SMG.CSS for full bootstrap usage-->
    ...
    <cfoutput>
		...
		<script src="/nsmg/assets/js/jquery.js" crossorigin="anonymous"></script>
		<script src="/nsmg/assets/js/bootstrap.min.js" crossorigin="anonymous"></script>
		<!---
