...
<cffunction name="geocode" returnType="struct" output="false">
	...
	<cfif structKeyExists(xmlResult.addressdetails.country, "administrativearea")>
		...
		<cfif structKeyExists(xmlResult.addressdetails.country.administrativearea, "subadministrativearea")>
			...
			<cfset result.subadministrativeareathoroughfare = xmlResult.addressdetails.country.administrativearea.subadministrativearea.locality.thoroughfare.thoroughfarename.xmltext>
			<cfset result.subadministrativeareapostalcode = xmlResult.addressdetails.country.administrativearea.subadministrativearea.locality.postalcode.postalcodenumber.xmltext>
		</cfif>
