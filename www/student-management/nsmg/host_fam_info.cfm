...
<div style="width:49%;float:left;display:block;">
   ...
   <br /><br />
		...
		<table width=100% cellpadding=4 cellspacing=0 border=0>
			<tr bgcolor="0b5886">
				<td valign="top"><font color="##FFFFFF"><b>Name</b></td>
				<td align="center" valign="top"><font color="##FFFFFF"><b>Season</b></td>		
				<td align="center" valign="top"><font color="##FFFFFF"><b>Date Submitted</b> <br><font size="-2">mm/dd/yyyy</font></td>
                <td align="center" valign="top"><font color="##FFFFFF"><b>Expiration Date</b> <br><font size="-2">mm/dd/yyyy</font></td>		
				<td align="center" valign="top"><font color="##FFFFFF"><b>View</b></td>
                 <cfif client.usertype lte 4> <td align="left" valign="top"><font color="##FFFFFF"><b>Notes</b></td></cfif>
			...
			<cfelse>
				<tr><td colspan="6" bgcolor="d6e8f3"><strong>Host Mother:</strong></td></tr>
				...
				<tr bgcolor="d6e8f3"><td colspan="6"><strong>Host Father:</strong></td></tr>
			...
			<tr bgcolor="d6e8f3"><td colspan="6"><strong>Other Family Members</strong></td></tr>
  ...
  <div style="width:49%;float:right;display:block;">
       <!--- ------------------------------------------------------------------------- ---->
    	...
    	<div class="rdholder" style="width:100%;float:right;" > 
                ...
                <a href="index.cfm?curdoc=forms/host_fam_mem_form&hostID=#family_info.hostID#"><img src="pics/buttons/new23x23.png" class="floatRight" border=0 /></a></a>
                </cfif>
            	</div> <!-- end top --> 
             <div class="rdbox">
