...
<cfsilent>
    ...
    <cfscript>
		...
		vAllowedDivisionChangeList = "8731,8743,12313,12431,16718,12389,17993,16552,17972";  // Bill, Bob, Brian Hause, Gary, Tal and Merri, Jan McInvale, Steve S, john	
	...
	<tr>
		...
		<div id="subMenuNav"> 
			<div id="subMenuLinks">  
                ...
                <cfif listFind("1,510,12313,17438", CLIENT.userID)>
