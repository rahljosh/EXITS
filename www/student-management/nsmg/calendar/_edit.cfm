...
<cfsilent>
	...
	<cfif FORM.submitted>
		...
		<cfif NOT ArrayLen( arrErrors )>
					...
					<cfcase value="2">
						...
						<cfquery name="qInsert" datasource="#APPLICATION.DSN#">
							...
							(
								...
								<cfqueryparam value="#TRIM(FORM.webEx_url)#" cfsqltype="CF_SQL_VARCHAR" />, 			<!--- webEx_url --->
					...
					<cfdefaultcase>
						...
						<cfquery name="qUpdate" datasource="#APPLICATION.DSN#">
							...
							SET
								...
								webEx_url = <cfqueryparam value="#TRIM(FORM.webEx_url)#" cfsqltype="CF_SQL_VARCHAR" />, 			<!--- webEx_url --->
			...
			<cfelse>
				...
				<cflocation
					url="#REQUEST.URLPath#&action=month&date=#Fix( FORM.date_started )#"
					addtoken="false"
					/>
	...
	<cfelse>
		...
		<cfif qEvent.RecordCount>
			...
			<cfset FORM.webEx_url = qEvent.webEx_url />
...
<cfoutput>
	...
	<form action="#REQUEST.URLFullPath#" method="post">
		...
		<tr>
			...
			<td class="right">
                <textarea name="webEx_url" id="webEx_url" class="webEx_url">#FORM.webEx_url#</textarea><br />			
			</td>
		</tr>
		<tr>
			<td class="left">
		...
		<cfif REQUEST.Attributes.viewas>
			...
			<p>	
				<a href="#REQUEST.URLPath#&action=month&date=#REQUEST.Attributes.viewas#">Cancel</a>
			</p>
			...
			<cfif qEvent.RecordCount>
				...
				<p>	
					<a href="#REQUEST.URLPath#&action=delete&id=#qEvent.id#&viewas=#REQUEST.Attributes.viewas#">Delete</a>
				</p>
		...
		<cfelse>
			...
			<p>
				<a href="#REQUEST.URLPath#&action=month<cfif qEvent.RecordCount>&date=#Fix( qEvent.date_started )#</cfif>">Cancel</a>
			</p>
			...
			<cfif qEvent.RecordCount>
				...
				<p>	
					<a href="#REQUEST.URLPath#&action=delete&id=#qEvent.id#">Delete</a>
				</p>
