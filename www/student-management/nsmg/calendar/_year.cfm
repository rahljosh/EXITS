...
<cfoutput>
	...
	<p id="calendarcontrols">
		&laquo;
		<a href="#REQUEST.URLPath#&action=year&date=#Fix( dtPrevYear )#">#DateFormat( dtPrevYear, "yyyy" )#</a> &nbsp;|&nbsp;
		<a href="#REQUEST.URLPath#&action=year&date=#Fix( dtNextYear )#">#DateFormat( dtNextYear, "yyyy" )#</a>
		&raquo;
	</p>
