...
<cfsilent>
	...
	<!--- Set Up URL - Added by Marcus Melo 03/12/2010 --->
	...
	<!--- Allowed ID List | Global Administrators, Peter, Gary, Bill, and Lisa --->
	<cfset REQUEST.AllowedIDs = "12431,8731,18061,21516,23346"> 
