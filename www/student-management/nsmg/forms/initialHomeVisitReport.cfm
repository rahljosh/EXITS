<cfinclude template="../hostApplication/approveDenyInclude.cfm">
...
<div id="stylized" class="myform">
   ...
   <Cfform method="post" action="initialHomeVisitReport.cfm?itemID=8&usertype=#client.usertype#&reportid=#form.pr_id#">
	...
	<cfif allow_approve and get_report.pr_rejected_date NEQ ''>
        ...
        <Cfif allow_save>
            <cfinput type="text" name="dateOfVisit" value="#DateFormat(FORM.dateofvisit, 'mm/dd/yyyy')#" class="datePicker" mask="99/99/9999" placeholder='MM/DD/YYYY'>
        <cfelse>
...
<cfinclude template="../hostApplication/updateInfoInclude.cfm">
</cfform>
<cfinclude template="../hostApplication/approveDenyButtonsInclude.cfm">
