	...
	<tr>
		<td width="25%" valign="top">
			<table cellpadding="0" cellspacing=0 border="0" width="100%">
				...
				<tr height="34"><td><font color="red">*</font><b>AR Training Sign-off Form</b></td></tr>
					...
					<table cellpadding="4" cellspacing=0 border="0" align="left">	
						...
						<tr  height="34"  bgcolor="##EEEEEE" <Cfif get_rep.accountCreationVerified eq 0 and ar_cbc_auth_form is ''> bgcolor="##FFCBC4" </cfif>><td ><cfif ar_cbc_auth_form EQ ''>
						 ...
						 <cfif ar_cbcAuthReview is ''>
							...
							Date: <cfif ar_cbcAuthReview is ''><a href="index.cfm?curdoc=cbc/users_cbc&userid=#url.userid#">Required</a><cfelse>#DateFormat(ar_cbcAuthReview, 'mm/dd/yyyy')#</cfif>		
                            </cfif>			
						</td>
					</tr>
