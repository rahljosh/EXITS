...
<p>NOW, THEREFORE, in consideration of the foregoing and the mutual agreements and
 ...
 <Br /><br />
  ...
  <Table width=80%>
    ...
    <Tr>
    	<Td colspan=3 align="right"><strong>Total Payment  : $700</strong></Td>
    </Tr>
</Table>
  ...
  <Table width=80%>
    ...
    <Tr>
    	<Td colspan=3 align="right"><strong>Total Payment  : $810</strong></Td>
    </Tr>
</Table>
...
deduction to be applied to the placement fee.</li>
</ul>
...
Area Representative as defined in the State Department Regulations and
CSIET guidelines. This includes conducting the host family and the student
