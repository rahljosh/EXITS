...
WHERE smg_students.regionassigned = 8 
AND smg_students.active = 1
AND smg_prquestion_details.month_of_report = 4
AND user_access_rights.regionid = 8
...
<table width=90% cellpadding=0 cellspacing=0 border=0 height=24 align="center">
	...
	<table cellpadding=2 cellspacing=4 width=90% bgcolor="##ffffe6" align="center">
				<tr><td bgcolor="##e2efc7" colspan=2>
				<Table align="center">
					<tr>
						<th colspan=5 align=center>Summary & Report Choices</th>
					</tr>
					<Tr>
						<td>Month:</td>
						<td>
...
<cfloop query=students_in_Region>
		...
		WHERE arearepid = #arearepid#
				...
				<tr>
					...
					<cfset sw = #total_students_per_rep.total_number# - #current_students_per_rep.total_showing#>
					<cfif sw neq 0>
