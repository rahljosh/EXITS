...
<tr><td><span class="application_section_header">Second Visit Representative</span></td></tr>
</table><br>
...
<cfif #get_student_info.hostid# is 0 or #get_student_info.schoolid# is 0>
	...
	<tr><td align="center"><h3>You cannot add a Second Vist Rep without this information. Please make sure that the HF and school are entered.</h3></td></tr>
	</table>
	<br>
	<table width="580" align="center">
	<tr><td align="center">
...
<cfelse>  <!--- unplaced --->
	...
	Select distinct smg_users.userid, firstname,lastname
    FROM smg_users 
	...
	WHERE smg_users.active = 1 
	      ...
	      AND (uar.usertype = 15 or uar.usertype =  7 or uar.usertype =  6 or uar.usertype =  5)
	ORDER BY lastname
</cfquery>
	
	<cfif #get_student_info.secondVisitRepID# is 0> <!--- PLACE REP --->
		<table width="580" align="center">
		<tr><td>	
		...
		<cfform action="../querys/update_place_secondVisitRep.cfm?studentid=#client.studentid#" method="post">
			<table width="580" align="center">
			<tr><td>				
			<cfselect name="secondVisistRepId">
	...
	<cfelse> <!--- STUDENT HAS ALREADY A SECOND VISIT REP --->	
			<cfquery name="rep_info" datasource="MySQL">
			SELECT  userid, firstname, lastname, address, address2, city, state, zip, phone, email
			FROM smg_users
			WHERE userid = #get_student_info.secondvisitRepID#
		</cfquery>
		<cfoutput>
			<cfif rep_info.recordcount is '0'>
				<table width="580" align="center"><tr><td><font color="CC3300">Second Visit  Rep. (#get_student_info.placerepid#) was not found in the system.</font></td></tr></table>
			<cfelse>
				<table width="580" align="center">
				<tr><td>			
				Representative who made the second visit:<br>
		...
		<cfform action="place_change_secondVisitRep.cfm?studentid=#client.studentid#"  method="post">
			<table width="580" align="center">
			<Tr>
...
<!--- PLACING HISTORY --->
<cfquery name="placing_history" datasource="MySQL">
	SELECT hostid, reason, studentid, dateofchange, arearepid, placerepid,secondVisitRepID,
	...
	INNER JOIN smg_users user ON user.userid = secondVisitRepID
...
<Cfif placing_history.recordcount is not 0> 
	<Table width=580 cellpadding=3 cellspacing=0 align="center" class="history">
		<tr><td colspan="3" align="center"><font color="a8a8a8"> H I S T O R Y </font><br><br></td></tr>
	<cfoutput query="placing_history">
		<tr bgcolor="D5DCE5"><td colspan="3">Date : &nbsp; #DateFormat(dateofchange, 'mm/dd/yyyy')#</td></tr>
		<tr><td width="175"><u>Second Visit Rep.</u></td>
