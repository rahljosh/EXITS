...
<cfsilent>
   ...
   // Get Confidential Visit Form
		previousReport = APPLICATION.CFC.PROGRESSREPORT.getVisitInformation(hostID=VAL(qGetHosts.hostid),reportType=5,seasonID=application.cfc.LOOKUPTABLES.getCurrentPaperworkSeason());
    </cfscript>
