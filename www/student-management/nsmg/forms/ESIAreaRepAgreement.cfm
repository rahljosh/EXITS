...
(the "Effective Date") by and between SLB Consulting Corporation doing business as #companyInfo.companyname# (#companyInfo.companyshort_nocolor#) a 
...
<p> WHEREAS, to further its objectives, #companyInfo.companyshort_nocolor# desires to engage the services of the Area
  Representative to locate and interact with the host families, schools and exchange students and</p>
...
<p>NOW, THEREFORE, in consideration of the foregoing and the mutual agreements and
  covenants contained herein, the parties hereto agree as follows:
  	...
  	<ol>
    <li><u>Recitals</u>
  <p>The recitals hereinabove set forth are hereby incorporated into and made a part of this
  Agreement.</p></li>
  <li> <u>Term</u>
 ...
 exchange industry. All Services shall be performed to the
  ...
  Representative does not violate the confidentiality provisions thereof.</p>
  ...
  expense all tools required to perform the Services.</p>
  <p>(f) References
 ...
 <p>(g) Criminal Background Check
  ...
  <p>(a) This Agreement and the Exhibits and Schedule attached hereto shall
  ...
  verbal or written;</p>
  <p>(b) No change or modifications of any of the terms or conditions herein shall
  be valid or binding on either party unless made in writing and signed by
  an authorized representative of each party;</p>
  <p>(c) Any waiver by either party of a provision of this Agreement, or any right
  ...
  <p>(d) The captions set forth herein are for convenience only and shall not define
  or limit any of the terms hereof;</p>
  <p>(e) This Agreement shall be binding upon, and shall inure to the benefit of the
  parties hereto, and to their respective heirs, next of kin, executors,
  administrators, successors, and, where applicable, assigns;</p>

 <p>(f) Both parties shall have the right to delegate to any agent, subcontractor or
...
State and CSIET mandated documentation.</p>
<p>
There is no limit to the number of $500 Early Placement Bonuses an AR can
earn. For example, placing 50 students by June 1st will earn ten (10) Early
Placement Bonuses, equal to $10,000.</p>
<p>Placements qualifying for this bonus will not be applied to the On-Time
Paperwork Bonus. Placements that qualified for the Fast Start Bonus cannot
be applied to the Early Placement Bonus. Multiple bonuses can be earned for
placement of additional groups of five students.</p>
<Table align="center" width=80%>
	<tr>
...
Department of State and CSIET mandated documentation.</p>
<p>
There is no limit to the number of $500 Placement Paperwork Bonuses an AR
can earn. For example, placing fifty (50) students will earn ten (10) Placement
Paperwork Bonuses, equal to $5,000</p>
<p>Placements that qualified for the Fast Start Bonus or Early Placement Bonus
cannot be applied to the Placement Paperwork Bonus.</p>
...
dates will not be eligible for payment.</p>
</li>
---->
...
will move with the student to the new AR.</li><li>In the case of a re-location, the requirements above will apply just as if it were a new
...
and school acceptance for an #companyInfo.companyshort_nocolor#-sponsored exchange student.
</li>
<li> "Supervise" or "Supervision" means contact with the student(s) placed by the
Area Representative as defined by industry guidelines. This includes conducting the host family and the student
orientation, and in-person visitation at least every other month.</li>
<li> "Semester" refers to one-half a school year. The first semester starts
approximately September 1st and ends mid-January. The second semester
begins mid-January and ends mid-June.</li>
<li> "School year" means the academic year commencing
approximately September 1st of any calendar year and ending
on or about mid-June of the following year.</li>
<li> "Calendar year" refers to a 12-month academic program
