...
<cfsavecontent variable="letter">
    ...
    <table width=650 align="center" border=0 bgcolor="FFFFFF">
    	<tr>
        	<td><b>Student: #get_letter_info.firstname# #get_letter_info.familylastname# from #get_letter_info.countryname#</b></td>
      	</tr>
    </table>
    <br>
...
<cfif LEN(URL.save)>
	<cfoutput>
    	<cfset fileName="SchoolWelcome#CLIENT.studentID#_#DateFormat(NOW(),'mm-dd-yyyy')#-#TimeFormat(NOW(),'hh-mm')#">
        ...
        <cfscript>
            ...
            APPLICATION.CFC.UDF.insertInternalFile(filePath=fullPath,fieldID=4,studentID=CLIENT.studentID);
        </cfscript>
    </cfoutput>
