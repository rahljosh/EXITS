...
<Cfquery name="get_students" datasource="MySQL">
	SELECT 
		s.studentid, s.firstname, s.familylastname, s.programid, s.ds2019_no, s.direct_place_nature,
		p.programname,
...
<table width="650" align="center" border=0 bgcolor="FFFFFF">
	<tr>
		...
		<td valign="middle" align="left"><font size="+3"><b>Direct Placement Report</b></font></td>		
	</tr>
	<tr><td colspan="3"><hr width=100% align="center"></td></tr>
</table>

<cfif get_students.recordcount mod 5 is 0>
	<cfset totalpages = get_students.recordcount \ 5>
<cfelse>	
	<cfset totalpages = get_students.recordcount \ 5>
...
<tr><td>
		...
		<tr>			
			<td align="left">&nbsp;</td>			
			<td align="right"><b>Nature of Direct Placement :</b></b></td><td>#direct_place_nature#</td>
		</tr>			
		</table>
</td></tr>
</table>

<cfif (recordcount is 1) or (currentrow mod 5 is 0)> 
	<cfset pagenumber = #pagenumber#+1>
	<table width='650' align="center">
		<tr>
		<td align="left" width="200">#DateFormat(now(), 'mm/dd/yyyy')#</td>
		<td align="center">Direct Placement Report</td>
...
<cfif (recordcount mod 5 is not 0) and (recordcount is currentrow)>
	<cfset pagenumber = #pagenumber#+1>
	<table width='650' align="center">
		<tr>
		<td align="left" width="200">#DateFormat(now(), 'mm/dd/yyyy')#</td>
