...
<title>EXITS - Complinace  Missing Placement Documents</title>
	...
	<table width="100%" cellpadding="4" cellspacing="0" align="center" style="border:1px solid ##000;">
		<tr>
			<td align="center">
                ...
                Previous Complianace Placement Documents Report
                <cfelse>
                 Complianace Placement Documents Report
                 </cfif></span> <br />
                    ...
                    <table width="100%" cellpadding="4" cellspacing="0" align="center" style="border:1px solid ##999;">
                        ...
                        <cfloop query="qGetStudentsByRep">		
                            ...
                            <cfscript>
                                ...
                                // Student Orientation
                                if ( NOT isDate(qGetStudentsByRep.compliance_stu_arrival_orientation) ) {
                                    missingDocumentsList = ListAppend(missingDocumentsList, "Student Orientation &nbsp; &nbsp;", " &nbsp; &nbsp;");
                                }
								
                                // HF Orientation
                                if ( NOT isDate(qGetStudentsByRep.compliance_host_arrival_orientation) ) {
                                    missingDocumentsList = ListAppend(missingDocumentsList, "HF Orientation &nbsp; &nbsp;", " &nbsp; &nbsp;");
                                }
								
/*                                // Class Schedule
                                if ( NOT isDate(qGetStudentsByRep.compliance_class_schedule) ) {
                                    missingDocumentsList = ListAppend(missingDocumentsList, "Class Schedule &nbsp; &nbsp;", " &nbsp; &nbsp;");
                                } */
                            </cfscript>
                            
                            <cfif LEN(missingDocumentsList) or LEN(missingDocumentsList)>
