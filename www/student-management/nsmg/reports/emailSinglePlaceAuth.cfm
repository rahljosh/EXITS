...
<title>Single Placement Authorization</title>
</head>
...
<cfform name="email" action="emailSinglePlaceAuth.cfm?studentid=#url.studentid#" method="post" onsubmit="return confirm ('Are you sure?')">
<cfinput type="hidden" name="studentid" value="#form.studentid#">
<cfinput type="hidden" name="send">
<table width="650" align="center" class="nav_bar" bordercolor="C0C0C0" cellpadding="3" cellspacing="1">
	<tr><td align="center"><span class="application_section_header">EMAIL SINLGE PERSON PLACEMENT AUTHORIZATION</span></td></tr>
	<tr><td align="center">Authorization Letter for #get_student_info.firstname# #get_student_info.familylastname# (###get_student_info.studentid#)</td></tr>
	<tr>
...
<!--- SEND E-MAIL --->
<cfelse>
<cfdocument filename="#AppPath.temp#sppa_#client.studentid#.pdf" format="PDF" backgroundvisible="yes" overwrite="yes" fontembed="yes"  localurl="no">
			<style type="text/css">
            <!--
            ...
            <cfset form.pdf = 1>
            <cfinclude template="../forms/singlePersonPlacementAuth.cfm">
        </cfdocument>
...
<cfelse>
  ...
  <cfinvoke component="nsmg.cfc.email" method="send_mail">
            ...
            <cfinvokeargument name="email_subject" value="Single Placement Authorization for #get_student_info.firstname# #get_student_info.familylastname# ( #get_student_info.studentid# )">
            <cfinvokeargument name="email_message" value="#email_message#">
            <cfinvokeargument name="email_file" value="#AppPath.temp#sppa_#client.studentid#.pdf">
        </cfinvoke>	

<table width="650" align="center" class="nav_bar" bordercolor="C0C0C0" cellpadding="3" cellspacing="1">
	<tr><td><span class="application_section_header">SINGLE PERSON PLACEMENT AUTHORIZATION LETTER</span></td></tr>
