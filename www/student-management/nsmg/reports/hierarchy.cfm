...
<cfquery name="comp_info" datasource="MySQL">
	select companyshort
	from smg_companies 
...
<cfquery name="hierarchy" datasource="MySQL">
...
<Cfquery name="rep_count" datasource="MySQL">
	select userid
...
<div align="center"><h3>#comp_info.companyshort# Hierarchy</h3></div>
<div align="center"><h4>Region: #hierarchy.regionname# :: No. of Reps: #rep_count.recordcount#</h4></b></div>
<hr width=90% color="000000">
...
<tr>
	<td valign="top">
		...
		<tr>
		<td colspan=2 valign="top" align="center"><cfloop query="regional_director">Regional Director: #firstname# #lastname#</td></tr>
	<tr><td valign="top" align="center"><table cellpadding=0 cellspacing="0"><tr><Td>#address#<br><cfif #address2# is ''><cfelse>#address2#<br></cfif>#city# #state#, #zip#</Td></tr></table></td>
	<td valign="top" align="center"><table cellpadding=0 cellspacing="0"><tr><Td>P: #phone# <br>F: #fax#<br>#email#</Td></tr></table></td></tr></cfloop>
	</table>
</td><td>

<table width="90%" align="center">
	<tr>
		<td colspan=2 valign="top" align="center"><cfloop query="facilitator">Facilitator: #facilitator.firstname# #facilitator.lastname#</td></tr>
	<tr><td valign="top" align="center"><table cellpadding=0 cellspacing="0"><tr><Td><!--- #address#<br><cfif #address2# is ''><cfelse>#address2#<br></cfif>#city# #state#, #zip# ---></Td></tr></table></td>
	<td valign="top" align="center"><table cellpadding=0 cellspacing="0"><tr><Td><!--- P: #phone# <br>F: #fax#<br>#email# ---></Td></tr></table></td></tr></cfloop>
	</table>
</tr>
...
<cfquery name="users_with_view" datasource="MySQL">
