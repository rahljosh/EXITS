...
<table border=0 cellpadding=8 cellspacing=2 width=100% class="section">
    <tr>
    	<td colspan="2">
        	All reports that can be run are listed below.  These reports are also linked to various other 
        	locations throughout the site.  If no reports are listed, there are no stand alone reports that you have access to.
        </td>
    </tr>
