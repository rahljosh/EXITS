...
<tr><td align="center">
	...
	<cfoutput>Total of <cfif form.active EQ 0>inactive<cfelseif form.active EQ 1>active<cfelseif form.active EQ 2>canceled</cfif> Students <b>placed</b> in program: #get_total_students.recordcount#</cfoutput>
	</td></tr>
</table>
...
<cfloop query="get_region">
	...
	<Cfquery name="list_repid" datasource="MySQL">
		...
		where smg_students.regionassigned = '#get_region.regionid#'
			<cfif form.active EQ 0> <!--- inactive --->
