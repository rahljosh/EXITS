...
<cfsilent>
    ...
    <cfscript>	
		...
		// Get List of Status
		qGetStatus = APPLICATION.CFC.LOOKUPTABLES.getApplicationLookUp(fieldKey='hostLeadStatus',sortOrder='sortOrder');
	</cfscript>	
	...
	var populateList = function(hostLeadData) { 
		...
		***/
		...
		var tableHeader = '<tr class="defaultTableStyle">';		
			...
			tableHeader += '<td id="dateUpdated" class="listTitle"><a href="javascript:void(0);" title="Sort By Last Login">Last Updated</a></td>'; 
