...
<cfoutput>
        ...
        <tr>
        	 ...
        	 <tr <cfif qBasicCaseDetails.currentrow mod 2>bgcolor="##efefef"</cfif>>
              <cfif url.action eq 'viewCaseList'>
             	<td rowspan="2"><a href="index.cfm?curdoc=caseMgmt/index&amp;action=viewCase&amp;caseID=#qBasicCaseDetails.caseID#" class="basicOrangeButton">View</a></td>
             <cfelse>
             	 <td rowspan="2"><a href="index.cfm?curdoc=caseMgmt/index&amp;action=basics&amp;caseID=#qBasicCaseDetails.caseID#" class="basicOrangeButton">Edit</a></td>  
             </cfif>  
