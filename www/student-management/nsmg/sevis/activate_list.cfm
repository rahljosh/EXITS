...
<cfelse>
	...
	<cfquery name="get_students" datasource="MySql"> 
		...
		WHERE s.sevis_activated = <cfqueryparam value="#url.batchid#" cfsqltype="cf_sql_integer"> 
		ORDER BY u.businessname, s.familylastname, s.firstname
	</cfquery>

	<table align="center" width="95%" frame="box">
	<tr><th colspan="3"><cfoutput>#CLIENT.companyShort# &nbsp; ACTIVATE STUDENTS &nbsp; - &nbsp; Batch ID &nbsp; 0#url.batchid# &nbsp; - &nbsp; List of Students</cfoutput></th></tr>
