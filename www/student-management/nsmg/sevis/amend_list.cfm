...
<cfif not isDefined('url.batchid')>
	...
	<tr><th colspan="3">It was not possible to print out your report. One error has ocurred. Please go back and re-submit it.</th></tr>
	</table>
<cfelse>
	<!-- get company info -->
	...
	<cfquery name="get_students" datasource="MySql"> 
		...
		WHERE s.sevis_amend_dates = <cfqueryparam value="#url.batchid#" cfsqltype="cf_sql_integer"> 
		ORDER BY u.businessname, s.familylastname, s.firstname
	</cfquery>

	<table align="center" width="95%" frame="box">
	<tr><th colspan="3"><cfoutput>#get_company.companyshort_nocolor# &nbsp; A M E N D &nbsp; D A T E S &nbsp; - &nbsp; Batch ID &nbsp; 0#url.batchid#</cfoutput></th></tr>
