...
<cfelse>
	...
	<tr><th colspan="3" bgcolor="#ededed">ADDRESS UPDATE &nbsp; - &nbsp; BATCH RESULTS</th></tr>
	<cfoutput>
	...
	<cfloop index="i" from = "1" to = #numItems#>
		...
		<cfif #mydoc.TransactionLog.BatchDetail.Process.RECORD[i].Result.XmlAttributes.Status# is 'true'>
			...
			<cfoutput>
			<td align="center" class="style2">#stuID#</td><td align="center" class="style2">#SevisID#</td><td class="style2">&nbsp; OK &nbsp; - &nbsp; Address Updated!</td>
			</cfoutput>
			<cfquery name="update_active_batch" datasource="MySql">
				UPDATE smg_students
				SET sevis_address_added = '#Right(batchid, 4)#'
