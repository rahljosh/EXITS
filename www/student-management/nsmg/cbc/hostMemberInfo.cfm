            ...
            <table width="98%" align="center" class="section" border="0" cellpadding="4" cellspacing="0">
                ...
                <cfloop query="qGetHostFamilyMembers">
                    ...
                    <tr bgcolor="###iif(qGetHostFamilyMembers.currentrow MOD 2 ,DE("FFFFFF") ,DE("ffffe6") )#">
                        ...
                        <td valign="top"><input type="text" name="birthDate#qGetHostFamilyMembers.currentRow#" id="birthDate#qGetHostFamilyMembers.currentRow#" class="smallField" value="#DateFormat(FORM['birthDate' & qGetHostFamilyMembers.currentrow],'mm-dd-yyyy')#" maxlength="10"><br>mm-dd-yyyy</td>
                        <td valign="top">
