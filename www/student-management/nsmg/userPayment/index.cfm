...
<cfif ListFind("1,2,3", CLIENT.userType)>
    ...
    <cfswitch expression="#action#">
        ...
        <cfcase value="initial,searchRepresentative,listStudentRepresentatives,selectPayment,searchStudent,incentiveTripPayment,maintenance,paymentHistory,processPayment,studentPaymentHistory,hostPaymentHistory,paymentReport,bonusReport,thankYouBonus,credits,payReps,potentialCredits,checkSummary" delimiters=",">
