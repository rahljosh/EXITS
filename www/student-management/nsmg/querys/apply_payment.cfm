...
<cfquery name="total_charge" datasource="MySQL">
select sum(charge) as total_charge
from smg_invoices
where number = #url.number#
</cfquery>

<cfquery name="previous_payment" datasource="MySQL">
...
<Cfquery name="update_charges" datasource="MySQL">
update smg_invoices
