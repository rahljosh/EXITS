...
<cfif not IsDefined('url.flightid')>
	...
	<tr bgcolor="D5DCE5"><td><a href="#CLIENT.exits_url#"><img src="../pics/logos/5.gif" border="0" align="left"></a></td>	
...
What: The flight leg from <strong>#get_Student.dep_aircode#</strong> to <strong>#get_Student.arrival_aircode#</strong> on <strong>#get_Student.dep_date#</strong> has been deleted.<br />
...
Submitted By: #qGetEmailInfo.businessname#.<br><br>
	...
	<cflocation url="../forms/flight_info.cfm" addtoken="no">
</cfif>