...
<title>Open your heart and soul....</title>
<style type="text/css">
<!--
body {
	margin: 0;
...
<div id="menu"><table width="275" border="0" cellspacing="5">
  <tr>
    <td><a href="save.cfm? filetype=pdf"><img src="images/save.png" height="20" alt="save icon" border="0" /></a></td>
    </tr>
</table>
</div>
<Cfoutput>
<div class="container">
  <div class="header"><a href="##"><img src="images/#client.companyid#_logoHeader.png" alt="Insert Logo Here" name="Insert_logo" width="612" height="96" id="Insert_logo" style="display:block;" /></a>
    <img src="images/topBar.jpg" width="615" height="25" />
<!-- end .header --></div>
  <div class="sidebar1">
    <table width="210" border="0" cellspacing="0" bgcolor="##0A3542">
      <tr>
        <td height="176"><img src="images/#client.companyid#_leftBar.png" width="212" height="174" /></td>
      </tr>
      <tr>
        <td bgcolor="##0A3542"><div class="editInfo"><span class="LG">#repInfo.firstname# #repInfo.lastname#</span><br />
        <font color="##FFFFFF">#repInfo.email#</font><br />
        #repInfo.phone#<br />
        </div>
  ...
  <div class="content">
    ...
    <!-- end .content --></div>
  <div class="footer">
    <img src="images/#client.companyid#_bottomBar.jpg" width="615" height="25" alt="ise footer" />
<!-- end .footer --></div>
<!-- end .container --></div>
</Cfoutput>
</body>
