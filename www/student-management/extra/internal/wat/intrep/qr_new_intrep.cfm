...
<cftransaction action="begin" isolation="serializable">
	<cfquery name="check_company_name" datasource="mysql">
	select businessname
	from smg_users
	where businessname = '#form.businessname#'
	</cfquery>
	...
	<!----Duplicate Business Name---->
		<cfif check_company_name.recordcount gt 0>
		<cfset form.error1 = '<b>Business Name</b> is already in use.  This usually indicates a duplicate record.'>
	...
	<cfquery name="new_intrep" datasource="MySql">
		INSERT INTO smg_users
			...
			billing_fax, firstname, middlename, lastname, dob, sex, email, email2, username, password, wat_contact, wat_email)
		VALUES
			...
			'#form.email#', '#form.email2#', '#form.username#', '#form.password#', '#form.wat_contact#', '#form.wat_email#')
	</cfquery>
