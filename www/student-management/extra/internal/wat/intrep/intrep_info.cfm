								...
								<td bordercolor="FFFFFF">
									<table width="100%" cellpadding=3 cellspacing=0 border=0>
										...
										<tr>
											...
											<td class="style1" width="70%"><cfif edit EQ 'yes'><cfinput type="text" name="wat_contact" value="#get_intrep.wat_contact#" size="40" maxlength="50"><cfelse> #get_intrep.wat_contact# </cfif></td>
										</tr>
						
										<tr>
											<td class="style1"><b>Email:</b></td>
											<td class="style1"><cfif edit EQ 'yes'><cfinput type="text" name="wat_email" size="40" value="#get_intrep.wat_email#" maxlength="50"> <cfelse> #get_intrep.wat_email# </cfif></td>											
										</tr>
									</table>									
								</td>
							</tr>
