		...
		<table width=95% cellpadding=0 cellspacing=0 border=0 align="center">
			<tr valign=middle height=24>
				...
				<td width="42%" align="right" valign="top" bgcolor="##E4E4E4" class="style1">
					#candidates.recordcount# <b><cfif url.status EQ 1>active<cfelseif url.status EQ 0>inactive<cfelseif url.status EQ 'canceled'>canceled</cfif></b> candidate<cfif candidates.recordcount GT 1>s</cfif> found&nbsp;<br>
					Filter: &nbsp; <cfif url.status NEQ 'All'><a href="?curdoc=candidate/candidates&status=all" class="style4"></cfif>All</a> 
