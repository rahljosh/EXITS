								...
								<td bordercolor="FFFFFF" valign="top">
									<table width="100%" cellpadding=3 cellspacing=0 border=0>
										...
										<tr>
											...
											<td><cfselect class="style1" name="extra_insurance_typeid" query="get_insutypes" value="insutypeid" display="type"></cfselect></td>
										</tr>																														
										<!--- <tr>
											<td class="style1"><b>Verification Received:</b></td>
											<td class="style1" align="left">
												<cfselect class="style1" name="verification_received" query="verification_dates" value="verification_received" display="verification_received" queryPosition="below">
