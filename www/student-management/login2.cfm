...
<!--- Param Form Variables --->
    ...
    <cfparam name="client.loginError" default="">
<Cfif not len(client.loginError)>
...
<Cfif len(client.loginError)>
	<body style="background-image:url(exitsapp_images/errorLogin.jpg);">   
<cfelse>
	<body>
</cfif>
<div id="mainContent">
<div id="loginBox">
  ...
  <Cfif len(client.loginError)>
  	<div class="exitLogoError">#client.loginError#</div>
  <cfelse>
