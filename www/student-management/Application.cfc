<cfcomponent
	...
	<cffunction
        ...
        <!--- Production - Email Error Message - Display HTML Error --->
 		<cfif NOT APPLICATION.isServerLocal AND (CLIENT.userID NEQ 20 OR CLIENT.userid NEQ 1)> <!--- Fred from INTO needs to see the errors, josh wants to see the errors --->
