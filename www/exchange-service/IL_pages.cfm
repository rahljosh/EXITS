<cfparam name="url.page" default="IL">
...
<!---LOGO AND SLIDESHOW SECTION--->
  ...
  <tr>
    <td height="99">Exchange Service International &#8211; Illinois Districts</td>
  </tr>
</table>
...
slideshowimages("images/IL/SLIDESHOW/pic1.jpg","images/IL/SLIDESHOW/pic2.jpg","images/IL/SLIDESHOW/pic3.jpg","images/IL/SLIDESHOW/pic4.jpg")
slideshowlinks("IL_pages.cfm","IL_pages.cfm","IL_pages.cfm","IL_pages.cfm")
...
<!---MAIN CONTENT--->
  <div class="content">
  <cfinclude template= "IL/#url.page#.cfm">
    <!-- end .content --></div>
