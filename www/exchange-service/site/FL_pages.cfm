<cfparam name="url.page" default="FL">
...
<!---LOGO AND SLIDESHOW SECTION--->
  ...
  <tr>
    <td height="99">Exchange Service International &#8211; Florida Districts</td>
  </tr>
</table>
<!-- end display left --></div>
    <div class="INright">
    <a href="javascript:gotoshow()"><img src="images/Florida/SLIDESHOW/pic1.jpg" name="slide" width="665" height="262" border="0"/></a>
    
  
<script>
<!--
//configure the paths of the images, plus corresponding target links
slideshowimages("images/Florida/SLIDESHOW/pic1.jpg","images/Florida/SLIDESHOW/pic2.jpg","images/Florida/SLIDESHOW/pic3.jpg","images/Florida/SLIDESHOW/pic4.jpg","images/Florida/SLIDESHOW/pic5.jpg")
slideshowlinks("FL_pages.cfm","FL_pages.cfm","FL_pages.cfm","FL_pages.cfm","FL_pages.cfm")
...
<!---MAIN CONTENT--->
  <div class="content">
  <cfinclude template= "FL/#url.page#.cfm">
    <!-- end .content --></div>
