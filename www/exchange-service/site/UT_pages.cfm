<cfparam name="url.page" default="UT">
...
<!---LOGO AND SLIDESHOW SECTION--->
  ...
  <tr>
    <td height="99">Exchange Service International &#8211; Utah Districts</td>
  </tr>
</table>
<!-- end display left --></div>
    <div class="INright">
    <a href="javascript:gotoshow()"><img src="images/UT/SLIDESHOW/pic1.jpg" name="slide" width="665" height="262" border="0"/></a>
    
  
<script>
<!--
//configure the paths of the images, plus corresponding target links
slideshowimages("images/UT/SLIDESHOW/pic1.jpg","images/UT/SLIDESHOW/pic2.jpg","images/UT/SLIDESHOW/pic3.jpg","images/UT/SLIDESHOW/pic4.jpg","images/UT/SLIDESHOW/pic5.jpg")
slideshowlinks("UT_pages.cfm","UT_pages.cfm","UT_pages.cfm","UT_pages.cfm","UT_pages.cfm")
...
<!---MAIN CONTENT--->
  <div class="content">
  <cfinclude template= "UT/#url.page#.cfm">
    <!-- end .content --></div>
