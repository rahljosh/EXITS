<cfparam name="url.page" default="NV">
...
<!---LOGO AND SLIDESHOW SECTION--->
  ...
  <tr>
    <td height="99">Exchange Service International &#8211; Nevada Districts</td>
  </tr>
</table>
<!-- end display left --></div>
    <div class="INright">
    <a href="javascript:gotoshow()"><img src="images/NV/SLIDESHOW/pic1.jpg" name="slide" width="665" height="262" border="0"/></a>
    
  
<script>
<!--
//configure the paths of the images, plus corresponding target links
slideshowimages("images/NV/SLIDESHOW/pic1.jpg","images/NV/SLIDESHOW/pic2.jpg","images/NV/SLIDESHOW/pic3.jpg","images/NV/SLIDESHOW/pic4.jpg","images/NV/SLIDESHOW/pic5.jpg","images/NV/SLIDESHOW/pic6.jpg")
...
<!---MAIN CONTENT--->
  <div class="content">
  <cfinclude template= "NV/#url.page#.cfm">
    <!-- end .content --></div>
