<cfparam name="url.page" default="AR">
...
<!---LOGO AND SLIDESHOW SECTION--->
  ...
  <tr>
    <td height="99">Exchange Service International &#8211; Arkansas Districts </td>
  </tr>
</table>
<!-- end display left --></div>
    <div class="INright">
    <a href="javascript:gotoshow()"><img src="images/arkansas/SLIDESHOW/pic1.jpg" name="slide" width="665" height="262" border="0"/></a>
    
  
<script>
<!--
//configure the paths of the images, plus corresponding target links
slideshowimages("images/arkansas/SLIDESHOW/pic1.jpg","images/arkansas/SLIDESHOW/pic2.jpg","images/arkansas/SLIDESHOW/pic3.jpg")
slideshowlinks("AR_pages.cfm","AR_pages.cfm","AR_pages.cfm")
...
<!---MAIN CONTENT--->
  <div class="content">
  <cfinclude template= "AR/#url.page#.cfm">
    <!-- end .content --></div>
