<cfparam name="url.page" default="GA">
...
<!---LOGO AND SLIDESHOW SECTION--->
  ...
  <tr>
    <td height="99">Exchange Service International &#8211; Georgia Districts</td>
  </tr>
</table>
...
slideshowimages("images/GA/SLIDESHOW/pic1.jpg","images/GA/SLIDESHOW/pic2.jpg")
slideshowlinks("GA_pages.cfm","GA_pages.cfm")
...
<!---MAIN CONTENT--->
  <div class="content">
  <cfinclude template= "GA/#url.page#.cfm">
    <!-- end .content --></div>
