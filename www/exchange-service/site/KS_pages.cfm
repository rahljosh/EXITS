<cfparam name="url.page" default="KS">
...
<!---LOGO AND SLIDESHOW SECTION--->
  ...
  <tr>
    <td height="99">Exchange Service International &#8211; Kansas Districts</td>
  </tr>
</table>
<!-- end display left --></div>
    <div class="INright">
    <a href="javascript:gotoshow()"><img src="images/KS/SLIDESHOW/pic1.jpg" name="slide" width="665" height="262" border="0"/></a>
    
  
<script>
<!--
//configure the paths of the images, plus corresponding target links
slideshowimages("images/KS/SLIDESHOW/pic1.jpg","images/KS/SLIDESHOW/pic2.jpg","images/KS/SLIDESHOW/pic3.jpg","images/KS/SLIDESHOW/pic4.jpg","images/KS/SLIDESHOW/pic5.jpg")
slideshowlinks("KS_pages.cfm","KS_pages.cfm","KS_pages.cfm","KS_pages.cfm","KS_pages.cfm")
...
<!---MAIN CONTENT--->
  <div class="content">
  <cfinclude template= "KS/#url.page#.cfm">
    <!-- end .content --></div>
