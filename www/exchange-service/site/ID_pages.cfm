<cfparam name="url.page" default="ID">
...
<!---LOGO AND SLIDESHOW SECTION--->
  ...
  <tr>
    <td height="99">Exchange Service International &#8211; Idaho Districts</td>
  </tr>
</table>
<!-- end display left --></div>
    <div class="INright">
    <a href="javascript:gotoshow()"><img src="images/ID/SLIDESHOW/pic1.jpg" name="slide" width="665" height="262" border="0"/></a>
    
  
<script>
<!--
//configure the paths of the images, plus corresponding target links
slideshowimages("images/ID/SLIDESHOW/pic1.jpg","images/ID/SLIDESHOW/pic2.jpg","images/ID/SLIDESHOW/pic3.jpg")
slideshowlinks("ID_pages.cfm","ID_pages.cfm","ID_pages.cfm")
...
<!---MAIN CONTENT--->
  <div class="content">
  <cfinclude template= "ID/#url.page#.cfm">
    <!-- end .content --></div>
