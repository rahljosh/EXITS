<cfparam name="url.page" default="CA">
...
<!---LOGO AND SLIDESHOW SECTION--->
  ...
  <tr>
    <td height="99">Exchange Service International &#8211; California Districts</td>
  </tr>
</table>
<!-- end display left --></div>
    <div class="INright">
    <a href="javascript:gotoshow()"><img src="images/California/SLIDESHOW/pic1.jpg" name="slide" width="665" height="262" border="0"/></a>
    
  
<script>
<!--
//configure the paths of the images, plus corresponding target links
slideshowimages("images/California/SLIDESHOW/pic1.jpg","images/California/SLIDESHOW/pic2.jpg","images/California/SLIDESHOW/pic3.jpg","images/California/SLIDESHOW/pic4.jpg","images/California/SLIDESHOW/pic5.jpg")
slideshowlinks("CA_pages.cfm","CA_pages.cfm","CA_pages.cfm","CA_pages.cfm","CA_pages.cfm")
...
<!---MAIN CONTENT--->
  <div class="content">
  <cfinclude template= "CA/#url.page#.cfm">
    <!-- end .content --></div>
