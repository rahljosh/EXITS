<cfparam name="url.page" default="CO">
...
<!---LOGO AND SLIDESHOW SECTION--->
  ...
  <tr>
    <td height="99">Exchange Service International &#8211; Colorado Districts</td>
  </tr>
</table>
<!-- end display left --></div>
    <div class="INright">
    <a href="javascript:gotoshow()"><img src="images/CO/SLIDESHOW/Pic1.jpg" name="slide" width="665" height="262" border="0"/></a>
    
  
<script>
<!--
//configure the paths of the images, plus corresponding target links
slideshowimages("images/CO/SLIDESHOW/Pic1.jpg","images/CO/SLIDESHOW/Pic2.jpg","images/CO/SLIDESHOW/pic3.jpg","images/CO/SLIDESHOW/pic4.jpg","images/CO/SLIDESHOW/pic5.jpg")
slideshowlinks("CO_pages.cfm","CO_pages.cfm","CO_pages.cfm","CO_pages.cfm","CO_pages.cfm")
...
<!---MAIN CONTENT--->
  <div class="content">
  <cfinclude template= "CO/#url.page#.cfm">
    <!-- end .content --></div>
