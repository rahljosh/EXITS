...
<Cfif isDefined('form.process')>
    ...
    From the #url.type# form, on the Exchange Service International web site. requst sent #dateformat(Now(), 'mm/dd/yyyy')#
    #desc#:
...
from smg_states
     ...
     <cfoutput>
         ...
         <table width="60%" border="0" cellspacing="0" cellpadding="5" class="formBox">
  ...
  <tr >
    ...
    <td width="62%"><cfinput type="text" name="fname" message="Please enter your last name." required="yes" id="Name" size=22 typeahead="no" showautosuggestloadingicon="true" /></td>
  </tr>
  <tr  bgcolor="##EFEFEF">
  ...
  <tr>
    ...
    <td><cfinput type="text" name="phone" message="Please enter a valid phone number"  validateat="onSubmit"  required="yes" id="Name2" size=22 typeahead="no" showautosuggestloadingicon="true" /></td>
  </tr>
    <tr  bgcolor="##EFEFEF">
