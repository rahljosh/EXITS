<cfparam name="url.page" default="NY">
...
<!---LOGO AND SLIDESHOW SECTION--->
  ...
  <tr>
    <td height="99">Exchange Service International &#8211; New York Districts</td>
  </tr>
</table>
<!-- end display left --></div>
    <div class="INright">
    <a href="javascript:gotoshow()"><img src="images/NY/SLIDESHOW/pic1.jpg" name="slide" width="665" height="262" border="0"/></a>
    
  
<script>
<!--
//configure the paths of the images, plus corresponding target links
slideshowimages("images/NY/SLIDESHOW/pic1.jpg","images/NY/SLIDESHOW/pic2.jpg","images/NY/SLIDESHOW/pic3.jpg","images/NY/SLIDESHOW/pic4.jpg","images/NY/SLIDESHOW/pic5.jpg","images/NY/SLIDESHOW/pic6.jpg")
slideshowlinks("NV_pages.cfm","NV_pages.cfm","NV_pages.cfm","NV_pages.cfm","NV_pages.cfm","NV_pages.cfm")
...
<!---MAIN CONTENT--->
  <div class="content">
  <cfinclude template= "NY/#url.page#.cfm">
    <!-- end .content --></div>
