<cfparam name="url.page" default="MI">
...
<!---LOGO AND SLIDESHOW SECTION--->
  ...
  <tr>
    <td height="99">Exchange Service International &#8211; Michigan Districts</td>
  </tr>
</table>
<!-- end display left --></div>
    <div class="INright">
    <a href="javascript:gotoshow()"><img src="images/MI/SLIDESHOW/pic1.jpg" name="slide" width="665" height="262" border="0"/></a>
    
  
<script>
<!--
//configure the paths of the images, plus corresponding target links
slideshowimages("images/MI/SLIDESHOW/pic1.jpg","images/MI/SLIDESHOW/pic2.jpg")
slideshowlinks("MI_pages.cfm","MI_pages.cfm")
...
<!---MAIN CONTENT--->
  <div class="content">
  <cfinclude template= "MI/#url.page#.cfm">
    <!-- end .content --></div>
