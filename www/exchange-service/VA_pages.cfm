<cfparam name="url.page" default="VA">
...
<!---LOGO AND SLIDESHOW SECTION--->
  ...
  <tr>
    <td height="99">Exchange Service International &#8211; Virginia Districts</td>
  </tr>
</table>
<!-- end display left --></div>
    <div class="INright">
    <a href="javascript:gotoshow()"><img src="images/GA/SLIDESHOW/pic1.jpg" name="slide" width="665" height="262" border="0"/></a>
    
  
<script>
<!--
//configure the paths of the images, plus corresponding target links
slideshowimages("images/VA/SLIDESHOW/pic1.jpg","images/VA/SLIDESHOW/pic2.jpg","images/VA/SLIDESHOW/pic3.jpg","images/VA/SLIDESHOW/pic4.jpg","images/VA/SLIDESHOW/pic5.jpg")
slideshowlinks("VA_pages.cfm","VA_pages.cfm","VA_pages.cfm","VA_pages.cfm","VA_pages.cfm")
...
<!---MAIN CONTENT--->
  <div class="content">
  <cfinclude template= "VA/#url.page#.cfm">
    <!-- end .content --></div>
