<cfparam name="url.page" default="IA">
...
<!---LOGO AND SLIDESHOW SECTION--->
  ...
  <tr>
    <td height="99">Exchange Service International &#8211; Iowa Districts</td>
  </tr>
</table>
<!-- end display left --></div>
    <div class="INright">
    <a href="javascript:gotoshow()"><img src="images/IA/SLIDESHOW/pic1.jpg" name="slide" width="665" height="262" border="0"/></a>
    
  
<script>
<!--
//configure the paths of the images, plus corresponding target links
slideshowimages("images/IA/SLIDESHOW/pic1.jpg","images/IA/SLIDESHOW/pic2.jpg")
slideshowlinks("IA_pages.cfm","IA_pages.cfm")
...
<!---MAIN CONTENT--->
  <div class="content">
  <cfinclude template= "IA/#url.page#.cfm">
    <!-- end .content --></div>
