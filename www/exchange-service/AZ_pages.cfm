<cfparam name="url.page" default="AZ">
...
<!---LOGO AND SLIDESHOW SECTION--->
  ...
  <tr>
    <td height="99">Exchange Service International &#8211; Arizona Districts </td>
  </tr>
</table>
<!-- end display left --></div>
    <div class="INright">
    <a href="javascript:gotoshow()"><img src="images/Arizona/SLIDESHOW/pic3.jpg" name="slide" width="665" height="262" border="0"/></a>
    
  
<script>
<!--
//configure the paths of the images, plus corresponding target links
slideshowimages("images/Arizona/SLIDESHOW/pic1.jpg","images/Arizona/SLIDESHOW/pic2.jpg","images/Arizona/SLIDESHOW/pic3.jpg","images/Arizona/SLIDESHOW/pic4.jpg","images/Arizona/SLIDESHOW/pic5.jpg")
slideshowlinks("AZ_pages.cfm","AZ_pages.cfm","AZ_pages.cfm","AZ_pages.cfm","AZ_pages.cfm")
...
<!---MAIN CONTENT--->
  <div class="content">
  <cfinclude template= "AZ/#url.page#.cfm">
    <!-- end .content --></div>
