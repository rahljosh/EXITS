<cfparam name="url.page" default="WA">
...
<!---LOGO AND SLIDESHOW SECTION--->
  ...
  <tr>
    <td height="99">Exchange Service International &#8211; Washington Districts</td>
  </tr>
</table>
<!-- end display left --></div>
    <div class="INright">
    <a href="javascript:gotoshow()"><img src="images/WA/SLIDESHOW/pic1.jpg" name="slide" width="665" height="262" border="0"/></a>
    
  
<script>
<!--
//configure the paths of the images, plus corresponding target links
slideshowimages("images/WA/SLIDESHOW/pic1.jpg","images/WA/SLIDESHOW/pic2.jpg","images/WA/SLIDESHOW/pic3.jpg","images/WA/SLIDESHOW/pic4.jpg","images/WA/SLIDESHOW/pic5.jpg")
slideshowlinks("WA_pages.cfm","WA_pages.cfm","WA_pages.cfm","WA_pages.cfm","WApages.cfm")
...
<!---MAIN CONTENT--->
  <div class="content">
  <cfinclude template= "WA/#url.page#.cfm">
    <!-- end .content --></div>
