...
<div id="mainText">
  <div class="headerPic"><img src="images/headers/hostfamilyform.jpg"/></div>
...
from smg_states
     ...
     <cfoutput>
        ...
        <input type="image" src="images/buttons/submit_19.png" />
        <a href="contact.cfm"><img src="images/buttons/BACK_21.png" width="86" height="25" alt="BACK" border="0"/></a><br />
        </cfform>
      </cfoutput>
