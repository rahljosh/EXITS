<cfparam name="url.page" default="ME">
...
<!-- end display left --></div>
    <div class="INright">
    <a href="javascript:gotoshow()"><img src="images/ME/SLIDESHOW/pic1.jpg" name="slide" width="665" height="262" border="0"/></a>
    
  
<script>
<!--
//configure the paths of the images, plus corresponding target links
slideshowimages("images/ME/SLIDESHOW/pic1.jpg","images/ME/SLIDESHOW/pic2.jpg","images/ME/SLIDESHOW/pic3.jpg")
slideshowlinks("ME_pages.cfm","ME_pages.cfm","ME_pages.cfm)
...
<!---MAIN CONTENT--->
  <div class="content">
  <cfinclude template= "ME/#url.page#.cfm">
    <!-- end .content --></div>
