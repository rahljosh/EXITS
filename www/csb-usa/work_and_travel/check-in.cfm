...
<table width="871" height="435" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01">
  ...
  <tr>
    <td width="145" class="text"><div align="right"><strong><font face="Tahoma, Arial">Participant ID Number:&nbsp; </font></strong></div></td>
    <td width="355" class="text">
      <input name="idnumber" type="Text" class="text" id="idnumber" size="50" maxlength="50">
      <strong><font face="Tahoma, Arial"><a href="javascript:MM_openBrWindow('images/id-card.jpg','idnumber','width=535,height=310')"><img src="images/question.gif" width="15" height="15" border="0"> What is this? </a></font></strong></td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="35" colspan="2" class="text"><span class="style4"><span class="style7">&nbsp;- Employer Information:</span><br>
      (you must provide the address where you currently work in the United States) </span></td>
  </tr>
  <tr>
    <td class="text"><div align="right"><strong><font face="Tahoma, Arial">Company Name</font><font face="Tahoma, Arial">:&nbsp;<span class="style5">*</span></font></strong></div></td>
    <td class="text"><input name="companyName" type="Text" class="text" id="companyName" size="50" maxlength="50"></td>
  </tr>
  <tr>
    <td class="text"><div align="right"><strong><font face="Tahoma, Arial">Street Address</font><font face="Tahoma, Arial">:&nbsp;<span class="style5">*</span></font></strong></div></td>
  ...
  <tr>
    ...
    <td class="text"><select name="companyState" size="1" class="text" id="companyState">
      <option value="">
  ...
  <tr>
    <td class="text"><div align="right"><strong><font face="Tahoma, Arial">Primary Contact/Supervisor:&nbsp;</font></strong></div></td>
...
(you must provide the address where you currently live in the United States) </span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="2" align="center" class="text">
      <input name="submit" type="Submit" class="text" value="Submit">    </td>
                  ...
                  <br>
                  <div align="justify"><span class="style3"><u>- CHANGE OF EMPLOYER/ADDRESS </u></span><u><strong>(while in the United States) </strong></u><br>
  To keep your information updated in the SEVIS system while you are in the United States, you must notify CSB of any changes related to your job or to your housing address.<br>
                  ...
                  <table width="80%" align="center">
                    <tr>
                      <td width="140" class="text"><div align="right"><strong><font face="Tahoma, Arial">Participant</font><font face="Tahoma, Arial"> ID Number:&nbsp;</font></strong></div></td>
                      <td width="434" class="text"><input name="idnumber2" type="Text" class="text" id="idnumber2" size="50" maxlength="50">                      </td>
                    </tr>
                    <tr>
                      <td class="text"><div align="right"><strong><font face="Tahoma, Arial">Last Name:&nbsp;<span class="style5">*</span> </font></strong></div></td>
                    ...
                    <tr>
                                      ...
                                      <tr>
                                        <td class="text"><div align="right"><strong><font face="Tahoma, Arial">Upload Job Offer:&nbsp; </font></strong></div></td>
                                        <td class="text"><input name="UploadFile" type="file" class="text" size="50" required="yes">
                                        <strong><font face="Tahoma, Arial"><a href="StudEmployment.pdf" target="_blank"><img src="images/pdf.gif" width="15" height="16" border="0"> PDF template </a></font></strong></td>
                                      </tr>
                                      <tr>
