...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <cfif url.request is 'send'>
    <cfmail from="info@csb-usa.com" to="anca@csb-usa.com, #form.email#" bcc="jeimi@exitgroup.org" subject="Apply with a CSB International Partner in your home country">
