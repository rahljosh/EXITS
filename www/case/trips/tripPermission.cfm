...
select * 
from student_tours
where id = <cfqueryparam cfsqltype="cf_sql_integer" value="#CLIENT.selectedTrip#"> 
limit 1
</Cfquery>
<cfoutput>
...
<Table width=700 cellpadding=2 cellspacing=0>
	<Tr>
    	<td><img src="http://ise.exitsapplication.com/nsmg/pics/logos/10_header_logo.png"/></td><td><h1 align="center"><font color="black">&nbsp;&nbsp;&nbsp;#company_info.companyshort_nocolor# Tours Permission Form</font></h1></td>
 </Tr>
 </Table>
 <Table width=700 cellpadding=2 cellspacing=0>
    <Tr>
