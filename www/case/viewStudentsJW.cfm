...
<div id="wrapper">
  ...
  <div id= "mainbody">
    <div id="sidebar">
      ...
      <li class="List"><a href="contactARep.cfm">Be Contacted by Area Rep</a></li></ul>
      ...
      <li class="List"><a href="http://www.esecutive.com/index.php">Student Insurance</a></li></ul>
       <div id="repInfo"></div>
           <ul><li class="List"><a href="contactARep.cfm">Be Contacted by Rep</a></li></ul>
      <div id="sidebarEnd"></div>
      <div id="sidebarSpacer"></div>
    </div>
    <!-- InstanceBeginEditable name="MainContent" -->
	<cfquery name="get_students" datasource="caseusa">
	SELECT     	studentid,  dob, firstname, interests_other, smg_countrylist.countryname, smg_religions.religionname
	FROM       	smg_students
...
<div id="content">
  <div id="aboutCase">
   ...
   <table width="600" border="0"> 
     ...
     <cfif not isDefined('client.student_view_login')>
    <input name="password" type="password" maxlength="15" /></cfelse> 
  <CFSET image_path="/var/www/html/student-management/nsmg/uploadedfiles/web-students/#get_students.studentid#.jpg">
      <tr>
        ...
        <td class="gradient">
          <p>Name: <span class="<cfif get_students.currentrow mod 2>incomingstudenttext<cfelse>incomingstudenttext2</cfif>">#get_students.firstname#</span><br />
            Home Country: <span class="incomingstudenttext">#get_students.countryname#</span></p>
          <p>About #get_students.firstname#: <span class="incomingstudenttext">#get_students.interests_other#</span></p>
        </td>
      </tr>
      </cfoutput>
