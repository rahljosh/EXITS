...
insert into student_tours (studentid, tripid, cc, cc_year, nationality, stunationality, person1, person2, person3, med, billingAddress, billingCity, billingState, billingZip, billingcountry, cc_month, date, ip, companyid)
			values (#form.ret_studentid#, #x#, '#form.cc#', #form.cc_year#, '#form.nationality#', '#form.stunationality#', '#form.person1#', '#form.person2#', '#form.person3#', '#form.med#',  '#form.billingAddress#', '#form.billingCity#', '#form.billingState#', '#form.billingZip#', '#form.billingcountry#', #form.cc_month#, now(), '#cgi.REMOTE_ADDR#', 10)
</cfquery>
</Cfloop>
<cfelse>
                ...
                <td>
                  <table  width=100% cellspacing=0 cellpadding=2>
                    ...
                    <cfloop list="#form.select_trip#" index="i">
                    	<cfset row = #row# + 1>
                        <cfquery name="tripInfo" datasource="mysql">
                        select *
                        from smg_tours
                        where tour_id = #i#
                        </cfquery>
...
<cfif isDefined('form.lookup')>
    <Cfquery name="stuInfo" datasource="mysql">
...
<cfquery name="qstates" datasource="mysql">
...
<cfif isDefined('form.process')>
	...
	<input type=hidden name="acctVerified" value="#acctVerified#" />
          <Table width=90% cellspacing=0 cellpadding=2 class="border" >
            ...
            <Tr>
                <td>
                  <table  width=100% cellspacing=0 cellpadding=2>
                    ...
                    <Cfquery name="strips" datasource="mysql">
                    select *
                    from smg_tours 
                    where tour_id = #t#
                    </Cfquery>
          ...
          <Table width=90% cellspacing=0 cellpadding=2 class="border">
            ...
            <Tr >
            	<td><h3>Credit Card*</h3></td><td><cfinput type="text" name="cc" validateat="onSubmit" message="Please enter a valid credit card number."  validate="creditcard" required="yes"></td>
                </Tr>
