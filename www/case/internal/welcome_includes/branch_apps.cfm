		...
		<table width=100% valign="top" border=0>
			...
			<tr class="style1">
				...
				<cfquery name="apps" datasource="caseusa">
					SELECT studentid 
					FROM smg_students
					WHERE branchid = '#client.userid#'
						<cfif i NEQ 4 AND i NEQ 6 AND i NEQ 9>AND active = '1'</cfif>
						AND randid != '0'
			...
			<tr><td colspan="11" align=center><a href="?curdoc=student_app/question_start_student"><img src="student_app/pics/start-application.gif" border=0></a></td></tr>
		</table>
