...
var URL = document.form.month.options[document.form.month.selectedIndex].value;
window.location.href = URL;
}
// End -->
</SCRIPT>
...
<!----Filter for month---->
	...
	<form name="form">
		...
		<option value="?curdoc=forms/approve_list3&month=0" <cfif url.month is '0'>selected</cfif>>All</option>
		<option value="?curdoc=forms/approve_list3&month=10" <cfif url.month is '10'>selected</cfif>>October</option>
		<option value="?curdoc=forms/approve_list3&month=12" <cfif url.month is '12'>selected</cfif>>December</option>
		<option value="?curdoc=forms/approve_list3&month=2" <cfif url.month is '2'>selected</cfif>>February</option>
		<option value="?curdoc=forms/approve_list3&month=4" <cfif url.month is '4'>selected</cfif>>April</option>
		<option value="?curdoc=forms/approve_list3&month=6" <cfif url.month is '6'>selected</cfif>>June</option>
		<option value="?curdoc=forms/approve_list3&month=8" <cfif url.month is '8'>selected</cfif>>August</option>
		</select>
	</form>
<!--- OFFICE --->		
<cfif client.usertype LTE 4>
	...
	<Cfquery name="rd_students" datasource="caseusa">
		...
		WHERE s.active =1 and u.userid = 6085
							...
							<tr>
								...
								<td>
									<cfquery name="reports" datasource="caseusa">
										...
										INNER JOIN smg_document_tracking doc ON doc.report_number = prquestion.report_number
										WHERE prquestion.stuid = '#studentid#'
											AND (doc.month_of_report = '#url.month#' or prquestion.month_of_report = '#url.month#')
										ORDER BY prquestion.submit_type DESC 
									</cfquery>		
									<cfif reports.submit_type EQ 'offline'>
										<a href="?curdoc=forms/view_progress_report&number=#reports.report_number#&regionid=#regionid#" title="View Report Number #reports.report_number#">0</font></a>	
									<cfelse>
										<cfif rd_students.type EQ 4 or rd_students.type EQ 5>
											N/A
										<Cfelseif DateFormat(rd_students.startdate, 'mm') gt 9 and DateFormat(rd_students.startdate, 'mm') lt 11 and (rd_students.type neq 2 and rd_students.type neq 4)>
										...
										<cfelse>
											...
											<cfelse>
												<cfif reports.date_rejected is not ''>
													<a href="?curdoc=forms/view_progress_report&number=#reports.report_number#&regionid=#regionid#" title="View Report Number #reports.report_number#"><font color="red">R</font></a>
												<cfelseif reports.ny_accepted is not ''>
													<a href="?curdoc=forms/view_progress_report&number=#reports.report_number#&regionid=#regionid#" title="View Report Number #reports.report_number#"><font color="green">A</font></a>
												<cfelseif reports.date_rd_approved is not ''>
													<a href="?curdoc=forms/view_progress_report&number=#reports.report_number#&regionid=#regionid#" title="View Report Number #reports.report_number#"><font color="orange"><cfif client.usertype eq 4>W<cfelse>H</cfif></font></a>
												<cfelseif reports.date_rd_approved is '' and client.usertype EQ 5>
													<a href="?curdoc=forms/view_progress_report&number=#reports.report_number#&regionid=#regionid#" title="View Report Number #reports.report_number#"><font color="orange">W</font></a>
												<cfelseif reports.date_ra_approved is '' and client.usertype EQ 6>
													<a href="?curdoc=forms/view_progress_report&number=#reports.report_number#&regionid=#regionid#" title="View Report Number #reports.report_number#"><font color="orange">W</font></a>
												<cfelseif reports.date_rd_approved is '' and client.usertype EQ 6>
													<a href="?curdoc=forms/view_progress_report&number=#reports.report_number#&regionid=#regionid#" title="View Report Number #reports.report_number#"><font color="orange">W</font></a>
												<cfelseif reports.date_ra_approved is '' and client.usertype EQ 5>
													<a href="?curdoc=forms/view_progress_report&number=#reports.report_number#&regionid=#regionid#" title="View Report Number #reports.report_number#"><font color="orange">W</font></a>
												<cfelseif reports.ny_accepted is '' and october_reports.date_rd_approved EQ ''>
													<a href="?curdoc=forms/view_progress_report&number=#reports.report_number#&regionid=#regionid#" title="View Report Number #reports.report_number#"><font color="orange">P</font></a>
												<cfelse>
													<a href="?curdoc=forms/view_progress_report&number=#reports.report_number#&regionid=#regionid#" title="View Report Number #reports.report_number#"><font color="660000">P</font></a>
												</cfif>
											</cfif>
										</cfif>
									</cfif>
