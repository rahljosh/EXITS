...
<cfquery name="student_host_name" datasource="caseusa">
	select smg_students.firstname, smg_students.familylastname, smg_students.arearepid, smg_students.arearepid
	from smg_students
...
<Cfquery name="ra1" datasource="caseusa">
	select smg_users.advisor_id, smg_students.studentid, smg_users.firstname, smg_users.lastname
	from smg_users right join smg_students on smg_users.userid = smg_students.arearepid
	where studentid = #stu_id.stuid# 
</cfquery>
...
<Cfquery name="ra" datasource="caseusa">
	select user_access_rights.advisorid as advisor_id, smg_users.firstname, smg_users.lastname
	from user_access_rights right join smg_users on smg_users.userid = user_Access_rights.advisorid
	where user_access_rights.userid  = #ra1.advisor_id# 
</cfquery>
...
<cfquery name="rep_on_report" datasource="caseusa">
...
<cfquery name="get_advisor_for_rep" datasource="caseusa">
select advisorid
from user_access_rights
where userid = #rep_on_report.userid# and companyid = #client.companyid# and regionid = '#client.regions#'
	...
	<cfif client.userid eq #get_advisor_for_rep.advisorid# or client.userid eq #rd.userid# or client.userid eq #ra.advisor_id# or client.userid eq  #student_host_name.arearepid#>
	<cfelse>
		...
		<cfoutput>
							...
							If you feel you have receivd this in error and should be able to see the report, please contact <a href="mailto:support@case-usa.org">support@case-usa.org</a> and reference report id #url.number# along with your name. 
							</div>
							<a href="index.cfm">Home</a> :: <a href="index.cfm?curdoc=forms/approve_list">Back to Report List</a>
							<br><br>
							<font size=-2>
							Support Use Only<br>
							u:#client.userid# rd:#rd.userid#  ra:#ra.advisor_id# ar:#student_host_name.arearepid#
  ...
  <table border=0 width=100% cellspacing=0 border=0 class="section" >
	...
	<tr>
		<td align="center">					
				...
				Month of Report: 
<cfif progress_Report.month_of_report eq 10>October<br> <font size=-2>Due Oct <cfif client.companyid is 7>15th<cfelse>1st</cfif> - include information from arrival thru Oct <cfif client.companyid is 7>15<cfelse>1</cfif></font></cfif> 
<cfif progress_Report.month_of_report eq 12>December<br> <font size=-2>Due Dec <cfif client.companyid is 7>15th<cfelse>1st</cfif> - include information from Oct <cfif client.companyid is 7>15<cfelse>1</cfif> thru Dec <cfif client.companyid is 2>15<cfelse>1</cfif></font></cfif> 
<cfif progress_Report.month_of_report eq 2>February<br> <font size=-2>Due Feb <cfif client.companyid is 7>15th<cfelse>1st</cfif> - include information from  Dec <cfif client.companyid is 7>15<cfelse>1</cfif> thru <cfif client.companyid is 2>Feb<cfelse>Jan</cfif> <cfif client.companyid is 2>15<cfelse>31</cfif></font></cfif> 
<cfif progress_Report.month_of_report eq 4>April<br> <font size=-2>Due April <cfif client.companyid is 7>15th<cfelse>1st</cfif> - include information from Feb <cfif client.companyid is 7>15<cfelse>1</cfif>  thru <cfif client.companyid is 2>April<cfelse>March</cfif> <cfif client.companyid is 2>15<cfelse>31</cfif></font></cfif> 
<cfif progress_Report.month_of_report eq 6>June<br> <font size=-2>Due June <cfif client.companyid is 7>15th<cfelse>1st</cfif> - include information from April  <cfif client.companyid is 7>15<cfelse>1</cfif>  thru <cfif client.companyid is 2>June<cfelse>May</cfif>  <cfif client.companyid is 2>15<cfelse>31</cfif></font></cfif> 
<cfif progress_Report.month_of_report eq 8>August<br> <font size=-2>Due August <cfif client.companyid is 7>31st<cfelse>1st</cfif> - include information from June  <cfif client.companyid is 7>15<cfelse>1</cfif>  thru <cfif client.companyid is 2>July<cfelse>July</cfif>  <cfif client.companyid is 2>15<cfelse>31</cfif></font></cfif> 
				 ...
				 <Cfoutput>
				Area Representitve: #ra1.firstname# #ra1.lastname#  :: Regional Director: #rd.firstname# #rd.lastname#
