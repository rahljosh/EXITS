...
<cfinput type="hidden" value="#temp_password#" name="password">
<cfinput type="hidden" value="#uniqueid#" name="uniqueid">
...
<table>
	...
	<tr>
		...
		<cfinput type="radio" name="usertype" value="#usertypeid#" onClick="hideAll(); changeDiv('#formtype#','block');" message="Please select a user type." required="yes" >#usertype#
...
<table>
	...
	<tr>
		<td align="right">Zip</td><td> <cfinput name=zip type=text size=5 maxlength="6"></td>		
	</tr>
	</table>
...
<table>
	...
	<Tr>
		<td align="right">Social Security: </td><td align="left"><cfinput type=text name="ssn" size=11 validate="social_security_number" message="Please enter a SSN in the following format xxx-xx-xxxx." maxlength="11"> xx-xxx-xxxx</td>
	</tr>
</table>
	</div>
...
<table>
	...
	<tr>
		<td align="right">Zip</td><td> <cfinput type=text name=companyzip size=10 maxlength="6"></td>		
	</tr>
	<tr>	
		<td align="right">Sex:</td><Td align="left"> <cfinput type="radio" name="Sex" value="male">Male <cfinput type="radio" name="Sex" value="female">Female</td>
	</tr>
...
<table>
	<tr>	
		<td align="right" valign="top">Email:</td><Td align="left"> <cfinput type=text name="email" size=20 onchange="javascript:copy()"> login information will be sent on creation of account.<br>
		(leave email address blank for no email address, no email / error will be generated .)</td>
	</tr>
	<tr>
		<td align="right">Username:</td><Td align="left"> <cfinput type=text name="username" size=20> defaults to email address, change if desired</td>
	</tr>
	<tr>	
		<td align="right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Home Phone:</td><Td align="left"> <cfinput name="phone" type=text size=20> nnn-nnn-nnnn</td>
	</tr>
	<tr>	
		<td align="right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Work Phone:</td><Td align="left"> <cfinput name="work_phone" type=text size=20> nnn-nnn-nnnn</td>
	</tr>
	<tr>	
		<td align="right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cell Phone:</td><Td align="left"> <cfinput name="cell_phone" type=text size=20> nnn-nnn-nnnn</td>
	</tr>
	<tr>	
...
<br>
<cfinput type="checkbox" name="listing" value="yes" disabled="true" checked>include information in online phone book (accessable only to employees & field)<br><br>
