...
<table class="section" align="Center" width=580 cellpadding=0 cellspacing=0>
	<tr>
		<td>
				...
				<tr>
					<td rowspan="2" valign="top" width='5'><span class="get_attention"><b>></b></span></td>
					<td class="dash" width=50%><b>School</b> <cfif schoolid NEQ '0' and client.usertype LTE 4>[ <A href="../index.cfm?curdoc=forms/school_app_1&schoolid=#get_student_info.schoolid#" target="_blank">view school</A> ]</cfif></td>
					<td rowspan="2" valign="top" width='10'></td>
					<td rowspan="4" valign="top" width='5'><span class="get_attention"><b>></b></span></td>
...
<!--- PLACEMENT HISTORY --->
<cfquery name="history_dates" datasource="caseusa">
	SELECT dateofchange
