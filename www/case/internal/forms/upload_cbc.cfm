...
<table width=100% cellpadding=0 cellspacing=0 border=0 height=24>
						<tr valign=middle height=24>
							...
							<td background="pics/header_background.gif"><h2>Upload CBC Form</td><td background="pics/header_background.gif" width=16></td>
...
<table width="500" border=0 cellpadding=3 cellspacing=0 align="center">
	<tr>
		<td style="line-height:20px;" valign="top" colspan=3><br>
			<cfform action="querys/upload_file.cfm?id=#url.id#" method="post" enctype="multipart/form-data" preloader="no">
