...
<cfquery name="get_paperwork_log" datasource="caseusa">
	SELECT * 
...
<cfquery name="user_rights" datasource="caseusa">
...
<cfquery name="get_arrival" datasource="caseusa">
	...
	WHERE studentid =  <cfqueryparam value="#get_paperwork_log.studentid#" cfsqltype="cf_sql_integer">
