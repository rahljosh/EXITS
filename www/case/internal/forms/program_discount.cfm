...
<cfquery name="get_prices" datasource="caseusa">
	select businessname, 10_month_price, 5_month_price, 10_month_ins, 5_month_ins, accepts_sevis_fee, userid, insurance_typeid
	from smg_users
...
<Cfoutput>
<form method="post" action="querys/add_discount.cfm?userid=#url.userid#">
...
<table div align="center" cellpadding= 4 cellspacing=0>
	<tr bgcolor="#00003C">
		<Td colspan=2 align="center"><font color="white">10 Months</Td><td colspan=2 align="center"><font color="white">5 months</td>
	</tr>
	<tr bgcolor="#00003C">
		<td align="center"><font color="white">Price</td><td align="center"><font color="white">Insurance</td><td align="center"><font color="white">Price</td><td align="center"><font color="white">Insurance</td>
	</tr>
	...
	<Tr>
	<tr bgcolor="00003C"><td colspan=5><font color="white">Insurance Policy Type</td></tr>
	<tr>
		<td colspan=2>											
	...
	<tr bgcolor="00003C"><td colspan=5><font color="white">Accepts SEVIS FEE</td></tr>
	<tr>
		<td colspan="2"> 								
