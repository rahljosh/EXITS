...
<cfquery name="ra2" datasource="caseusa">
						...
						<td width=50% valign="top" align="left">
									<table>
										...
										<tr>
											...
											NJ Accepted: <Cfif tracking_info.ny_Accepted  is ''>Pending<cfelse> #DateFormat(tracking_info.ny_Accepted, 'mm/dd/yyyy')# @ #TimeFormat(tracking_info.ny_Accepted, 'h:mm:ss tt')# </cfif><br>
							...
							<td valign="top" align="right">
											...
											<cfif client.usertype LTE '4'> 
											<tr>
												<td>&nbsp; <a href="javascript:OpenLetter('../internal/reports/email_progress_report.cfm?number=#url.number#');"><img src="pics/email.gif" border="0" alt="Email Progress Report"> Email</a></td>
											</tr>
											</cfif>
										</Table>
								</td>
