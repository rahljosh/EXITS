...
<Cfif history_dates.recordcount is not 0>
	...
	<cfoutput query="placement_history">
		...
		<tr bgcolor="D5DCE5"><td colspan="5">Date : &nbsp; #DateFormat(dateofchange, 'mm/dd/yyyy')#</td></tr>
		<tr><td width="110"><u>Host Fam.</u></td>
		<td width="120"><u>Place Rep.</u></td>
		<td width="180"><u>Reason</u></td>
