	...
	<tr><td><b>Date</b></td><Td><b>ID</b></Td><td><b>Student</b></td><td><b>Type</b></td><td><b>Amount</b></td><td><b>Comment</b></td><td><b>Trans. Type</b></td><td>Delete</td></tr>
		...
		<cfelse>
			...
			<tr bgcolor="#iif(all_charges.currentrow MOD 2 ,DE("ffffe6") ,DE("e2efc7") )#">
				...
				<td>#comment#</td>
				<td>#transtype#</td>
				<td align="center"><cfif client.userid is '12522' or client.userid is '5' or client.usertype is '1'><a href="../querys/delete_supervising_payment.cfm?paymentid=#id#&userid=#rep_info.userid#" onClick="return areYouSure(this);"><img src="../pics/deletex.gif" border="0"></img></a></cfif></td>
			</tr>
