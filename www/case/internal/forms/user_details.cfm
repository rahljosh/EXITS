...
<cfoutput>
<form action="querys/add_user_details.cfm?userid=#userid#" method="post">
...
<Table border=0>
		...
		<cfquery name="company_names" datasource="caseusa">
...
<cfelse>
<cfquery name="user_regions" datasource="caseusa">
