...
<cfquery name="get_letter_info" datasource="caseusa">
...
to attend your school. #companyshort.companyshort# has issued a DS 2019 for #get_letter_info.firstname# and 
#get_letter_info.firstname# is now in the process of securing a J1 visa.
</p>

<p>
We have asked the #get_letter_info.h_lastname# family to help #get_letter_info.firstname# in enrolling and registering
in your school.
</p>

<p>
We wish to let you know that #get_letter_info.firstname# is being supervised by #get_letter_info.ar_firstname# 
#get_letter_info.ar_lastname#, <cfif companyshort.companyid is 4>a <cfelse>an </cfif>#companyshort.companyshort# Area Representative. 
