...
<!--- get Reps  --->
<cfquery name="GetIntlReps" datasource="caseusa">
...
<cfloop query="GetIntlReps">
	...
	<cfif IsDefined('form.send_email')>
		...
		<CFMAIL TO="#GetIntlReps.email#"
			bcc="#get_user_email#"
			SUBJECT="#companyshort.companyshort# - Placement Report"
			...
			<p>&nbsp; &nbsp; &nbsp; Also remember that you can log on to EXITS yourself and check all placement information at your convenience. Please visit
				http://www.case-usa.com and click on EXITS Portal Login.</p>
			...
			<table width='95%' frame="below" cellpadding=6 cellspacing="0" align="center">
				<tr><td width="6%" align="center"><b>ID</b></td>
					...
					<td width="12" align="center"><b>Flight Information</b></td>
					<td width="12%" align="center"><b>Placement Date</b></td></tr>
				<cfloop query="get_students">
					<cfquery name="get_flight_info" datasource="caseusa">
						SELECT flightid
					...
					<tr bgcolor="#iif(get_students.currentrow MOD 2 ,DE("ededed") ,DE("white") )#">
						...
						<td align="center"><cfif get_flight_info.recordcount>Received<cfelse><font color="FF0000"><b>Missing</b></font></cfif></td>	
	...
	<span class="application_section_header">#companyshort.companyshort# -  Students per International Rep.</span>
	</table><br>
	<table width='95%' cellpadding=6 cellspacing="0" align="center" frame="box">
	<tr><td align="center">
		Program(s) Included in this Report:<br>
