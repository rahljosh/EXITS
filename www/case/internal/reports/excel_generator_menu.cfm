		...
		<Table class="nav_bar" cellpadding=4 cellspacing="0" align="left" width="100%">
			...
			<tr align="left">
				<TD colspan="2">&nbsp; &nbsp;	
					...
					<cfoutput query="get_regions"><option value="#regionid#"><cfif client.companyid is 5>#CompanyShort# - </cfif>#RegionName# </option></cfoutput>
					</select>
				</td>
			</tr>	
            <!----	
			...
			<tr align="left">
				<TD width="50%">				
					<input type="checkbox" name="ise" value="1" <cfif client.companyid is 1 or client.companyid is 5>checked</cfif> disabled>ISE<br>
					<input type="checkbox" name="ise" value="2" <cfif client.companyid is 2 or client.companyid is 5>checked</cfif> disabled>INTO<br>
				</td>
				<TD width="50%">				
					<input type="checkbox" name="asa" value="3" <cfif client.companyid is 3 or client.companyid is 5>checked</cfif> disabled>ASA<br>
					<input type="checkbox" name="dmd" value="4" <cfif client.companyid is 4 or client.companyid is 5>checked</cfif> disabled>DMD
				</td>
			</tr>
			---->	
			<tr bgcolor="#e2efc7">
