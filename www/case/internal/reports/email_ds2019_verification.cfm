...
<cfloop query="GetIntlReps">
	...
	<cfquery name="fax_number" datasource="caseusa">
	select fax
	from smg_companies
	...
	<cfif IsDefined('form.send_email') AND GetIntlReps.email NEQ ''>
		...
		<cfmail from="support@case-usa.org" to="#GetIntlReps.email#" bcc="#get_current_user.email#" 
			subject="#companyshort.companyshort# - DS 2019 Verification Report" type="html">
			<HTML>
			<HEAD>
				<style type="text/css">
				h3{
