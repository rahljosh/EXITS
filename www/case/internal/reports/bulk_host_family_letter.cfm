...
<table width=650 align="center" border=0 bgcolor="FFFFFF">
	<tr>
		<td><div align="justify">
			...
			#companyshort.companyshort# provides you with full support throughout #get_students.firstname#'<cfif #right(get_students.firstname, 1)# is 's'><cfelse>s</cfif> stay. 
