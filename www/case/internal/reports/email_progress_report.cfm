...
<cfelse>
	...
	TO="#emails#" failto="#get_current_user.email#" FROM="support@case-usa.org" TYPE="HTML">
	<HTML>
	<HEAD></HEAD>
	<BODY>
	...
	<table cellspacing="2" cellpadding="2" border="0" width="650" align="center" class="box">
		<tr>
			<td><img src="#ImgScrPath#/internal/pics/logos/#companyshort.companyid#.gif" alt="" border="0" align="left"></td>
			 <td  align="left">
		...
		<TR>
			<TD align="left" valign=top>
					<TABLE>
						...
						<tr>
							<td>
								<table class=nav_bar width=100% align="Center" background="#ImgScrPath#/internal/pics/inperson_background.jpg">
									<TR>
			...
			<TD align="right" valign=top>
					<TABLE>
						...
						<tr>
							<td>
								<table class=nav_bar width=100% align="Center"  background="#ImgScrPath#/internal/pics/phone_background.jpg">
									<TR>
										<td align="center">Host Family<br>(mm/dd/yy)</td><td align="center">Student<br>(mm/dd/yy)</td>
									</tr>
									<TR>
