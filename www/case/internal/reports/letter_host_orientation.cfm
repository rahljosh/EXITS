	...
	<tr class="style1">
		<td>
			<div align="justify">
				...
				In addition, this document serves as an acknowledgment that a designated representative of the exchange organization performed
				an in-home interview and that you have received a host family handbook. Your signature also confirms you have been provided the
				name and contact information of a supervising representative who will be available to objectively assist you and the student
				during the program.
				<br><br>
			</div>
		</td>
