...
<!-----Area Rep----->
<cfquery name="get_area_rep" datasource="caseusa">
...
<!-----Host Family----->
<cfquery name="get_host_family" datasource="caseusa">
	Select *
	From smg_hosts
...
<!-----Host Children----->
<cfquery name="get_host_children" datasource="caseusa">
	Select *
...
<cfquery name="get_host_pets" datasource="caseusa">
...
<table width=650 align="center" border=0 bgcolor="FFFFFF"> 
	...
	<td>
		...
		<form action="email_placement_letter.cfm?studentid=#get_student_info.studentid#" method="post"
		onsubmit="return confirm ('Are you sure? This PIS will be sent to the International Representative')">
		<input type="image" src="../pics/sendemail.gif" value="send email"><input type="checkbox" name="self">Yourself Only</form>
		<cfelse><br><br><br><br>
		</cfif>
		#DateFormat(now(), 'dddd, mmmm dd, yyyy')# <!--- Wednesday, August 31, 2005  ---><br>
	</td>
	<td><img src="../pics/logos/#companyshort.companyid#.gif"  alt="" border="0" align="right"></td>
...
<table width=650 align="center" border=0 bgcolor="FFFFFF" style="font-size:13px"> 
	...
	<span class="application_section_header_bold">STUDENT INFORMATION</span><br>
		<tr><td>
		<cfif get_student_info.placement_notes NEQ ''>#get_student_info.placement_notes#<br></cfif>		
...
<!--- http://smg.pokytrails.com/reports/placement_letter.cfm?studentid=491 --->