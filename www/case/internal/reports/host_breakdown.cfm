...
<cfquery name="hosts" datasource="caseusa">
...
<cfoutput query="hosts">
	...
	<cfelse>
	<Cfquery name="host_company" datasource="caseusa">
	select companyshort
	from smg_companies
	...
	<cfquery name="hosting" datasource="caseusa">
	...
	<cfelse>
	<cfquery name="student_region" datasource="caseusa">
	...
	<cfelse>
		<cfquery name="sup_Rep_info" datasource="caseusa">
	...
	<cfelse>
		<cfquery name="place_Rep_info" datasource="caseusa">
		select smg_users.firstname, smg_users.lastname, smg_users.userid, smg_users.active, smg_users.regions, smg_users.companyid
		from smg_users
