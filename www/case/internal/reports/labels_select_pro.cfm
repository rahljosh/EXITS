...
<cfquery name="insurance_dates" datasource="caseusa">
	SELECT s.insurance
	FROM smg_students s
...
<tr><td valign="top">
	...
	<tr><th colspan="2" bgcolor="##e2efc7">STUDENT'S ID CARDS <font size="-2">(Ordered by Agent)</font></th></tr>
	<tr>
		<td width="50%" valign="top">
			...
			<Table class="nav_bar" align="left" cellpadding=6 cellspacing="0" width="100%">
				<tr><th colspan="2" bgcolor="##e2efc7">Per Batch ID</th></tr>
				<tr><td>Batch ID : </td>
					<td align="left"><select name="batchid" multiple size="5">
						<cfloop query="get_batches"><option value="#batchid#">#batchid# &nbsp; #DateFormat(datecreated,'mm/dd/yy')# </option></cfloop></select></td></tr>
				<tr align="left">
					<td>Intl. Rep:</td>
	...
	<tr>
		<td width="50%" valign="top">
			...
			<Table class="nav_bar" align="left" cellpadding=6 cellspacing="0" width="100%">
				<tr><th colspan="3" bgcolor="##e2efc7">Per Entered Date</th></tr>
				<tr><td>Program :</td>
