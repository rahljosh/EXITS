...
<cfquery name=invoice_details datasource="caseusa">
...
<br>
 ...
 <br>
				...
				Charges to be paid are indicated below indicates how the charges will be applied.  Please verify that this is correct before clicking approve.
				 ...
				 <cfelseif diff lt 0>
				  The amount paid is greater than the amount due for this invoice.  The difference #LSCurrencyFormat(diff,'local')# will show up as a credit on the agents account that you can apply to another payment by
		 ...
		 select * from smg_charges where invoiceid = #invoice#
		 </cfquery>
		<table>
			<tr>
			...
			<cfquery name="check_if_paid" datasource="caseusa">
			select *
