...
<cfset form.end_date = '10/31/2005'><cfset form.beg_date = '09/01/2005'><head>
...
<!----Totals from Sept to Current--->
	...
	<cfquery name="total_refund" datasource="caseusa">
		...
		<cfif total_refund.total_refund is''><cfset total_refund.total_refund = 0></cfif>
			...
			<tr>
				<td align="right" width=50%><strong>Total Amount Invoiced:</strong></td><td><strong>#LSCurrencyFormat(total_Due.amount_due, 'local')#</strong></td>
			</tr>
			<tr>
			...
			<tr>
				<td align="right" bgcolor="FFFF99"><font size=+1><strong>(=) Total Outstanding Balance:</strong></td><td bgcolor="FFFF99"><strong><font size=+1><cfset balance_due = #total_due.amount_due# - #total_credit.credit_Amount#- #total_received.total_received#+#total_refund.total_refund#><b>#LSCurrencyFormat(balance_due, 'local')#*</strong></td>
			</tr>
...
1) Invoices Issued #form.beg_date# and #form.end_date#
