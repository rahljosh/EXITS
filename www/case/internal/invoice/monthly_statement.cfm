<cfif isDefined('form.pdf')>
	<cflocation url="monthly_statement_pdf.cfm?userid=#url.userid#&beg_date=#form.beg_Date#&end_date=#form.end_date#">
	<cfabort>
</cfif><head>
...
<Cfquery name="intrep" datasource="caseusa">
	select smg_users.businessname, smg_users.userid, smg_users.usebilling
	from  smg_users
	where smg_users.userid = #url.userid#
</Cfquery>
...
<td bgcolor="cccccc" class="thin-border" background="../pics/cccccc.gif">From:</td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><Td bgcolor="cccccc" class="thin-border" >To:</Td><td rowspan=2 valign="top">  
		<table border="0" cellspacing="0" cellpadding="2" class="nav_bar" align="right">
		  ...
		  <tr>
			<td bgcolor="CCCCCC" align="center" class="thin-border-bottom"><b><FONT size="+1">Statement Dates</FONT></b></td>
			
		  </tr>
		  <tr>
			<td align="center" class="thin-border-bottom" ><B><font size=+1> 
#DateFormat(form.beg_Date, 'M/DD/yy')# - #DateFormat(form.end_Date, 'M/DD/yy')#
	...
	<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
			<td valign=top class="thin-border-left-bottom-right">
				...
				#business_name.billing_company#<br>
		#business_name.billing_contact#<br>
		#business_name.billing_address#<br>
		<cfif #business_name.billing_address2# is ''><cfelse>#business_name.billing_address2#</cfif>
		#business_name.billing_city# #business_name.billing_country# #business_name.billing_zip#
		<br>
		E: #business_name.billing_email#<br>
		P: #business_name.billing_phone#<br>
		F: #business_name.billing_fax#<br>
		
		
		</td>

</tr>
<cfif usebilling eq 1>
...
<!----Totals from Sept to Current--->
			...
			<cfquery name="total_Credit" datasource="caseusa">
...
<!----
			...
			<tr>
				<td align="right"><strong>(-) Total Amount Canceled / Credited / Discounted:</strong></td><td><strong>   #LSCurrencyFormat(total_Credit.credit_amount, 'local')#</strong></td>
			</tr>
			<tr>
			...
			<tr>
				<td align="right" bgcolor="FFFF99" width=60%><strong><font color="##CC3333">(=) Total Outstanding Balance:</strong></td><td bgcolor="FFFF99"><strong><font color="##CC3333"><cfset balance_due = #total_due.amount_due# - #total_credit.credit_Amount#- #total_received.total_received#+#total_refund.total_refund#><b>#LSCurrencyFormat(balance_due, 'local')#*</strong></td>
			</tr>
...
<cfoutput query=payments_received>
	...
	<!----
	<cfquery name="credit_description" datasource="caseusa">
