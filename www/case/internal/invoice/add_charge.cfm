...
<!----Sevis Charge---->
<cfquery name="check_for_sevis" datasource="caseusa">
...
<cfquery name="students_under_rep_not_charged" datasource="caseusa">
...
<table cellpadding = 4 cellspacing=0 border=0>
	...
	<tr>
		...
		<cfoutput query=students_under_rep_not_charged>
			<cfquery name="check_charges" datasource="caseusa">
				select amount, chargeid, invoiceid, type, description
				from smg_charges
				where stuid = #studentid# and active = 1
				order by type
			</cfquery>
			<cfquery name="program_name_charge" datasource="caseusa">
					...
					<cfelse>
						<cfset charge_list =''>
							...
							<cfset charge_list = ListAppend(charge_list, '#type#')>
											...
											<cfquery name="program_charges" datasource="caseusa">
											select 
											...
											<cfquery name="student_charges" datasource="caseusa">
							...
							<cfelse>
								...
								<cfquery name="determine_guarantee" datasource="caseusa">
								...
								<cfif determine_guarantee.state_guarantee eq 0>
									<cfquery name="guarantee_info" datasource="caseusa">
								...
								<Tr>
									...
									<cfquery name="check_sts" datasource="caseusa">
