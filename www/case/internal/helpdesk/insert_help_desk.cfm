...
<cfquery name="insert_link" datasource="caseusa">
	insert into smg_links (link)
		values ('https://www.case-usa.org/inernal/index.cfm?curdoc=helpdesk/help_desk_view&amp;helpdeskid=#retrive_helpdeskid.helpdeskid#')
</cfquery>
...
<cfoutput>
<cfmail from="support@case-usa.org" to="#get_user_info.email#" subject="CASE Help Desk - New Message Submitted">
...
and the CASE Technical Support Team will be reviewing it soon.

Please click on the link to check the status, review the item, or add additional information. 

http://www.case-usa.org/?link=#get_link_id.linkid#

*Authentication maybe required if you are not currently logged on to the CASE website.*
...
generated by CASE.  If you have any concerns please
contact support@case-usa.com immediately.
===================================================
</cfmail>

<!--- message sent to the Technical Support --->
<cfmail from="support@case-usa.org" to="#assigned_to.email#, stacy@case-usa.org" subject="CASE Help Desk - New Message Submitted">
Dear #assigned_to.firstname# #assigned_to.lastname#,

A new request of service has been submitted to you.
Item Link: http://www.case-usa.org/?link=#get_link_id.linkid#
