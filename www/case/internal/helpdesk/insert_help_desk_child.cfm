...
<cfquery name="get_help_desk" datasource="caseusa">
	SELECT *
	FROM smg_help_desk
	WHERE helpdeskid = <cfqueryparam value="#url.helpdeskid#" cfsqltype="cf_sql_integer">
</cfquery>

<cfquery name="get_user_submitted" datasource="caseusa">
...
<cfif get_user_info.usertype GT 1>
	...
	<cfquery name="update_help_desk" datasource="caseusa">
	...
	<cfquery name="insert_help_desk_items" datasource="caseusa">
	...
	<cfmail from="support@case-usa.org" to="#assigned_to.email#, pat@student-management.com" subject="SMG Help Desk - HD Ticket ###url.helpdeskid# - New Post Submitted">
...
To view the comment and current status please visit http://www.student-management.com/?link=#find_link.id#
...
<cfelse>
	<!--- ADMIN USERS --->
	<cfquery name="update_help_desk" datasource="caseusa"> <!--- UPDATE ASSIGNMENT--->
		UPDATE smg_help_desk	
	...
	<cfif form.text is not ''> <!--- INSERT CHILD MESSAGE --->
		...
		<cfoutput>
			<cfmail from="helpdesk@student-management.com" to="#get_user_submitted.email#" subject="SMG Help Desk - HD Ticket ###url.helpdeskid# - New Post Submitted">
