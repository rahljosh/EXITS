...
<cfquery name="help_desk_list" datasource="caseusa">
			...
			<table>		
				...
				<tr><td width="50%" valign="bottom">Message: </td>
					<td align="left" width="50%">Section Affected :
						...
						<option value="0"></option>
						<cfquery name="get_sections" datasource="caseusa">
...
<div class="scroll">
	...
	<cfif help_desk_list.recordcount is not 0>
		...
		<cfquery name="check_sub_items" datasource="caseusa">
...
<!----Alternate Contact Methods---->
	...
	Stacy Brewer<br>
	<a href="mailto:stacy@case-usa.org">stacy@case-usa.org</a><br>
	...
	general support email at <a href="mailto:support@case-usa.org">support@case-usa.org</a> <br>
	</td>
	</tr>
</table>
<!----footer of table---->
