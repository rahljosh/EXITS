...
<title>EXITS - VIRTUAL FOLDER</title>
</head>

<body onLoad="print()">

<cfif NOT IsDefined('url.studentid') AND NOT IsDefined('url.file')>
...
<table width="680" border="0" cellpadding="3" cellspacing="0" align="center">
	<tr><td><img src="../uploadedfiles/virtualfolder/#url.studentid#/#url.file#" width="680" height="860"></td></tr>
</table>
</cfoutput>
