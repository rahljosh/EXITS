...
<title>CASE - VIRTUAL FOLDER</title>
...
<cfset currentDirectory = "/var/www/html/case/internal/uploadedfiles/virtualfolder/#get_student_info.studentid#">
...
<table width=100% cellpadding=0 cellspacing=0 border=0 height=24>
	<tr valign=middle height=24>
		...
		<td background="../pics/header_background.gif"><h2>CASE - Virtual Folder &nbsp; - &nbsp; #get_student_info.firstname# #get_student_info.familylastname# (###get_student_info.studentid#)</h2></td>
...
<table width=660 cellpadding=6 cellspacing=1 border=0 align="center">
	<tr><th><h2>Welcome to the CASE Virtual Folder</h2></th></tr>
	<tr><td><div align="justify">In this area you can upload as many files as you want for your student. For each file upload notification will be sent out to inform
			the appropriate people at CASE that you have uploaded a file. <br>
			...
			PS: There is a limit of 2mb per file.</div></td></tr>
</table><br>
