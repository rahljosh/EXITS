...
you do not have access to this info.
<cfelse>
...
<!---
   ...
   <cfcase value="ShowPage">
    ...
    <cflock name="TrackMan" type="ReadOnly" timeout="10">
      <cfloop collection="#Application.stuOnline#" item="ThisUser">
       <cfif Application.stuOnline[ThisUser][2] IS CGI.CF_Template_Path>
         <cfset 
 ...
 <!---Build List of Users in the same folder--->
   <cfcase value="ShowDir">
     ...
     <cflock name="TrackMan" type="ReadOnly" timeout="10">
       <cfloop collection="#Application.stuOnline#" item="ThisUser">
        <cfif GetDirectoryFromPath(Application.stuOnline[ThisUser][2])
              IS
 ...
 <table width=100% cellpadding=0 cellspacing=0 border=0 height=24>
   ...
   <table border=0  width=100% class=section rules="rows">
     ...
     #ThisUser#</td>
          <td>
         #Application.stuOnline[ThisUser][2]#</td>
          <td>
         #TimeFormat(Application.stuOnline[ThisUser][1])#
         #DateFormat(Application.stuOnline[ThisUser][1])#
         </td></tr>
