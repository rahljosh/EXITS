...
<cfif client.usertype LTE 4>
	...
	<cfquery name="pending_hosts" datasource="caseusa">
		SELECT s.host_fam_approved, s.studentid, s.hostid, s.firstname, s.familylastname as student_lastname, s.regionassigned, 
			 h.familylastname, h.fatherfirstname, h.fatherlastname, h.motherlastname, h.motherfirstname, h.city, h.state,  
			 p.programname
		FROM smg_students s
...
<cfelse>
	...
	<cfquery name="list_regions" datasource="caseusa"> 
		SELECT uar.regionid, uar.usertype, smg_regions.regionname
	...
	<cfquery name="pending_hosts" datasource="caseusa">
		...
		WHERE s.active = '1'
			...
			<cfif client.usertype EQ 5>
				AND (s.regionassigned = '#get_user_region.regionid#') 
			<!--- Advisor --->
...
<table border=0 cellpadding=4 cellspacing=0 width=100%>
	...
	<tr>
		...
		<td width=20>ID</td>
		<td width=70>Last Name(s)</td>
		<td width=70>First Name(s)</td>
	</tr>
...
<cfoutput query="pending_hosts">
	<cfquery name="get_region" datasource="caseusa">
		SELECT * 
		FROM smg_regions
		where regionid = #pending_hosts.regionassigned#
	</cfquery>
...
<tr bgcolor="<Cfif host_fam_Approved EQ '7'>FCC8C8<cfelseif host_fam_Approved is '6'>FDFF6D<cfelseif host_fam_approved is '5'>A0E1A1<cfelseif host_fam_approved is '99'>FB8822</cfif>">
		<td width=20>#studentid#</td>
		<td width=75>#student_lastname#</td>
		<td width=75>#firstname#</td>
		<td width="60">#get_region.regionname#</td>
		<td width="80">#programname#</td>
		<td width=20><a class=nav_bar href="" onClick="javascript: win=window.open('forms/place_menu.cfm?studentid=#studentid#', 'Settings', 'height=550, width=600, location=no, scrollbars=yes, menubars=no, toolbars=no, resizable=yes'); win.opener=self; return false;">#hostid#</a></td>
		<td width=70><a class=nav_bar href="" onClick="javascript: win=window.open('forms/place_menu.cfm?studentid=#studentid#', 'Settings', 'height=550, width=600, location=no, scrollbars=yes, menubars=no, toolbars=no, resizable=yes'); win.opener=self; return false;"><cfif fatherlastname is motherlastname> #fatherlastname#<Cfelseif fatherlastname is''> #motherlastname# <Cfelseif motherlastname is ''>#fatherlastname#<Cfelse>#fatherlastname# #motherlastname#</cfif></td>
