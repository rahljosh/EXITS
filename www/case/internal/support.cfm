...
<table border=0 cellpadding=4 cellspacing=0 class="section" width=100%>
	<Tr>
		<td>
		<br>
		Contact CASE Technical Support regarding system based problems. <br><br>
		...
		To submit a problem to the support team, please email support:: <a href="mailto:support@case-usa.org">support@case-usa.org</a> <br>
		 <br>
