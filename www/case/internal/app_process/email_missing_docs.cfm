...
<cfquery name="get_program_applied" datasource="caseusa">
	SELECT app_program
	FROM smg_student_app_programs
	WHERE app_programid = '#get_student_info.app_indicated_program#'
</cfquery>

<cfquery name="docs_checklist" datasource="caseusa">
...
<CFMAIL SUBJECT="Missing Documents Notification for #get_student_info.firstname# #get_student_info.familylastname# (###get_student_info.studentid#)"
	...
	<table width="650" border="0" bgcolor="FFFFFF" cellpadding="3">
		...
		<tr><td colspan="2">Missing Documents:</td></tr>
		<tr>
			<td colspan="2">
				<cfloop query="docs_checklist">	
					<cfif ListFind(get_student_info.onhold_docs, docid , ",")><b><li>#document#</li></b><br></cfif>
				</cfloop>
			</td>
		</tr>
