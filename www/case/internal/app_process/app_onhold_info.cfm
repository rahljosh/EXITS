	...
	<tr>
		<td valign="top">
			...
			<cfelseif get_student_info.onhold_reasonid EQ 3>
				Missing Documents Notification <a href="?curdoc=app_process/email_missing_documents&studentid=#get_student_info.studentid#" onClick="return confirm_email()"><img src="pics/email.gif" border="0" alt="Email Missing Documents Notification"></a>
