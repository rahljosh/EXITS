...
<cfquery name="reactivate_application" datasource="caseusa">
	UPDATE smg_students 
...
<cfquery name="reactivate_application_status" datasource="caseusa">
...
<cfquery name="get_denied_reason" datasource="caseusa">
