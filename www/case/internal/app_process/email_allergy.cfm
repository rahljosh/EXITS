...
<CFMAIL SUBJECT="Allergy Information Form for #get_student_info.firstname# #get_student_info.familylastname# (###get_student_info.studentid#)"
	...
	<!--- Attach allergy form --->
	<cfmailparam file="/var/www/html/case/internal/uploadedfiles/pdf_docs/allergy_info_form.pdf"/>
	...
	<table width="650" border="0" bgcolor="FFFFFF" cellpadding="3">
		<tr>
			<td colspan="2">
				<div align="justify">
				The above student's application has been placed on hold due to allergies that may prove too restrictive for the program. CASE needs to verify that 
