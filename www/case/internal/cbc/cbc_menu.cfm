...
<cfquery name="get_host_cbcs" datasource="caseusa">
	SELECT DISTINCT count(cbc.cbcfamid) as total, cbc.cbc_type, smg_seasons.season, cbc.familyid
	...
	GROUP BY cbc.cbc_type, cbc.seasonid
	ORDER BY cbc.seasonid
</cfquery>

<cfquery name="get_user_cbcs" datasource="caseusa">
	SELECT DISTINCT count(cbc.cbcid) as total, smg_seasons.season
	FROM smg_users_cbc cbc
	INNER JOIN smg_users u ON u.userid = cbc.userid
	INNER JOIN smg_seasons ON smg_seasons.seasonid = cbc.seasonid
	WHERE cbc.date_sent IS NULL 
		AND cbc.companyid = <cfqueryparam value="#client.companyid#" cfsqltype="cf_sql_integer">
	GROUP BY cbc.seasonid
	ORDER BY cbc.seasonid
</cfquery>
	...
	<tr>
		<td align="center" width="50%" valign="top">
			<Table cellpadding=6 cellspacing="0" align="center" width="100%">
				...
				<cfif get_user_cbcs.recordcount>
					<cfloop query="get_user_cbcs">
		...
		<td align="center" width="50%" valign="top">
			<Table cellpadding=6 cellspacing="0" align="center" width="100%">
				...
				<tr><th>Season</th><th>CBC Type</th><th>Total</th></tr>
				<cfif get_host_cbcs.recordcount>
				
					<cfloop query="get_host_cbcs">
