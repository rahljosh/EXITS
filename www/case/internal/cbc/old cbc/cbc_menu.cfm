...
<cfquery name="get_host_cbcs" datasource="MySql">
	SELECT DISTINCT count(cbc.cbcfamid) as total, cbc.cbc_type, smg_seasons.season
...
<cfquery name="get_user_cbcs" datasource="MySql">
