...
<!---- HOST MOTHER --->
<cfquery name="get_cbc_mother" datasource="MySql">
...
<cfquery name="get_mother_season" datasource="MySql">
...
<!---- HOST FATHER --->
<cfquery name="get_cbc_father" datasource="MySql">
	SELECT cbcfamid, hostid, date_authorized , date_sent, date_received, requestid, flagcbc, 
		smg_hosts_cbc.seasonid, smg_seasons.season,
		c.companyshort
	FROM smg_hosts_cbc
...
<cfquery name="get_father_season" datasource="MySql">
	SELECT seasonid, season, active
	FROM smg_seasons
	WHERE active = '1'
	<!--- get remaining seasons --->
