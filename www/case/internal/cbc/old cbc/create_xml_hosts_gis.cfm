...
<cfelse>
	...
	<cftry>
		...
		<cfset newssn = #Replace("#newssn#", " ", "","All")#>
	<cfcatch type="any">
		Please check SSN for #get_cbc_members.name# #get_cbc_members.lastname# member of host family (###get_cbc_hosts.hostid#)
		<cfabort>
	</cfcatch>
	</cftry>
	...
	<cffile action="write" file="/var/www/html/student-management/nsmg/uploadedfiles/xml_files/gis/#get_company.companyshort#/batch_#get_batchid.cbcid#_hostm_#name#_#hostid#_sent.xml" output="#toString(requestXML)#">

	<cfset responseXML = ''>
   	<cfset responseXML = XmlParse(cfhttp.filecontent)>

	<cffile action="write" file="/var/www/html/student-management/nsmg/uploadedfiles/xml_files/gis/#get_company.companyshort#/batch_#get_batchid.cbcid#_hostm_#name#_#hostid#_rec.xml" output="#toString(responseXML)#">	
