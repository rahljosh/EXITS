...
<cfif form.usertype NEQ 'member'>
	...
	<cffile action="write" file="/var/www/html/student-management/nsmg/cbc/gis/#get_company.companyshort#/batch_#get_batchid.cbcid#_host_#form.usertype#_#hostid#_sent.xml" output="#toString(requestXML)#" mode="777">

	<cfset responseXML = ''>
   	<cfset responseXML = XmlParse(cfhttp.filecontent)>
   	
	<cffile action="write" file="/var/www/html/student-management/nsmg/cbc/gis/#get_company.companyshort#/batch_#get_batchid.cbcid#_host_#form.usertype#_#hostid#_rec.xml" output="#toString(responseXML)#" mode="777">
	...
	<cfmail from="support@student-management.com" to="caroline@student-management.com" subject="GIS Search for #get_company.companyshort# HF #usertype# - #Evaluate(usertype & "firstname")# #Evaluate(usertype & "lastname")# (###hostid#)" failto="support@student-management.com" type="html">
...
<cfelse>
	...
	<cfquery name="get_cbc_members" datasource="MySql">
		SELECT DISTINCT cbc.cbcfamid, cbc.hostid, cbc.cbc_type, cbc.date_authorized, cbc.date_sent, cbc.date_received,
	...
	<cffile action="write" file="d:\websites\nsmg\cbc\gis\#get_company.companyshort#\batch_#get_batchid.cbcid#_hostm_#name#_#hostid#_sent.xml" output="#toString(requestXML)#">

	<cfset responseXML = ''>
   	<cfset responseXML = XmlParse(cfhttp.filecontent)>
	
	<cffile action="write" file="d:\websites\nsmg\cbc\gis\#get_company.companyshort#\batch_#get_batchid.cbcid#_hostm_#name#_#hostid#_rec.xml" output="#toString(responseXML)#">	
