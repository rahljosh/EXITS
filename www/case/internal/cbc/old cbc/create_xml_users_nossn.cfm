...
<cfloop query='get_cbc_users'> 
	...
	<cffile action="write" file="/var/www/html/student-management/nsmg/cbc/gis/#get_company.companyshort#/batch_#get_batchid.cbcid#_user_#get_cbc_users.userid#_sent.xml" output="#toString(requestXML)#" mode="777">
    ...
    <cffile action="write" file="/var/www/html/student-management/nsmg/cbc/gis/#get_company.companyshort#/batch_#get_batchid.cbcid#_user_#get_cbc_users.userid#_rec.xml" output="#toString(responseXML)#" mode="777">	
