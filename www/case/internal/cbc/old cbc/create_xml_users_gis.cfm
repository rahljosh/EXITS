...
<cfset BGCDirectURL = "https://online.backgroundchecks.com/integration/bgcdirectpost.aspx">
...
<cfloop query='get_cbc_users'> 
	...
	<table width="670" align="center" cellpadding="0" cellspacing="0">
		<tr><td>XML FILE <a href="../uploadedfiles/gis/#get_company.companyshort#/batch_#get_batchid.cbcid#_user_#get_cbc_users.userid#_sent.xml" target="_blank">Sent</a></td></tr>
		<tr><td>XML FILE <a href="../uploadedfiles/gis/#get_company.companyshort#/batch_#get_batchid.cbcid#_user_#get_cbc_users.userid#_rec.xml" target="_blank">Received</a></td></tr>
	</table><br>
	...
	<cfmail from="support@student-management.com" to="caroline@student-management.com" subject="GIS Search for #get_company.companyshort# - User : #firstname# #lastname# (###userid#)" failto="support@student-management.com" type="html">
