...
<table width=100% cellpadding=2 cellspacing=0 border=0 class="section">
	...
	<tr bgcolor="#iif(currentrow MOD 2 ,DE("ffffe6") ,DE("e2efc7") )#">
		...
		<td valign="top" align="center" width="10%">
			<!--- secure connection --->
			<cfif cgi.SERVER_PORT EQ 443  or client.userid eq 10459 or client.userid eq 510 or client.userid eq 11570 or client.userid EQ 1967 or client.userid EQ 12151 or 1 eq 1>
				<cfif ssn EQ ''>
