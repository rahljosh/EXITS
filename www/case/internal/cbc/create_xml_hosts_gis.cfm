...
<cfelse>
	...
	<cffile action="write" file="/var/www/html/case/internal/uploadedfiles/xml_files/gis/#get_company.companyshort#/batch_#get_batchid.cbcid#_hostm_#name#_#hostid#_sent.xml" output="#toString(requestXML)#">

	<cfset responseXML = ''>
   	<cfset responseXML = XmlParse(cfhttp.filecontent)>

	<cffile action="write" file="/var/www/html/case/internal/uploadedfiles/xml_files/gis/#get_company.companyshort#/batch_#get_batchid.cbcid#_hostm_#name#_#hostid#_rec.xml" output="#toString(responseXML)#">	
	...
	<cfmail from="support@case-usa.org" to="cbcresults@case-usa.org" subject="GIS Search for #get_company.companyshort# HF #usertype# - #name# #lastname# (###hostid#)" failto="support@case-usa.org" type="html">
		<table width="670" align="center">
			<tr><td colspan="2">&nbsp;</td></tr>
