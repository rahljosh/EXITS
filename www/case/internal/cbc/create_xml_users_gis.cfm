...
<cfloop query='get_cbc_users'> 
	...
	<cffile action="write" file="/var/www/html/case/internal/uploadedfiles/xml_files/gis/#get_company.companyshort#/batch_#get_batchid.cbcid#_user_#get_cbc_users.userid#_sent.xml" output="#toString(requestXML)#" mode="777">

	<cfset responseXML = ''>
   	<cfset responseXML = XmlParse(cfhttp.filecontent)>

    <cffile action="write" file="/var/www/html/case/internal/uploadedfiles/xml_files/gis/#get_company.companyshort#/batch_#get_batchid.cbcid#_user_#get_cbc_users.userid#_rec.xml" output="#toString(responseXML)#" mode="777">	
	...
	<cfmail from="support@case-usa.org" to="cbcresults@case-usa.org" subject="GIS Search for #get_company.companyshort# - User : #firstname# #lastname# (###userid#)" failto="support@case-usa.org" type="html">
