...
<cffile action="write" file="/var/www/html/case/internal/uploadedfiles/sevis/xml/school/#get_company.companyshort#_school_00#get_batchid.batchid#.xml" output="#toString(sevis_batch)#">
