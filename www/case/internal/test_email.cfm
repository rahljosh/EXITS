...
<table width=550 class="thin-border" cellspacing="3" cellpadding=0>
	...
	<tr><td>
Please accept this notice as verification that that application for #get_Student_info.firstname# #get_student_info.familylastname# has been received in the Babylon offices of Cultural Academic Student Exchange.  Our admissions staff will be reviewing the application for acceptance into the program as quickly as possible.
<br>
<br>
