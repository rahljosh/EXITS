...
<cfquery name="add_religion" datasource="caseusa">
insert into smg_religions (religionname)
					values('#form.new_religion#')
</cfquery>
<cfquery name="get_religion_id" datasource="caseusa">
...
<cfif form.religion is not 00>
	...
	<cfelse>
		<cfquery name="insert_church" datasource="caseusa">
		...
		<cfquery name="insert_church_in_fam" datasource="caseusa">
		update smg_hosts
