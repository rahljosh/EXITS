...
<!--- GETS THE PLACE REP --->
<cfquery name="get_rep_name" datasource="caseusa">
	SELECT firstname, lastname, email
	FROM smg_users
	WHERE userid = #get_student_info.placerepid#
</cfquery>
<!--- GETS THE REG DIR --->
<cfquery name="get_regDir" datasource="caseusa">
	SELECT firstname, lastname, email
	FROM smg_users
...
<cfmail to="#get_rep_name.email#" cc="#get_regDir.email#" from="support@case-usa.org" subject="Placement Rejected" >
#rep#,
...
<cfquery name ="update_host_fam_approved" datasource="caseusa">
					UPDATE smg_students 
...
<cfquery name="placement_history" datasource="caseusa">
