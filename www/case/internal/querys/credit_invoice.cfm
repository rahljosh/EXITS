...
<cfoutput query="get_Students">
	...
	<cfquery name="update_students" datasource="caseusa">
	update smg_Students
	set application_fee = #now()#
	where studentid = #studentid#
	</cfquery>

	<cfquery name="update_invoice" datasource="caseusa">
	update smg_invoice
...
<cfquery name="get_current_credit" datasource="caseusa">
...
<cfset current_Credit = #get_current_Credit.account_Credit# + #credit#>
<Cfquery name="update_intagent" datasource="caseusa">
