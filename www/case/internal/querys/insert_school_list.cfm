<CFIF NOT isDefined("form.schoolid")>
	<CFSET form.schoolid = "0">
</cfif>

<!--- ADD NEW SCHOOL --->
<cfif form.schoolid EQ 0>  
	<cfquery name="check_new_school" datasource="caseusa">
	...
	<cftransaction action="begin" isolation="SERIALIZABLE">
		<cfquery name="insert_school" datasource="caseusa">
		...
		<cfquery name="schoolid" datasource="caseusa"> <!--- get the newest school --->
...
<cfelse>  
	<cftransaction action="begin" isolation="SERIALIZABLE">	
		<cfquery name="update_school" datasource="caseusa">
			UPDATE smg_schools
	...
	<cfset client.schoolid = #form.schoolid#>
</cfif>

<!--- SCHOOL DATES --->
<cfif form.count EQ '0' OR form.seasonid NEQ '0'>
	<cftransaction action="begin" isolation="SERIALIZABLE">	
		<cfquery name="insert_dates" datasource="caseusa">
...
alert("You have successfully updated this page. Thank You.");
	location.replace("?curdoc=forms/school_app_1&schoolid=#client.schoolid#");
//-->
</script>
</cfoutput>
</head>
