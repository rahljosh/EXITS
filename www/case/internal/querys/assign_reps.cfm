<cfquery name="check_area_rep" datasource="caseusa">
select advisor_id 
from smg_users 
where userid = #client.userid#
</cfquery>
<cfquery name="get_supervisingrep_status" datasource="caseusa">
...
<cfquery name="school_info" datasource="caseusa">
select schoolid
from smg_hosts 
...
<cfquery name="assign_folks_to_student" datasource="caseusa">
update smg_students
...
<cfif isDefined('form.supervising')>
<Cfquery name="assign_Rep_to_folks" datasource="caseusa">
update smg_hosts
