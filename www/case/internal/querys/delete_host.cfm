...
<cfelse>
	<cfquery name="check_students" datasource="caseusa">
	...
	<cfquery name="check_cbcs" datasource="caseusa">
...
<!--- none students are assigned to the HOST, - DELETE HOST --->
		...
		<cfquery name="delete_host_children" datasource="caseusa">
			DELETE 
			FROM smg_host_children
			WHERE hostid = <cfqueryparam value="#url.hostid#" cfsqltype="cf_sql_integer">
		</cfquery>
		<cfquery name="delete_host_animals" datasource="caseusa">
			DELETE 
