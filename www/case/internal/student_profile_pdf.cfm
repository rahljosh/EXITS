...
where uniqueid = '#url.studentid#'
	...
	<cfset client.studentid = #get_id.studentid#>
</cfif>
...
<cfquery name="region_guarantee" datasource="caseusa">
select regionname
from smg_regions
...
<cfquery name="get_siblings" datasource="caseusa">
...
<cfquery name="country_birth" datasource="caseusa">
	SELECT countryname 
	FROM smg_countrylist	
	WHERE countryid = '#get_student_info.countrybirth#'
</cfquery>

<cfquery name="country_citizen" datasource="caseusa">
	SELECT countryname  
	FROM smg_countrylist 
	WHERE countryid = '#get_student_info.countrycitizen#'
</cfquery>

<cfquery name="country_resident" datasource="caseusa">
	SELECT countryname  
	FROM smg_countrylist
	WHERE countryid = '#get_student_info.countryresident#'
</cfquery>

<cfquery name="get_state_guarantee" datasource="caseusa">
	SELECT statename  
	FROM smg_states
...
<table  width=650 align="center" border=0 bgcolor="FFFFFF" style="font-size:13px"> 
	...
	<table cellpadding=0 cellspacing=0 border=0 width=65% style="font-size:13px">
		<tr><td align="center" width="360">
				<cfdirectory directory="/var/www/html/case/internal/uploadedfiles/letters/students" name="stuletter" filter="#get_student_info.studentid#.*">
				...
				&nbsp - &nbsp 
				<cfdirectory directory="/var/www/html/case/internal/uploadedfiles/letters/parents" name="paletter" filter="#get_student_info.studentid#.*">
...
<tr>
	<td colspan=2><span class="application_section_header">Natural Parents & Family In Home Country</span></td>
</tr>
	<tr><td width="50%">
	...
	<cfoutput> 
  	...
  	<table width=650 align="center" border=0 bgcolor="FFFFFF" style="font-size:13px"> 
	<tr>
		<td colspan=3><span class="application_section_header">Academic and Language Evaluation</span></td>
	</tr>
	...
	<table width=650 align="center" border=0 bgcolor="FFFFFF" style="font-size:13px"> 
	<tr>
		<td colspan=4><span class="application_section_header">Personal Information</span>
		</td>
	</tr>
	<tr>
