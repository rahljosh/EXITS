...
<cfif IsDefined('url.userid')>
	<cfset client.userid = '#url.userid#'>
</cfif>
...
<cfform action="qr_email_form.cfm" name="send_email" method="post">
	...
	<table width=100% border=0 cellpadding=4 cellspacing=0 class="section">
		...
		<tr>	
			<td colspan="2">Please enter one email address to send the student application to.<br><Br>
            These automated emails are getting reported as spam at a rate that is higher then accepted due to mass emailings.  PLEASE only send emails to people who have explicitly requested you send them information. Do not use this tool to send 
            to unsolicited recipients.  If you want to send to a mail list, send the email to your self and forward it from your personal address.</td>
		</tr>
		<tr>	
			<td colspan="2">
