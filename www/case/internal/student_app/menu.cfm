...
<cfoutput>
<table width=100% cellpadding=0 cellspacing=0 border="0" id="menu1">
	<tr>
...
<table width=100% cellpadding=0 cellspacing=0 border="0" id="menu1" align="center">
	...
	<tr>
		...
		<cfif url.p EQ '20'>
			<td align="center" class="selected"><a class="item2" href="?curdoc=section4/page20#print#&id=4&p=20" onClick="return CheckLink();"><div class="selectedlink">Page [20] &nbsp; Regional Guarantee </div></a></td>
		<cfelse>
			<td align="center" class="ddmx"><a class="item2" href="?curdoc=section4/page20#print#&id=4&p=20" onClick="return CheckLink();">Page [20] &nbsp; Regional Guarantee </a></td>
		</cfif>	
		<cfif url.p EQ '21'>
			<td align="center" class="selected"><a class="item2" href="?curdoc=section4/page21#print#&id=4&p=21" onClick="return CheckLink();"><div class="selectedlink">Page [21] &nbsp; State Guarantee </div></a></td>
		<cfelse>
			<td align="center" class="ddmx"><a class="item2" href="?curdoc=section4/page21#print#&id=4&p=21" onClick="return CheckLink();">Page [21] &nbsp; State Guarantee </a></td>
		</cfif>	
		<cfif url.p EQ '22'>
