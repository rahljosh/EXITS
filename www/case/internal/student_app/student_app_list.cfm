...
<cfelseif url.status EQ 7>
	These applications have been approved by <cfif client.usertype EQ 8>you<cfelse>the international rep</cfif> 
	and are waiting for CASE.
    <cfelseif url.status EQ 8>
	These applications have been approved by <cfif client.usertype EQ 8>you<cfelse>the international rep</cfif> 
	and are waiting for the CASE approval.
    <cfelseif url.status EQ 9>
	These applications have been rejected by CASE.
    <cfelseif url.status EQ 10>
	These applications have been approved by CASE.	
</cfif>
</h2>
...
<cfif client.usertype GTE 5 OR (url.status neq 7 and url.status neq 8)>
	...
	<cfquery name="chck_int_agent_imput" datasource="caseusa">
...
<cfif client.usertype LTE 4 AND url.status EQ 7>
	...
	<cfquery name="students_7" datasource="caseusa">
		SELECT  s.studentid, s.familylastname, s.uniqueid, s.firstname, s.email, s.phone, s.sex, s.lastchanged, s.app_sent_student, 
			s.branchid, s.application_expires, s.password,
			u.businessname, 
			c.companyshort,
...
<cfif client.usertype LTE 4 AND url.status EQ 8>
	...
	<cfquery name="students_8" datasource="caseusa">
		SELECT  s.studentid, s.familylastname, s.uniqueid, s.firstname, s.email, s.phone, s.sex, s.lastchanged, s.app_sent_student, 
			s.branchid, s.application_expires, s.password,
			u.businessname, 
			c.companyshort,
