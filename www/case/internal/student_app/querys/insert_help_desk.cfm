<!-----User Information----->
<cfquery name="assigned_to" datasource="caseusa">
...
<cfquery name="get_support" datasource="caseusa">
...
<cfquery name="insert_help_desk" datasource="caseusa">
...
<cfquery name="retrive_helpdeskid" datasource="caseusa">
...
<cfquery name="get_link_id" datasource="caseusa">
