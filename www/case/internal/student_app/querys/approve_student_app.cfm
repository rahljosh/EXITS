...
<cftransaction>	
	...
	<cfif newstatus EQ 11>
		...
		<cfquery name="set_company_region" datasource="caseusa">
			UPDATE smg_students 
		...
		<cfif form.companyid EQ '6'>
			<cfquery name="add_student" datasource="caseusa">
			...
			<cfoutput query="get_email">
				...
				<cfelse>
					...
					<table width=550 class="thin-border" cellspacing="0" cellpadding=0>
						<tr><td bgcolor="b5d66e"><img src="http://www.case-usa.org/internal/pics/top-email.gif" width=550 heignt=75></td></tr>
						<tr>
							<td>
								<h2>Congratulations!</h2>
								#firstname# #familylastname#-
								<br><br>
								This email is to inform you that your application has been accepted and approved by Cultural Academic Student Exchange in New Jersey. <br><br>
								...
								You will also be able to see your host family profile when you log into www.case-usa.org after you have been placed (if you have been provided a username & password).
								<br><br>
							</td>
						</tr>
						<tr>
							<Td align="center">
							<font color="##CCCCCC" size=-1>Please add support@case-usa.org to your whitelist to ensure it isn't marked as spam. CASE will
							not sell your address or use it for unsolicited emails.    
							If you received this email as an unsolicited contact about CASE or CASE subsidiaries, please contact support@case-usa.org  </font>
							</Td>
						</tr>				
					</table>
					</cfmail>
	...
	<table align="center">
		<tr><td><img src="http://www.case-usa.org/internal/pics/top-email.gif"></td></tr>
