...
<cftransaction>
	...
	<cfquery name="deny_application_status" datasource="caseusa">
	...
	<cfif newstatus EQ '9'> <!--- DENIED BY SMG --->
		<cfquery name="deny_application" datasource="caseusa">
			UPDATE smg_students 
...
<Cfif newstatus LT 9>
	...
	<cfquery name="check_branch" datasource="caseusa">
	select branchid 
	from smg_students
	where studentid = #form.studentid#
	</cfquery>
...
<cfoutput>
	...
	<cfquery name="student_email" datasource="caseusa">
