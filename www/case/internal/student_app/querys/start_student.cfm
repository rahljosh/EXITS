...
<cfelseif client.usertype EQ '11'>
	...
	<cfquery name="get_main_office" datasource="caseusa">
...
<cfquery name="start_student" datasource="caseusa">
...
<cfif url.r is 'n'>
	...
	<cfquery name="start_app_status" datasource="caseusa">
...
<cfelse>
	...
	<cfoutput>
	<cfmail to="#Form.email1#" from="#agent_info.email#" Subject="SMG Exchange Application" type="html">
	<style type="text/css">
