...
<table width="670" border=0 cellpadding=0 cellspacing=0 align="center">	
	...
	<tr>
		...
		<table cellpadding="0" cellspacing="0" border="0" align="center">
			...
			<td valign="top" width="49%" align="center">
			<h3><u>Email</u></h3>
			Please fill out this form for general questions about CASE or the EXITS application system. You will receive a reply on this page so do not forget to check it later.<br>
...
<cfquery name="help_desk" datasource="caseusa">
