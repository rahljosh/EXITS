...
<table width=670 border=0 cellpadding=2 cellspacing=0 align="center">
	...
	<tr>
		<td>A. <img src="#path#pics/RadioN.gif" width="13" height="13" border="0"> &nbsp; I would like to request a specific regional guarantee.<br></td>
	</tr>	
	<tr>
		<td>B. <img src="#path#pics/RadioN.gif" width="13" height="13" border="0"> &nbsp; I do not wish a regional guarantee.<br><br></td>
	</tr>	
	<tr><td>			
