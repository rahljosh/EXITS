...
function CheckRegion() {
   ...
   if ((document.page20.region_select[0].checked) && (Counter == 0)) {
		  alert("If you wish a regional guarantee you must select one of the 5 regions.");
		  return false; }
}
function NextPage() {
...
<cfif (DateFormat(now(), 'mm') EQ 4 OR dateFormat(now(), 'mm') EQ 5) AND (get_student_info.app_indicated_program EQ '1' OR get_student_info.app_indicated_program EQ '2')> 
	...
	<table width="670" cellpadding=2 cellspacing=0 align="center">
		<tr>
			<td>Regional Guarantees are no longer available.</td>
		</tr>
	</table><br><br>
	</div>
	<!--- FOOTER OF TABLE --->
...
<table width="670" cellpadding=2 cellspacing=0 align="center">
	<tr>
		<td><h1>Student's Name: #get_student_info.firstname# #get_student_info.familylastname#</h1><br><br>
			...
			You must request a guarantee by printing and signing this page.
		</td>
	</tr>
</table><br>
...
<table width=670 border=0 cellpadding=2 cellspacing=0 align="center">
	...
	<tr>
		<td>
			<b>Note: There will be a $300.00 Extra Charge for Regions 1 - 5.</b><br><br>
