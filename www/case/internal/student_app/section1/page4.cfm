...
<cfset nsmg_directory = '/var/www/html/case/internal/uploadedfiles/online_app/picture_album/#client.studentid#'>
...
<table width="670" border=0 cellpadding=0 cellspacing=0 align="center">
	<tr>  
		<td> 
			...
			<cfelse>
				<div align="center">
					<a href="" onClick="javascript: win=window.open('http://upload.case-usa.org/form_upload_album.cfm?studentid=#client.studentid#', 'UploadPics', 'height=310, width=600, location=no, scrollbars=yes, menubars=no, toolbars=no, resizable=yes'); win.opener=self; return false;"><img src="pics/uploadpic.gif" border=0></a>
				</div>
				<br><br>
			</cfif>
			</cfoutput>
			...
			<cfelse>
				<cfoutput query="fam_pics">
					<cfquery name="pic_description" datasource="caseusa">
						SELECT description 
