...
<cfquery name="smg_students" datasource="caseusa">
...
<cfquery name="smg_student_siblings" datasource="caseusa">
...
<cfquery name="smg_student_app_family_album" datasource="caseusa">
...
<cfquery name="smg_student_app_grades" datasource="caseusa">
	...
	WHERE smg_student_app_school_year.studentid = <cfqueryparam value="#smg_students.studentid#" cfsqltype="cf_sql_integer">
</cfquery>

<cfquery name="smg_student_app_health" datasource="caseusa">
	SELECT * 
...
<cfquery name="get_pages" datasource="caseusa">
...
<cfloop query="get_pages">
	<cfquery name="page#get_pages.page#" datasource="caseusa">
...
<table width="670" border=0 cellpadding=3 cellspacing=0 align="center">
	<tr><td><div align="justify">This page lists all the items that have not been completed. 
			Items in <font color="FF0000"><b>RED ARE REQUIRED</b></font> AND
			items in <font color="0000FF"><b>BLUE ARE OPTIONAL.</b></font> 
			For your convenience, the list is divided by pages.</div></td></tr>
	<tr><td>&nbsp;</td></tr>
	...
	<cfif not IsDefined('count1')><tr><td><font color="0000FF">Complete</font><br></td></tr></cfif>
	<tr><td>&nbsp;</td></tr>
	...
	<cfif not IsDefined('count2')><tr><td><font color="0000FF">Complete</font><br></td></tr></cfif>
	<tr><td>&nbsp;</td></tr>
	...
	<cfif not IsDefined('count3')><tr><td><font color="0000FF">Complete</font><br></td></tr></cfif>
	<tr><td>&nbsp;</td></tr>
	...
	<cfif not IsDefined('count4')><tr><td><font color="0000FF">Complete</font><br></td></tr></cfif>	
	<tr><td>&nbsp;</td></tr>
	...
	<cfif not IsDefined('count5')><tr><td><font color="0000FF">Complete</font><br></td></tr></cfif>	
	<tr><td>&nbsp;</td></tr>
	...
	<cfif not IsDefined('count6')><tr><td><font color="0000FF">Complete</font><br></td></tr></cfif>
	<tr><td>&nbsp;</td></tr>	
	...
	<cfif not IsDefined('count7')><tr><td><font color="0000FF">Complete</font><br></td></tr></cfif>
	<tr><td>&nbsp;</td></tr>	
	...
	<cfif check_08_upload.recordcount EQ 0>
		...
		<cfset countred = countred + 1>
	<cfelse>	
		<cfif not IsDefined('count8')><tr><td><font color="0000FF">Complete</font><br></td></tr></cfif>
	</cfif>		
	<tr><td>&nbsp;</td></tr>
	...
	<cfif not IsDefined('count9')><tr><td><font color="0000FF">Complete</font><br></td></tr></cfif>
	<tr><td>&nbsp;</td></tr>
	...
	<cfif not IsDefined('count10')><tr><td><font color="0000FF">Complete</font><br></td></tr></cfif>
	<tr><td>&nbsp;</td></tr>	
	...
	<cfif not IsDefined('count11')><tr><td><font color="0000FF">Complete</font><br></td></tr></cfif>
	<tr><td>&nbsp;</td></tr>
	...
	<cfif not IsDefined('count12')><tr><td><font color="0000FF">Complete</font><br></td></tr></cfif>
	<tr><td>&nbsp;</td></tr>
	...
	<cfif not IsDefined('count13')><tr><td><font color="0000FF">Complete</font><br></td></tr></cfif>
	<tr><td>&nbsp;</td></tr>
	...
	<cfif not IsDefined('count14')><tr><td><font color="0000FF">Complete</font><br></td></tr></cfif>
	<tr><td>&nbsp;</td></tr>
	...
	<cfif countred EQ 0>
		...
		<cfif get_latest_status.status LTE '2'>
			<tr><td align="center">There are no required items that need to be filled out. <br> 
			You are ready to submit your application to <b><i>Cultural Academic Student Exchange </i></b>.</td>
			</tr>
	...
	<cfelse>
	<tr><td align="center">There are <font color="FF0000"><b>#countred# required field(s)</b></font> that have not been filled out yet. In order to submit your online application
			you must fill out all required items.</td></tr>	
	</cfif>	
	<tr><td>&nbsp;</td></tr>
	</table>
</div>
