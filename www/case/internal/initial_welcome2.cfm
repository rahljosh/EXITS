...
<cfelseif client.usertype EQ 8>
	<table cellpadding=2 cellspacing=4 width=100% bgcolor="##ffffe6" class="section">
		<tr>
			<td bgcolor="##e2efc7" width=50%><span class="get_attention"><b>::</b></span><Cfquery name="companyname" datasource="caseusa">
		...
		<tr>
			...
			<!----
				...
				<!----last Invoice Sent---->
				<cfquery name="last_invoice_sent" datasource="caseusa">
					select max(invoiceid) as invoiceid
					from smg_charges where agentid = #client.userid#
				</cfquery>
				<cfquery name="last_invoice_date" datasource="caseusa">
					select *
					from smg_charges
