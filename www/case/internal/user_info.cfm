...
<cfif isDefined('url.redirect')>
	...
	You are trying to edit a profile other then your own.  This is not allowed.  If you got this error and you do not know why, please contact
					...
					<td style="line-height:20px;" valign="top">
						<div style="width:100%; float:right;text-align:center;">
							...
							<cfelse>
								...
								CASE is not responsible for delayed payments if your information is incorrect.  
		...
		<td width="50%" valign="top">
			...
			<table width=100% cellpadding=0 cellspacing=0 border=0 height=24>
				<tr valign=middle height=24>
					...
					<td background="pics/header_background.gif"><h2>&nbsp;&nbsp;Company & Regional Access </td>
					<td background="pics/header_background.gif" width=16><cfif client.usertype LTE 5><a href="index.cfm?curdoc=forms/region_access_rights&userid=#url.userid#"><img src="pics/edit.png" border=0 alt="Edit"></a></cfif></td>
					<td width=17 background="pics/header_rightcap.gif">&nbsp;</td>
				</tr>
			</table>
			<table width=100% cellpadding=10 cellspacing=0 border=0 class="section" >
				...
				<tr>
					<td style="line-height:20px;" valign="top">
						...
						<cfelse>
							...
							If information is incorrect and you update your information, please notify CASE immediatly of any such updates. 
							</div> 
						</cfif>
					</td>
				</tr>
				...
				<tr>
					<td>
						...
						<cfform action="querys/upload_logo.cfm"  method="post" enctype="multipart/form-data" preloader="no">
							...
							<cfinput type="file" name="UploadFile" size=35 enctype="multipart/form-data" required="yes" message="Please specify a file." validateat="onsubmit,onserver"> 
