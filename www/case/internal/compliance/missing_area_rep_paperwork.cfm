...
<!--- Get Season --->
<cfquery name="get_season_paperwork" datasource="caseusa">
...
<!--- Get Season --->
<cfquery name="get_season_placed" datasource="caseusa">
	SELECT seasonid, season
	FROM smg_seasons
	WHERE seasonid = '#form.seasonid#'
</cfquery>
...
<table width="670" cellpadding="3" cellspacing="0" align="center" frame="box">
	<tr><td align="center">
		Contract AYP: <b>#get_season_paperwork.season#</b> &nbsp; - &nbsp; School AYP <b>#get_season_placed.season#</b><br />
