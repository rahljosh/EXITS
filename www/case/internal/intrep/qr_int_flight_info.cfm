...
<cfquery name="check_php" datasource="caseusa">
	SELECT studentid
...
<CFMAIL SUBJECT="CASE EXITS - Flight Information for #get_students.firstname# #get_students.familylastname# (###get_students.studentid#)"
TO="#email_to#"
...
<tr><td>
	Please click 
	<a href="http://www.case-usa.org/internal/index.cfm?curdoc=student_info&studentid=#get_students.studentid#">here</a>
