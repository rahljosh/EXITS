...
<table cellpadding="0" cellspacing="0" bgcolor="#ffffe6" width=100% class="section">
	<tr>
		...
		<tr>
		<td bgcolor="#b6d5e9" colspan=6><span class="get_attention"><b>::</b></span> The following email is sent to students when a new account is created for them to start the online application. </td>
	</tr>
	<tr>
		<td><br>
...
<cfif isDefined('url.us')><br><h2><font color="green">Message succesfully updated.</font></h2><br></cfif></div>
	<table width=550 class="thin-border" cellspacing="0" cellpadding=0 bgcolor="white" align="center">
		<tr>
			<td bgcolor=b6d5e9><img src="http://www.case-usa.org/internal/pics/top-email.gif" width=550 height=75></td>
		</tr>
		<tr>
			<td>
			<i>Students First Name</i>-
			<br><br>
			An account has been created for you on the Cultural Academic Student Exchange (CASE) EXITS system.  
			...
			<br><br>
			The completed application will be reviewed by your international representative and sent to the CASE Headquarters in New Jersey.
			...
			<br><br>
			http://www.case-usa.com/intenal/student_app/?s=E180CA2F-1320-17E0-361BAD89F91C6FDBD</a>
			<br><br>
			...
			*this ID: <i>System Generated 6 digit Number</i>
			...
			<cfquery name="get_message" datasource="caseusa">
			select message
		...
		<tr>
			<Td align="center">
			<font color="#CCCCCC"><font size=-1>Please add support@case-usa.org to your whitelist to ensure it isn't marked as spam. CASE will
			not sell your address or use it for unsolicited emails.  This email was sent on behalf of CASE from an International Agent, listed above.  If you received this email as an unsolicited contact 
			about CASE, please contact support@case-usa.org  </font></font>
			</Td>
		</tr>
</table>
	...
	<tr>
		<td bgcolor="#b6d5e9" colspan=6><span class="get_attention"><b>::</b></span> The following email is sent when the students appliation is approved by CASE. </td>
	</tr>
	<tr>
		<td colspan=5>
		<cfquery name="check_congrats" datasource="caseusa">
	...
	<tr>
		...
		<tr>
			<Td align="center">
			<font color="#CCCCCC"><font size=-1>Please add support@case-usa.org to your whitelist to ensure it isn't marked as spam. CASE will
			not sell your address or use it for unsolicited emails.  This email was sent on behalf of Cultural Academic Student Exchange from an International Agent, listed above.  If you received this email as an unsolicited contact 
			about CASE, please contact support@case-usa.org  </font></font>
			</Td>
		</tr>
</table>
