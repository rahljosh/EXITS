...
<Cfloop query="payment_details">
	<cfquery name="payment_Details_applied" datasource="caseusa">
...
<Cfquery name="total_sum" datasource="caseusa">
...
<table cellpadding="4" cellspacing="0" class="thin-border" width="530">
	...
	<cfif amount_received lt total_sum.totalreceived>
		<cfquery name="get_credit_assoc" datasource="caseusa">
			select *
			from smg_credit
	...
	<cfloop query="payment_details">
		<cfquery name="company" datasource="caseusa">
			select companyshort
			from smg_companies
			where companyid = #companyid#
		</cfquery>
		<cfquery name="get_charge_payments" datasource="caseusa">
			select sum(amountapplied) as amountapplied
			from smg_payment_charges
			where paymentid = #paymentid#
		</cfquery>
