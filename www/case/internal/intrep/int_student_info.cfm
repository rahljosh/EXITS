...
<cfquery name="get_stu_company" datasource="caseusa">
...
<cfquery name="get_branches" datasource="caseusa">
...
<cfquery name="state_guarantee" datasource="caseusa">
...
<cfquery name="iff_school" datasource="caseusa">
	select iffid, name
	from smg_iff
	WHERE iffid = '#get_student_info.iffschool#'
</cfquery>

<cfquery name="ayp_english" datasource="caseusa">
	select campid, name, camptype
	from smg_aypcamps
	WHERE campid = '#get_Student_info.aypenglish#'
</cfquery>

<cfquery name="ayp_orientation" datasource="caseusa">
	select campid, name, camptype
	from smg_aypcamps
