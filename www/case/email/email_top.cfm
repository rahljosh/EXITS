...
<table background="http://www.case-usa.org/images/email_textured_background.png" width=600>
	<Tr >
    
     	<td width=94><img src="http://www.case-usa.org/images/logos/#client.companyid#_header_logo.png"></td>
    <cfif client.companyid eq  10>
        <td><strong><font size=+2>CULTURAL ACADEMIC <font color="#companycolor#">STUDENT EXCHANGE</font></font></strong></td>
     <cfelse>
     	<td><strong><font size=+2>#client.companyname#</font></font></strong></td>
     </cfif>
     </Tr>	
   
     	<td colspan=2><img src="http://www.case-usa.org/images/logos/#client.companyid#_px.png" height=12 width=100%></td>
	</tr>
</table>
