...
<cfif isDefined('form.process')>
    ...
    <cfelse>    
     ...
     <cfelse>
     	  <cflocation url="index.cfm?page=schoolCommunity" addtoken="no">
     </cfif>
    </cfif>
...
<cfform action="religionPref.cfm">
...
<table width=100% cellspacing=0 cellpadding=2 class="border">
      ...
      <tr bgcolor="#deeaf3">
    	<td>Would you provide transportation to the student's religious services if they are different from your own? </td>
        <td> <label>
