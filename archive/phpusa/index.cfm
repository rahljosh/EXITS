...
<cfif isdefined('url.i')><cflocation url="http://www.phpusa.com/internal/invoice/view_invoice.cfm?i=#url.i#"></cfif>
<cfif isdefined('url.s')><cflocation url="http://www.phpusa.com/internal/invoice/view_statement.cfm?s=#url.s#"></cfif>
<frameset rows="133,*" cols="*" framespacing="0" frameborder="NO" border="0">
  <frame src="top.htm" name="topFrame" scrolling="no" noresize>
  <frame src="principal.htm" name="botton" scrolling="auto">
</frameset>
<noframes><body>
