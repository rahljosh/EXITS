		...
		<cfif new>
        	<cflock timeout="30">
                <cfquery datasource="#application.dsn#">
                    INSERT INTO smg_hosts (familylastname, fatherlastname, fatherfirstname, fathermiddlename, fatherbirth, fatherdob,  fatherworktype, father_cell,
                        motherfirstname, motherlastname, mothermiddlename, motherbirth, motherdob,  motherworktype, mother_cell,
            ...
            <cflocation url="index.cfm?curdoc=forms/host_fam_mem_form&hostid=#get_id.hostid#" addtoken="No">
		<!--- edit --->
		<cfelse>
			<cfquery datasource="#application.dsn#">
            ...
            <cflocation url="index.cfm?curdoc=host_fam_mem_form&hostid=#url.hostid#" addtoken="No">
		</cfif>
	</cfif>
...
<cfform method="post" action="index.cfm?curdoc=forms/host_fam_form&hostid=#url.hostid#&this" name="my_form" onSubmit="return checkForm();">
...
<cfif new>
    ...
    <table>
        <tr>
            ...
            <td><input type="hidden" value=99999 name="regionid"/>Pre-App - Unassigned</td>
        </tr>
    </table> 		
    </div>
</cfif>
