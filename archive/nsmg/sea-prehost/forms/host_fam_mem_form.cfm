...
<cfif isDefined("form.submitted")>
	...
	<cfelse>
        ...
        <cflocation url="index.cfm?curdoc=forms/host_fam_mem_form&hostid=#url.hostid#" addtoken="No">
	</cfif>
...
<table border=0 cellpadding=4 cellspacing=0 width=100% class="section">
	<tr>
			...
			<td><cfoutput><a href="index.cfm?curdoc=forms/host_fam_pis_4&hostid=#url.hostid#">No family memebers / I've entered all memebers</a></cfoutput></td>
