<cfquery name="stu_ins" datasource="mysql">
	SELECT distinct php.studentid, stu.firstname, stu.familylastname, stu.dob, smg_insurance_type.insutypeid, smg_insurance_type.type, stu.programid as stu_program_id,
	...
	LEFT JOIN smg_students stu on smg_students.studentid = php.studentid
...
<!-----save xls to server---->
				...
				<tr bgcolor="##CCCCCC">
					...
					#DateFormat(showenddate,'mm/dd/yy')#
		
					
						<cfquery name="insert_start_Date" datasource="mysql">
								update smg_insurance_batch
									set enddate = #showenddate#,
