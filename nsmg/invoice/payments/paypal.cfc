<cfcomponent displayname="PayPal" hint="PayPal Gateway">
	...
	<cffunction name="PPInitialize" returntype="void" output="no">
		...
		<cfset p12Certificate = "C:\paypal_java_sdk\users\paypal.p12">
		...
		<cfscript>
			...
			*/
			...
			pp_profile.setAPIUsername("josh_api1.student-management.com");
			pp_profile.setAPIPassword("UTRXHVKJZCH8FFMK");
			pp_profile.setCertificateFile('paypal');
			pp_profile.setPrivateKeyPassword("raul43");
	...
	<cffunction name="DoDirectPayment" returntype="any" output="no">
		...
		<cfscript>
			...
			details.setMerchantclientId("1X911810264059026");
