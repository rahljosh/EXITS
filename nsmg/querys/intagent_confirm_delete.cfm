...
<br>
	...
	<cfoutput><a href="querys/intagent_delete_messages.cfm?id=#form.messageid#"></cfoutput>Yes, delete these messages.</a> &nbsp;&nbsp;&nbsp; : : &nbsp;&nbsp;&nbsp;<a href="index.cfm?curdoc=forms/update_alerts">No, don't delete these messages.</a>
	</div>
<cfelse>
