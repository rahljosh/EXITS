...
<cfset companyshort.companyshort = "CASE">
<cfelse>
<cfset companyshort.companyshort = "ISE-Red">
</cfif>


<cfset editDirectory = "/var/www/html/student-management/nsmg/uploadedfiles/editable/#companyshort.companyshort#/">
...
<table width=100% cellpadding=0 cellspacing=0 border=0 height=24>
	<tr valign=middle height=24>
		...
		<td background="pics/header_background.gif"><h2> PDF Documents</td><td background="pics/header_background.gif" align="right">
		</td>
