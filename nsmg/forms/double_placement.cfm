...
<cfquery name="get_place_reps" datasource="MySQL">
...
<cfquery name="following_info" datasource="MySQL">
select *
from smg_students
where hostid = #client.hostid#
</cfquery>
...
<Cfelse>
<cfquery name=student_reps datasource="MySQL">
	...
	<tr><td width="80%" valign="top">
		...
		<tr><td>Rep who made the placement:</td>
			<td> <!----None Assigned---->
				...
				<cfelse><cfquery name="place_rep" datasource="MySQL">
		...
		<tr><td>Rep supervising the student:</td>
			<Td><cfif get_students.recordcount is 0>No rep assigned.
				<cfelse>
					<cfquery name="sup_rep" datasource="MySQL">
						select firstname, lastname, userid
						from smg_users
		...
		<tr><td>Double Placement with student:</td>
			<td>
				<cfif get_students.recordcount is 0>
					No placement yet
				<cfelse>
					<cfquery name="double_placed" datasource="MySQl">
