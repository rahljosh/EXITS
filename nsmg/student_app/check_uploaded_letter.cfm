...
<cfif file.recordcount NEQ '0'>
	<table width="670" border=0 cellpadding=3 cellspacing=0 align="center">
		...
		<tr><td><a href="http://upload.student-management.com/qr_delete_letter.cfm?type=#doc#&ref=#curdoc#&id=#url.id#&p=#url.p#&student=#client.studentid#" onClick="return areYouSure();"><img src="pics/button_drop.png" border=0> Delete the letter that was uploaded</a></td></tr>
		<tr><td><a href="" onClick="javascript: win=window.open('http://upload.student-management.com/upload_letter.cfm?type=#doc#&student=#client.studentid#', 'UploadFiles', 'height=310, width=600, location=no, scrollbars=yes, menubars=no, toolbars=no, resizable=yes'); win.opener=self; return false;"><img src="pics/docs.gif" border=0> Upload a new letter (Note: the current letter will be replaced by the new one)</a></td></tr>
	</table><br>
<cfelse>
<!----
...
---->
			...
			<tr><td align="center"><a href="" onClick="javascript: win=window.open('http://upload.student-management.com/upload_letter.cfm?type=#doc#&student=#client.studentid#', 'UploadFiles', 'height=310, width=600, location=no, scrollbars=yes, menubars=no, toolbars=no, resizable=yes'); win.opener=self; return false;"><img src="pics/uploadletter.gif" border=0></img></a></td></tr>
		</table><br>
		<!----
<cfelse>
		<table width="670" border=0 cellpadding=3 cellspacing=0 align="center">
