...
<table width="670" border=0 cellpadding=2 cellspacing=0 align="center">
	<tr><td colspan="2"><div align="justify">
		...
		<p>The exchange organization provides a list of J-1 Private High Schools, which is available upon request.  Tuition costs at these schools generally range
		...
		requested below.</p>
		<p>Please note:  All J-1 rules apply including the need for communicative English skills.  None of the schools are guaranteed due to the fact that some schools may only be able to accept one student.  Some private high schools may also charge additional
		fees for books, uniforms, sports activities, etc.  Again, these costs vary.</p>
		<p>We would recommend sending several choices of the schools from our J-1 Private High Schools list.  Please be aware, especially as the season progresses, no school is guaranteed.  We will 
		do our best to keep the placement in a similar price range, but as we enter the later stages of the season this will be more and more difficult.</p>
	</div></td></tr>
</table><br><br>
