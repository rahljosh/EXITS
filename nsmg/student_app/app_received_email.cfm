...
<cfif get_student.intrepemail NEQ ''>
	<cfmail to="#get_student.intrepemail#" from="support@student-management.com" subject="Application Received - #get_student.firstname# #get_student.familylastname# (###get_student.studentid#)" type="html" failto="support@student-management.com">
		<style type="text/css">
		...
		<table width=550 class="thin-border" cellspacing="2" cellpadding=2>
			...
			<tr>
				<td>
					...
					application for #get_student.firstname# #get_student.familylastname# (###get_student.studentid#) has been received in the Babylon offices 
					of Student Management Group. <br><br>
					...
					Please understand that this notice is only to verify that the application has been received in the Babylon offices
			...
			<tr>
				<Td align="center">
					<font color="##CCCCCC" size=-1>Please add support@student-management.com to your whitelist to ensure it isn't marked as spam. 
						SMG will not sell your address or use it for unsolicited emails. This email was sent on behalf of Student Management Group
						from an International Agent, listed above. If you received this email as an unsolicited contact about SMG or SMG 
						subsidiaries, please contact support@student-management.com  
					</font>
				</Td>
			</tr>
		</table>
