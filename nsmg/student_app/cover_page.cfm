...
<cfquery name="get_status_history" datasource="MySql">
...
<table width="100%" cellpadding="0" cellspacing="0">
	<tr height="33">
		...
		<td class="tablecenter"><h2>SMG - EXITS Online Application</h2></td>
...
<table width="660" border=0 cellpadding=4 cellspacing=2 align="center">	
	...
	<tr><td colspan="2"><b>This application has been denied by SMG. Please see information below.</b></td></tr>
	...
	<tr><td colspan="2"><div align="justify">
			...
			and company) and give it to Marcus Melo. Marcus will then assign this 
			student to your company in EXITS.<br><br>
