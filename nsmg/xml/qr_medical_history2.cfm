	 ...
	 where studentid = #client.studentid#
		...
		<cfloop from="1" to=#numberdis# index="dis">
			<cfif StudentXMLFile.applications.application[i].page9.disorders.type[dis].description.xmltext EQ 'Diabetes Militus'>
				had_diabetes =  <cfif #StudentXMLFile.applications.application[i].page9.disorders.type[diss].flag.xmltext# is 'yes'>1<cfelse>0</cfif>,
			...
			<cfelseif StudentXMLFile.applications.application[i].page9.disorders.type[dis].description.xmltext EQ 'Parasites'>
				had_sexually_disease = <cfif #StudentXMLFile.applications.application[i].page9.disorders.type[dis].flag.xmltext# is 'yes'>1<cfelse>0</cfif>,
			<cfelseif StudentXMLFile.applications.application[i].page9.disorders.type[dis].description.xmltext EQ 'Anorexia Nervous'>
			...
			other_allergies_list = '#StudentXMLFile.applications.application[i].page9.allergystatement.specificpollens.xmltext#' '#StudentXMLFile.applications.application[i].page9.otherallergies.animals.xmltext#',
			allergic_to_pets =  <cfif StudentXMLFile.applications.application[i].page9.otherallergies.toanimals.xmltext EQ 'Yes'>1<cfelse>0</cfif>,
			...
			hospitalized_reason = '#StudentXMLFile.applications.application[i].page9.otherallergies.animals.xmltext#',
			...
			pets_list = '#StudentXMLFile.applications.application[i].page9.otherallergies.animals.xmltext#'
