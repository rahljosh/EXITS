...
<head>
	...
	<title>SMG - EXITS - Application Denied</title>
</head>
...
<cfquery name="get_student_info" datasource="mysql">
	SELECT s.studentid, s.uniqueid, s.familylastname, s.firstname, s.middlename, s.dob, s.sex, s.countryresident, 
		s.active, s.app_current_status, s.app_indicated_program, s.dateapplication, s.companyid, s.randid, s.cancelreason, s.canceldate,
...
<cfquery name="denied_by" datasource="MySql">
	SELECT hist.studentid, hist.status, hist.date, hist.reason,
...
<table width=100% cellpadding=0 cellspacing=0 border=0 height=24>
	<tr valign=middle height=24>
		...
		<td background="pics/header_background.gif"><h2>Application Denied</h2></td>
...
<table width="660" border=0 cellpadding=4 cellspacing=2 align="center" background="pics/denied.jpg">	
	<tr>
...
<table width="660" border=0 cellpadding=6 cellspacing=2 align="center" class="thin-border">	
	<tr>
		...
		<td width="70%">#get_student_info.companyshort#</td>
	</tr>
	<tr>
		<td align="right">Application Denied By: </td>
		<td >#denied_by.firstname# #denied_by.lastname# (###denied_by.userid#)</td>
	</tr>
	<tr>
		<td align="right" valign="top">Denial Reason:</td>
		<td><cfif denied_by.reason NEQ ''>#denied_by.reason#<cfelse>#get_student_info.cancelreason#</cfif></td>
	</tr>	
	<tr>
		<td align="right" valign="top">Denial Date:</td>
		<td><cfif denied_by.date NEQ ''>#Dateformat(denied_by.date, 'mm/dd/yyyy')#<cfelse>#Dateformat(get_student_info.canceldate, 'mm/dd/yyyy')#</cfif></td>
	</tr>
	<tr>
		<td colspan="3" align="center">
			<a href="?curdoc=app_process/reactivate_app&studentid=#get_student_info.studentid#"><img src="student_app/pics/reactivate.gif" alt="Reactivate Application" border="0" align="top"></a>
			&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
