...
<Cfquery name="getBatchInfo" datasource="MySQL">
	SELECT
    	c.companyID,
        c.companyShort,
        cbc.date_sent
	...
	WHERE 
    	cbc.userID = <cfqueryparam cfsqltype="cf_sql_integer" value="#URL.userID#">
    AND
    	cbc.batchID = <cfqueryparam cfsqltype="cf_sql_integer" value="#URL.batchID#">
</Cfquery>
    
   
<cffile action="read" file="/var/www/html/student-management/nsmg/uploadedfiles/xml_files/gis/#getBatchInfo.companyshort#/#url.file#" variable="rec_xml">	
...
<tr bgcolor="##CCCCCC"><th colspan="2">Criminal Backgroud Check - Date Processed: #DateFormat(getBatchInfo.date_sent, 'mm/dd/yyyy')# </td></tr>
<tr><td colspan="2">&nbsp;</td></tr>
<!--- USOneValidate --->
