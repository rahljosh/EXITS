...
<cfloop query='get_cbc_users'> 
	...
	<cfmail from="#get_company.support_email#" to="#get_company.gis_email#" subject="GIS Search for #get_company.companyshort# - User : #firstname# #lastname# (###userid#)" failto="support@student-management.com" type="html">
