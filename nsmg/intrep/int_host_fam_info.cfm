...
<cfquery name="get_region" datasource="#application.dsn#">
	...
	FROM smg_regions
	WHERE regionid = <cfqueryparam cfsqltype="cf_sql_integer" value="#family_info.hostid#">
</cfquery>
...
<cfquery name="get_school" datasource="#application.dsn#">
	...
	FROM smg_schools
	WHERE schoolid = <cfqueryparam cfsqltype="cf_sql_integer" value="#family_info.hostid#">
</cfquery>
...
<tr><td width="60%" align="left" valign="top">
	...
	<table width=100% cellpadding=0 cellspacing=0 border=0 height=24 >
		<tr valign=middle height=24>
			...
			<td background="pics/header_background.gif"><h2>Host Family Information casey</h2></td><cfif client.usertype LTE '4'><td background="pics/header_background.gif"><a href="?curdoc=querys/delete_host&hostid=#hostid#" onClick="return areYouSure(this);"><img src="pics/deletex.gif" border="0"></img></a></td></cfif>
	...
	<table width="100%" border=0 cellpadding=4 cellspacing=0 class="section">
		...
		<tr><td>Host Father:</td><td>#family_info.fatherfirstname# #family_info.fatherlastname# &nbsp; <cfif family_info.fatherdob NEQ ''>(#dateDiff('yyyy', family_info.fatherdob, now())#)</cfif></td><td>Occupation:</td><td><cfif family_info.fatherworktype is ''>n/a<cfelse>#family_info.fatherworktype#</cfif></td></tr>
		<tr><td>Host Mother:</td><td>#family_info.motherfirstname# #family_info.motherlastname#  &nbsp; <cfif family_info.motherdob NEQ ''>(#dateDiff('yyyy', family_info.motherdob, now())#)</cfif></td><td>Occupation:</td><td><cfif family_info.motherworktype is ''>n/a<cfelse>#family_info.motherworktype#</cfif></td></tr>
	</table>	
	<!--- BOTTOM OF A TABLE --->
